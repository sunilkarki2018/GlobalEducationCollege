...
!(function ($, window) {
    ...
    var AjaxBootstrapSelectRequest = function (plugin) {
        ...
        this.plugin.replaceValue(this.options.data, '{{{modulename}}}', this.plugin.$element.attr('modulename'));
        this.plugin.replaceValue(this.options.data, '{{{ParameterName}}}', this.plugin.$element.attr('id'));
        this.plugin.replaceValue(this.options.data, '{{{entityname}}}', this.plugin.$element.attr('entityname'));
