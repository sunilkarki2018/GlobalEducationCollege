...
!(function (e, t) {
    ...
    if (
        (((Be = Be && Be.hasOwnProperty("default") ? Be["default"] : Be).PLUGINS.align = function (r) {
            var i = r.$;
            return {
                apply: function o(e) {
                    var t = r.selection.element();
                    if (i(t).parents(".fr-img-caption").length) i(t).css("text-align", e);
                    else {
                        r.selection.save(), r.html.wrap(!0, !0, !0, !0), r.selection.restore();
                        for (var a = r.selection.blocks(), n = 0; n < a.length; n++)
                            i(a[n]).css("text-align", e).removeClass("fr-temp-div"), "" === i(a[n]).attr("class") && i(a[n]).removeAttr("class"), "" === i(a[n]).attr("style") && i(a[n]).removeAttr("style");
                ...
                refresh: function n(e) {
                    ...
                    if (t.length) {
                        var a = r.helpers.getAlignment(i(t[0]));
                        e.find("> *")
                            .first()
                            .replaceWith(r.icon.create("align-".concat(a)));
                    }
                },
                refreshOnShow: function s(e, t) {
                    var a = r.selection.blocks();
                    if (a.length) {
                        var n = r.helpers.getAlignment(i(a[0]));
                        t.find('a.fr-command[data-param1="'.concat(n, '"]')).addClass("fr-active").attr("aria-selected", !0);
                    }
                },
                refreshForToolbar: function l(e) {
                    ...
                    if (t.length) {
                        var a = r.helpers.getAlignment(i(t[0]));
                        (a = a.charAt(0).toUpperCase() + a.slice(1)), "align".concat(a) === e.attr("data-cmd") && e.addClass("fr-active");
                    }
                },
            };
        }),
            Be.DefineIcon("align", { NAME: "align-left", SVG_KEY: "alignLeft" }),
            Be.DefineIcon("align-left", { NAME: "align-left", SVG_KEY: "alignLeft" }),
            Be.DefineIcon("align-right", { NAME: "align-right", SVG_KEY: "alignRight" }),
            Be.DefineIcon("align-center", { NAME: "align-center", SVG_KEY: "alignCenter" }),
            Be.DefineIcon("align-justify", { NAME: "align-justify", SVG_KEY: "alignJustify" }),
            Be.RegisterCommand("align", {
                type: "dropdown",
                title: "Align",
                ...
                html: function () {
                    var e = '<ul class="fr-dropdown-list" role="presentation">',
                        t = Be.COMMANDS.align.options;
                    for (var a in t)
                        t.hasOwnProperty(a) &&
                            (e += '<li role="presentation"><a class="fr-command fr-title" tabIndex="-1" role="option" data-cmd="align"data-param1="\n        '
                                .concat(a, '" title="')
                                .concat(this.language.translate(t[a]), '">')
                                .concat(this.icon.create("align-".concat(a)), '<span class="fr-sr-only">\n        ')
            ...
            Be.RegisterCommand("alignCenter", {
                type: "button",
                icon: "align-center",
                title: "Align Center",
                callback: function () {
            ...
            Be.RegisterCommand("alignJustify", {
                type: "button",
                icon: "align-justify",
                title: "Align Justify",
                callback: function () {
            ...
            Object.assign(Be.DEFAULTS, { charCounterMax: -1, charCounterCount: !0 }),
            (Be.PLUGINS.charCounter = function (a) {
                var n,
                    t = a.$,
                    r = function r() {
                        return (a.el.textContent || "").replace(/\u200B/g, "").length;
                    };
                function e(e) {
                    if (a.opts.charCounterMax < 0) return !0;
                    if (r() < a.opts.charCounterMax) return !0;
                    var t = e.which;
                    return !((!a.keys.ctrlKey(e) && a.keys.isCharacter(t)) || t === Be.KEYCODE.IME) || (e.preventDefault(), e.stopPropagation(), a.events.trigger("charCounter.exceeded"), !1);
                }
                function i(e) {
                    return a.opts.charCounterMax < 0 ? e : t("<div>").html(e).text().length + r() <= a.opts.charCounterMax ? e : (a.events.trigger("charCounter.exceeded"), "");
                }
                function o() {
                    if (a.opts.charCounterCount) {
                        var e = r() + (0 < a.opts.charCounterMax ? "/" + a.opts.charCounterMax : "");
                        n.text("".concat(a.language.translate("Characters"), " : ").concat(e)), a.opts.toolbarBottom && n.css("margin-bottom", a.$tb.outerHeight(!0));
                        var t = a.$wp.get(0).offsetWidth - a.$wp.get(0).clientWidth;
                        0 <= t && ("rtl" == a.opts.direction ? n.css("margin-left", t) : n.css("margin-right", t));
                    }
                }
                return {
                    _init: function s() {
                        return (
                            !!a.$wp &&
                            !!a.opts.charCounterCount &&
                            ((n = t(document.createElement("span")).attr("class", "fr-counter")).css("bottom", a.$wp.css("border-bottom-width")),
                                a.$second_tb && a.$second_tb.append(n),
                                a.events.on("keydown", e, !0),
                                a.events.on("paste.afterCleanup", i),
                                a.events.on("keyup contentChanged input", function () {
                                    a.events.trigger("charCounter.update");
                                }),
                                a.events.on("charCounter.update", o),
                                a.events.trigger("charCounter.update"),
                                void a.events.on("destroy", function () {
                                    t(a.o_win).off("resize.char".concat(a.id)), n.removeData().remove(), (n = null);
                                }))
                        );
                    },
                    count: r,
            ...
            (Be.PLUGINS.codeBeautifier = function () {
                var e,
                    t,
                    a,
                    n,
                ...
                function I(n, e) {
                    var t = { "@page": !0, "@font-face": !0, "@keyframes": !0, "@media": !0, "@supports": !0, "@document": !0 },
                        a = { "@media": !0, "@supports": !0, "@document": !0 };
                    (e = e || {}), (n = (n = n || "").replace(/\r\n|[\r\u2028\u2029]/g, "\n"));
                    ...
                    function g(e) {
                        var t,
                            a = p;
                        return e && v(), (t = n.charAt(p + 1) || ""), (p = a - 1), h(), t;
                    }
                    function m(e) {
                        for (var t = p; h();)
                            if ("\\" === d) h();
                    ...
                    function E(e) {
                        ...
                        for (e = "/" === g(), h(); h();) {
                            ...
                            if (e && "\n" === d) return n.substring(t, p);
                        }
                        return n.substring(t, p) + d;
                    }
                    function A(e) {
                        return n.substring(p - e.length, p).toLowerCase() === e;
                    }
                    function T() {
                        for (var e = 0, t = p + 1; t < n.length; t++) {
                            var a = n.charAt(t);
                            if ("{" === a) return !0;
                            if ("(" === a) e += 1;
                            else if (")" === a) {
                    ...
                    for (
                        ...
                        I = {
                            "{": function (e) {
                                I.singleSpace(), O.push(e), I.newLine();
                            },
                            "}": function (e) {
                                I.newLine(), O.push(e), I.newLine();
                            },
                            ...
                            singleSpace: function () {
                                O.length && !I._lastCharWhitespace() && O.push(" ");
                            },
                            preserveSingleSpace: function () {
                                _ && I.singleSpace();
                            },
                            trim: function () {
                                for (; I._lastCharWhitespace();) O.pop();
                            },
                        },
                        O = [],
                        x = !1,
                        ...
                        if ("/" === d && "*" === g()) {
                            var P = 0 === S;
                            (B || P) && I.newLine(), O.push(E()), I.newLine(), P && I.newLine(!0);
                        } else if ("/" === d && "/" === g()) B || "{" === D || I.trim(), I.singleSpace(), O.push(E()), I.newLine();
                        else if ("@" === d) {
                            I.preserveSingleSpace(), O.push(d);
                            var U = (void 0, (y = p), (w = m(": , {}()[]/='\"")), (p = y - 1), h(), w);
                            U.match(/[ :]$/) && (h(), (U = m(": ").replace(/\s$/, "")), O.push(U), I.singleSpace()), (U = U.replace(/\s$/, "")) in t && ((L += 1), U in a && (k = !0));
                        } else
                            "#" === d && "{" === g()
                                ? (I.preserveSingleSpace(), O.push(m("}")))
                                : "{" === d
                                    ? "}" === g(!0)
                                        ? (v(), h(), I.singleSpace(), O.push("{}"), I.newLine(), l && 0 === S && I.newLine(!0))
                                        : (S++, (C += R), I["{"](d), (x = k ? ((k = !1), L < S) : L <= S))
                                    : "}" === d
                                        ? (S--, (C = C.slice(0, -r)), I["}"](d), (F = x = !1), L && L--, l && 0 === S && I.newLine(!0))
                                        : ":" === d
                                            ? (v(), (!x && !k) || A("&") || T() ? (":" === g() ? (h(), O.push("::")) : O.push(":")) : ((F = !0), O.push(":"), I.singleSpace()))
                                            : '"' === d || "'" === d
                                                ? (I.preserveSingleSpace(), O.push(m(d)))
                                                : " " === d
                                                    ? ((F = !1), O.push(d), I.newLine())
                                                    : "(" === d
                                                        ? A("url")
                                                            ? (O.push(d), v(), h() && (")" !== d && '"' !== d && "'" !== d ? O.push(m(")")) : p--))
                                                            : (u++, I.preserveSingleSpace(), O.push(d), v())
                                                        : ")" === d
                                                            ? (O.push(d), u--)
                                                            : "," === d
                                                                ? (O.push(d), v(), o && !F && u < 1 ? I.newLine() : I.singleSpace())
                                                                : ("]" === d || ("[" === d ? I.preserveSingleSpace() : "=" === d ? (v(), (d = "=")) : I.preserveSingleSpace()), O.push(d));
                    }
                    var W = "";
                    return C && (W += C), (W += O.join("").replace(/[\r\n\t ]+$/, "")), s && (W += "\n"), "\n" != c && (W = W.replace(/[\n]/g, c)), W;
                }
                function q(e, t) {
                ...
                (e = j),
                    ...
                    (e.newline = /[\n\r\u2028\u2029]/),
                    (e.lineBreak = new RegExp("\r\n|".concat(e.newline.source))),
                    (e.allLineBreaks = new RegExp(e.lineBreak.source, "g")),
                    (e.isIdentifierStart = function (e) {
                        return e < 65 ? 36 === e || 64 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (170 <= e && a.test(String.fromCharCode(e))));
                    }),
                    (e.isIdentifierChar = function (e) {
                        return e < 48 ? 36 === e : e < 58 || (!(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (170 <= e && n.test(String.fromCharCode(e))))));
                    });
                var Q = { BlockStatement: "BlockStatement", Statement: "Statement", ObjectLiteral: "ObjectLiteral", ArrayLiteral: "ArrayLiteral", ForInitializer: "ForInitializer", Conditional: "Conditional", Expression: "Expression" };
                function r(n, e) {
                    var c,
                        r,
                        i,
                    ...
                    function v(e, t) {
                        var a = 0;
                        return (
                            e && ((a = e.indentation_level), !c.just_added_newline() && e.line_indent_level > a && (a = e.line_indent_level)),
                            {
                                mode: t,
                                parent: e,
                    ...
                    for (
                        u = {
                            TK_START_EXPR: function N() {
                                O();
                                var e = Q.Expression;
                                if ("[" === d.text) {
                                    if ("TK_WORD" === o || ")" === f.last_text)
                                        return "TK_RESERVED" === o && q(f.last_text, i.line_starters) && (c.space_before_token = !0), L(e), R(), S(), void (h.space_in_paren && (c.space_before_token = !0));
                                    (e = Q.ArrayLiteral), _(f.mode) && (("[" !== f.last_text && ("," !== f.last_text || ("]" !== s && "}" !== s))) || h.keep_array_indentation || T());
                                } else "TK_RESERVED" === o && "for" === f.last_text ? (e = Q.ForInitializer) : "TK_RESERVED" === o && q(f.last_text, ["if", "while"]) && (e = Q.Conditional);
                                " " === f.last_text || "TK_START_BLOCK" === o
                                    ? T()
                                    : "TK_END_EXPR" === o || "TK_START_EXPR" === o || "TK_END_BLOCK" === o || "." === f.last_text
                                        ? A(d.wanted_newline)
                                        : ("TK_RESERVED" === o && "(" === d.text) || "TK_WORD" === o || "TK_OPERATOR" === o
                                            ? ("TK_RESERVED" === o && ("function" === f.last_word || "typeof" === f.last_word)) || ("*" === f.last_text && "function" === s)
                                                ? h.space_after_anon_function && (c.space_before_token = !0)
                                                : "TK_RESERVED" !== o || (!q(f.last_text, i.line_starters) && "catch" !== f.last_text) || (h.space_before_conditional && (c.space_before_token = !0))
                                            : (c.space_before_token = !0);
                                "(" === d.text && "TK_RESERVED" === o && "await" === f.last_word && (c.space_before_token = !0);
                                "(" === d.text && (("TK_EQUALS" !== o && "TK_OPERATOR" !== o) || I() || A());
                                L(e), R(), h.space_in_paren && (c.space_before_token = !0);
                                S();
                            },
                            TK_END_EXPR: function D() {
                                for (; f.mode === Q.Statement;) w();
                                f.multiline_frame && A("]" === d.text && _(f.mode) && !h.keep_array_indentation);
                                h.space_in_paren && ("TK_START_EXPR" !== o || h.space_in_empty_paren ? (c.space_before_token = !0) : (c.trim(), (c.space_before_token = !1)));
                                "]" === d.text && h.keep_array_indentation ? (R(), w()) : (w(), R());
                                c.remove_redundant_indentation(p), f.do_while && p.mode === Q.Conditional && ((p.mode = Q.Expression), (f.do_block = !1), (f.do_while = !1));
                            },
                            TK_START_BLOCK: function M() {
                                var e = F(1),
                                    t = F(2);
                                t && ((":" === t.text && q(e.type, ["TK_STRING", "TK_WORD", "TK_RESERVED"])) || (q(e.text, ["get", "set"]) && q(t.type, ["TK_WORD", "TK_RESERVED"])))
                                    ? q(s, ["class", "interface"])
                                        ? L(Q.BlockStatement)
                                        : L(Q.ObjectLiteral)
                                    : L(Q.BlockStatement);
                                var a = !e.comments_before.length && "}" === e.text && "function" === f.last_word && "TK_END_EXPR" === o;
                                "expand" === h.brace_style || ("none" === h.brace_style && d.wanted_newline)
                                    ? "TK_OPERATOR" !== o && (a || "TK_EQUALS" === o || ("TK_RESERVED" === o && x(f.last_text) && "else" !== f.last_text))
                                        ? (c.space_before_token = !0)
                                        : T(!1, !0)
                                    : "TK_OPERATOR" !== o && "TK_START_EXPR" !== o
                                        ? "TK_START_BLOCK" === o
                                            ? T()
                                            : (c.space_before_token = !0)
                                        : _(p.mode) && "," === f.last_text && ("}" === s ? (c.space_before_token = !0) : T());
                                R(), S();
                            },
                            TK_END_BLOCK: function B() {
                                for (; f.mode === Q.Statement;) w();
                                var e = "TK_START_BLOCK" === o;
                                "expand" === h.brace_style ? e || T() : e || (_(f.mode) && h.keep_array_indentation ? ((h.keep_array_indentation = !1), T(), (h.keep_array_indentation = !0)) : T());
                                w(), R();
                            },
                            TK_WORD: k,
                            TK_RESERVED: k,
                            TK_SEMICOLON: function P() {
                                O() && (c.space_before_token = !1);
                                for (; f.mode === Q.Statement && !f.if_block && !f.do_block;) w();
                                R();
                            },
                            TK_STRING: function U() {
                                O() ? (c.space_before_token = !0) : "TK_RESERVED" === o || "TK_WORD" === o ? (c.space_before_token = !0) : "TK_COMMA" === o || "TK_START_EXPR" === o || "TK_EQUALS" === o || "TK_OPERATOR" === o ? I() || A() : T();
                                R();
                            },
                            TK_EQUALS: function W() {
                                O();
                                f.declaration_statement && (f.declaration_assignment = !0);
                                (c.space_before_token = !0), R(), (c.space_before_token = !0);
                            },
                            TK_OPERATOR: function K() {
                                O();
                                if ("TK_RESERVED" === o && x(f.last_text)) return (c.space_before_token = !0), void R();
                                if ("*" === d.text && "TK_DOT" === o) return void R();
                                if (":" === d.text && f.in_case) return (f.case_body = !0), S(), R(), T(), void (f.in_case = !1);
                                if ("::" === d.text) return void R();
                                "TK_OPERATOR" === o && A();
                                var e = !0,
                                    t = !0;
                                q(d.text, ["--", "++", "!", "~"]) || (q(d.text, ["-", "+"]) && (q(o, ["TK_START_BLOCK", "TK_START_EXPR", "TK_EQUALS", "TK_OPERATOR"]) || q(f.last_text, i.line_starters) || "," === f.last_text))
                                    ? ((t = e = !1),
                                        !d.wanted_newline || ("--" !== d.text && "++" !== d.text) || T(!1, !0),
                                        " " === f.last_text && y(f.mode) && (e = !0),
                                        "TK_RESERVED" === o
                                            ? (e = !0)
                                            : "TK_END_EXPR" === o
                                                ? (e = !("]" === f.last_text && ("--" === d.text || "++" === d.text)))
                                                : "TK_OPERATOR" === o && ((e = q(d.text, ["--", "-", "++", "+"]) && q(f.last_text, ["--", "-", "++", "+"])), q(d.text, ["+", "-"]) && q(f.last_text, ["--", "++"]) && (t = !0)),
                                        (f.mode !== Q.BlockStatement && f.mode !== Q.Statement) || ("{" !== f.last_text && " " !== f.last_text) || T())
                                    : ":" === d.text
                                        ? 0 === f.ternary_depth
                                            ? (e = !1)
                                            : (f.ternary_depth -= 1)
                                        : "?" === d.text
                                            ? (f.ternary_depth += 1)
                                            : "*" === d.text && "TK_RESERVED" === o && "function" === f.last_text && (t = e = !1);
                                (c.space_before_token = c.space_before_token || e), R(), (c.space_before_token = t);
                            },
                            TK_COMMA: function H() {
                                if (f.declaration_statement)
                                    return y(f.parent.mode) && (f.declaration_assignment = !1), R(), void (f.declaration_assignment ? T((f.declaration_assignment = !1), !0) : ((c.space_before_token = !0), h.comma_first && A()));
                                R(), f.mode === Q.ObjectLiteral || (f.mode === Q.Statement && f.parent.mode === Q.ObjectLiteral) ? (f.mode === Q.Statement && w(), T()) : ((c.space_before_token = !0), h.comma_first && A());
                            },
                            TK_BLOCK_COMMENT: function $() {
                                ...
                                if (d.directives) return T(!1, !0), R(), "start" === d.directives.preserve && (c.raw = !0), void T(!1, !0);
                                if (!j.newline.test(d.text) && !d.wanted_newline) return (c.space_before_token = !0), R(), void (c.space_before_token = !0);
                                var e,
                                    t = (function o(e) {
                                        var t;
                                        e = e.replace(/\x0d/g, "");
                                ...
                                T(!1, !0),
                                    ...
                                    (!(function s(e, t) {
                                        for (var a = 0; a < e.length; a++) {
                                            var n = X(e[a]);
                                            if (n.charAt(0) !== t) return !1;
                                        }
                                        return !0;
                                    })(t.slice(1), "*")
                                        ? (function l(e, t) {
                                            for (var a, n = 0, r = e.length; n < r; n++) if ((a = e[n]) && 0 !== a.indexOf(t)) return !1;
                                            return !0;
                                        })(t.slice(1), r) && (n = !0)
                                        : (a = !0));
                                for (R(t[0]), e = 1; e < t.length; e++) T(!1, !0), a ? R(" ".concat(t[e].replace(/^\s+/g, ""))) : n && t[e].length > i ? R(t[e].substring(i)) : c.add_token(t[e]);
                                T(!1, !0);
                            },
                            TK_COMMENT: function G() {
                                d.wanted_newline ? T(!1, !0) : c.trim(!0);
                                (c.space_before_token = !0), R(), T(!1, !0);
                            },
                            TK_DOT: function Y() {
                                O();
                                "TK_RESERVED" === o && x(f.last_text) ? (c.space_before_token = !0) : A(")" === f.last_text && h.break_chained_methods);
                                R();
                            },
                            TK_UNKNOWN: function V() {
                                R(), "\n" === d.text[d.text.length - 1] && T();
                            },
                            TK_EOF: function z() {
                                for (; f.mode === Q.Statement;) w();
                            },
                    ...
                    var b = 0;
                    if (n && n.length) {
                        for (; " " === n.charAt(b) || "\t" === n.charAt(b);) (m += n.charAt(b)), (b += 1);
                        n = n.substring(b);
                    }
                    function E(e) {
                        var t = e.newlines;
                        if (h.keep_array_indentation && _(f.mode)) for (var a = 0; a < t; a += 1) T(0 < a);
                        else if ((h.max_preserve_newlines && t > h.max_preserve_newlines && (t = h.max_preserve_newlines), h.preserve_newlines && 1 < e.newlines)) {
                            T();
                            for (var n = 1; n < t; n += 1) T(!0);
                        }
                        u[(d = e).type]();
                    }
                    function A(e) {
                        if (((e = e !== undefined && e), !c.just_added_newline()))
                            if ((h.preserve_newlines && d.wanted_newline) || e) T(!1, !0);
                            else if (h.wrap_line_length) {
                                c.current_line.get_character_count() + d.text.length + (c.space_before_token ? 1 : 0) >= h.wrap_line_length && T(!1, !0);
                            }
                    }
                    function T(e, t) {
                        if (!t && " " !== f.last_text && "," !== f.last_text && "=" !== f.last_text && "TK_OPERATOR" !== o) for (; f.mode === Q.Statement && !f.if_block && !f.do_block;) w();
                        c.add_new_line(e) && (f.multiline_frame = !0);
                    }
                    function C() {
                        c.just_added_newline() &&
                            (h.keep_array_indentation && _(f.mode) && d.wanted_newline
                                ? (c.current_line.push(d.whitespace_before), (c.space_before_token = !1))
                                : c.set_indent(f.indentation_level) && (f.line_indent_level = f.indentation_level));
                    }
                    function R(e) {
                        c.raw
                            ? c.add_raw_token(d)
                            : (h.comma_first && "TK_COMMA" === o && c.just_added_newline() && "," === c.previous_line.last() && (c.previous_line.pop(), C(), c.add_token(","), (c.space_before_token = !0)),
                                (e = e || d.text),
                                C(),
                                c.add_token(e));
                    }
                    ...
                    function _(e) {
                        return e === Q.ArrayLiteral;
                    }
                    function y(e) {
                        return q(e, [Q.Expression, Q.ForInitializer, Q.Conditional]);
                    }
                    function w() {
                        0 < t.length && ((p = f), (f = t.pop()), p.mode === Q.Statement && c.remove_redundant_indentation(p));
                    }
                    function I() {
                        return f.parent.mode === Q.ObjectLiteral && f.mode === Q.Statement && ((":" === f.last_text && 0 === f.ternary_depth) || ("TK_RESERVED" === o && q(f.last_text, ["get", "set"])));
                    }
                    function O() {
                        return (
                            !!(
                                ("TK_RESERVED" === o && q(f.last_text, ["const", "let", "const"]) && "TK_WORD" === d.type) ||
                                ("TK_RESERVED" === o && "do" === f.last_text) ||
                                ("TK_RESERVED" === o && "return" === f.last_text && !d.wanted_newline) ||
                                ("TK_RESERVED" === o && "else" === f.last_text && ("TK_RESERVED" !== d.type || "if" !== d.text)) ||
                                ("TK_END_EXPR" === o && (p.mode === Q.ForInitializer || p.mode === Q.Conditional)) ||
                                ("TK_WORD" === o && f.mode === Q.BlockStatement && !f.in_case && "--" !== d.text && "++" !== d.text && "function" !== s && "TK_WORD" !== d.type && "TK_RESERVED" !== d.type) ||
                                (f.mode === Q.ObjectLiteral && ((":" === f.last_text && 0 === f.ternary_depth) || ("TK_RESERVED" === o && q(f.last_text, ["get", "set"]))))
                            ) &&
                            (L(Q.Statement),
                                S(),
                                "TK_RESERVED" === o && q(f.last_text, ["const", "let", "const"]) && "TK_WORD" === d.type && (f.declaration_statement = !0),
                                I() || A("TK_RESERVED" === d.type && q(d.text, ["do", "for", "if", "while"])),
                                !0)
                        );
                    }
                    function x(e) {
                    ...
                    function k() {
                        ("TK_RESERVED" === d.type && f.mode !== Q.ObjectLiteral && q(d.text, ["set", "get"]) && (d.type = "TK_WORD"), "TK_RESERVED" === d.type && f.mode === Q.ObjectLiteral) && ":" === F(1).text && (d.type = "TK_WORD");
                        if (
                            (O() ||
                                !d.wanted_newline ||
                                y(f.mode) ||
                                ("TK_OPERATOR" === o && "--" !== f.last_text && "++" !== f.last_text) ||
                                "TK_EQUALS" === o ||
                                (!h.preserve_newlines && "TK_RESERVED" === o && q(f.last_text, ["const", "let", "const", "set", "get"])) ||
                                T(),
                                f.do_block && !f.do_while)
                        ) {
                            if ("TK_RESERVED" === d.type && "while" === d.text) return (c.space_before_token = !0), R(), (c.space_before_token = !0), void (f.do_while = !0);
                            T(), (f.do_block = !1);
                        }
                        if (f.if_block)
                        ...
                        if ("TK_RESERVED" === d.type && ("case" === d.text || ("default" === d.text && f.in_case_statement)))
                            return (
                                T(),
                        ...
                        if (
                            ("TK_RESERVED" === d.type &&
                                "function" === d.text &&
                                ((q(f.last_text, ["}", " "]) || (c.just_added_newline() && !q(f.last_text, ["[", "{", ":", "=", ","]))) && (c.just_added_blankline() || d.comments_before.length || (T(), T(!0))),
                                    "TK_RESERVED" === o || "TK_WORD" === o
                                        ? "TK_RESERVED" === o && q(f.last_text, ["get", "set", "new", "return", "export", "async"])
                                            ? (c.space_before_token = !0)
                                            : "TK_RESERVED" === o && "default" === f.last_text && "export" === s
                                                ? (c.space_before_token = !0)
                                                : T()
                                        : "TK_OPERATOR" === o || "=" === f.last_text
                                            ? (c.space_before_token = !0)
                                            : (f.multiline_frame || (!y(f.mode) && !_(f.mode))) && T()),
                                ("TK_COMMA" !== o && "TK_START_EXPR" !== o && "TK_EQUALS" !== o && "TK_OPERATOR" !== o) || I() || A(),
                                "TK_RESERVED" === d.type && q(d.text, ["function", "get", "set"]))
                        )
                            return R(), void (f.last_word = d.text);
                        ((a = "NONE"),
                            "TK_END_BLOCK" === o
                                ? "TK_RESERVED" === d.type && q(d.text, ["else", "catch", "finally"])
                                    ? "expand" === h.brace_style || "end-expand" === h.brace_style || ("none" === h.brace_style && d.wanted_newline)
                                        ? (a = "NEWLINE")
                                        : ((a = "SPACE"), (c.space_before_token = !0))
                                    : (a = "NEWLINE")
                                : "TK_SEMICOLON" === o && f.mode === Q.BlockStatement
                                    ? (a = "NEWLINE")
                                    : "TK_SEMICOLON" === o && y(f.mode)
                                        ? (a = "SPACE")
                                        : "TK_STRING" === o
                                            ? (a = "NEWLINE")
                                            : "TK_RESERVED" === o || "TK_WORD" === o || ("*" === f.last_text && "function" === s)
                                                ? (a = "SPACE")
                                                : "TK_START_BLOCK" === o
                                                    ? (a = "NEWLINE")
                                                    : "TK_END_EXPR" === o && ((c.space_before_token = !0), (a = "NEWLINE")),
                            "TK_RESERVED" === d.type && q(d.text, i.line_starters) && ")" !== f.last_text && (a = "else" === f.last_text || "export" === f.last_text ? "SPACE" : "NEWLINE"),
                            "TK_RESERVED" === d.type && q(d.text, ["else", "catch", "finally"]))
                            ? "TK_END_BLOCK" !== o || "expand" === h.brace_style || "end-expand" === h.brace_style || ("none" === h.brace_style && d.wanted_newline)
                                ? T()
                                : (c.trim(!0), "}" !== c.current_line.last() && T(), (c.space_before_token = !0))
                            : "NEWLINE" === a
                                ? "TK_RESERVED" === o && x(f.last_text)
                                    ? (c.space_before_token = !0)
                                    : "TK_END_EXPR" !== o
                                        ? ("TK_START_EXPR" === o && "TK_RESERVED" === d.type && q(d.text, ["const", "let", "const"])) ||
                                        ":" === f.last_text ||
                                        ("TK_RESERVED" === d.type && "if" === d.text && "else" === f.last_text ? (c.space_before_token = !0) : T())
                                        : "TK_RESERVED" === d.type && q(d.text, i.line_starters) && ")" !== f.last_text && T()
                                : f.multiline_frame && _(f.mode) && "," === f.last_text && "}" === s
                                    ? T()
                                    : "SPACE" === a && (c.space_before_token = !0);
                        R(), (f.last_word = d.text), "TK_RESERVED" === d.type && "do" === d.text && (f.do_block = !0), "TK_RESERVED" === d.type && "if" === d.text && (f.if_block = !0);
                    }
                    (o = "TK_START_BLOCK"),
                        (s = ""),
                        ((c = new J(l, m)).raw = h.test_output_raw),
                        (t = []),
                        L(Q.BlockStatement),
                        (this.beautify = function () {
                            var e, t;
                            for (i = new ee(n, h, l), g = i.tokenize(), r = 0; (e = F());) {
                                for (var a = 0; a < e.comments_before.length; a++) E(e.comments_before[a]);
                                E(e), (s = f.last_text), (o = e.type), (f.last_text = e.text), (r += 1);
                            }
                ...
                function i(t) {
                    ...
                    (this.set_indent = function (e) {
                        (a = t.baseIndentLength + e * t.indent_length), (n = e);
                    }),
                        ...
                        (this.push = function (e) {
                            r.push(e), (a += e.length), (i = !1);
                        }),
                        (this.pop = function () {
                            var e = null;
                            return i || ((e = r.pop()), (a -= e.length), (i = 0 === r.length)), e;
                        }),
                        (this.remove_indent = function () {
                            0 < n && ((n -= 1), (a -= t.indent_length));
                        }),
                        (this.trim = function () {
                            for (; " " === this.last();) r.pop(), (a -= 1);
                            i = 0 === r.length;
                        }),
                        (this.toString = function () {
                            var e = "";
                            return this._empty || (0 <= n && (e = t.indent_cache[n]), (e += r.join(""))), e;
                        });
                }
                function J(t, a) {
                    (a = a || ""), (this.indent_cache = [a]), (this.baseIndentLength = a.length), (this.indent_length = t.length), (this.raw = !1);
                    var n = [];
                    (this.baseIndentString = a),
                        (this.indent_string = t),
                        (this.previous_line = null),
                        (this.current_line = null),
                        (this.space_before_token = !1),
                        (this.add_outputline = function () {
                            (this.previous_line = this.current_line), (this.current_line = new i(this)), n.push(this.current_line);
                        }),
                        this.add_outputline(),
                        ...
                        (this.remove_redundant_indentation = function (e) {
                            if (!e.multiline_frame && e.mode !== Q.ForInitializer && e.mode !== Q.Conditional) for (var t = e.start_line_index, a = n.length; t < a;) n[t].remove_indent(), t++;
                        }),
                        (this.trim = function (e) {
                            for (e = e !== undefined && e, this.current_line.trim(t, a); e && 1 < n.length && this.current_line.is_empty();) n.pop(), (this.current_line = n[n.length - 1]), this.current_line.trim();
                ...
                var Z = function Z(e, t, a, n, r, i) {
                    (this.type = e), (this.text = t), (this.comments_before = []), (this.newlines = a || 0), (this.wanted_newline = 0 < a), (this.whitespace_before = n || ""), (this.parent = null), (this.directives = null);
                };
                function ee(w, I, e) {
                    var O = "\n\r\t ".split(""),
                        x = /[0-9]/,
                    ...
                    function o() {
                        var e,
                            t,
                            a = [];
                        if (((D = 0), (M = ""), W <= U)) return ["", "TK_EOF"];
                        t = P.length ? P[P.length - 1] : new Z("TK_START_BLOCK", "{");
                        var n = w.charAt(U);
                        for (U += 1; q(n, O);) {
                            if ((j.newline.test(n) ? ("\n" === n && "\r" === w.charAt(U - 2)) || ((D += 1), (a = [])) : a.push(n), W <= U)) return ["", "TK_EOF"];
                            (n = w.charAt(U)), (U += 1);
                        }
                        if ((a.length && (M = a.join("")), x.test(n))) {
                            var r = !0,
                                i = !0,
                                o = x;
                            for ("0" === n && U < W && /[Xxo]/.test(w.charAt(U)) ? ((i = r = !1), (n += w.charAt(U)), (U += 1), (o = /[o]/.test(w.charAt(U)) ? F : k)) : ((n = ""), (U -= 1)); U < W && o.test(w.charAt(U));)
                                (n += w.charAt(U)),
                                    (U += 1),
                                    r && U < W && "." === w.charAt(U) && ((n += w.charAt(U)), (U += 1), (r = !1)),
                                    i && U < W && /[Ee]/.test(w.charAt(U)) && ((n += w.charAt(U)), (U += 1) < W && /[+-]/.test(w.charAt(U)) && ((n += w.charAt(U)), (U += 1)), (r = i = !1));
                            return [n, "TK_WORD"];
                        }
                        if (j.isIdentifierStart(w.charCodeAt(U - 1))) {
                            if (U < W) for (; j.isIdentifierChar(w.charCodeAt(U)) && ((n += w.charAt(U)), (U += 1) !== W););
                            return "TK_DOT" === t.type || ("TK_RESERVED" === t.type && q(t.text, ["set", "get"])) || !q(n, K) ? [n, "TK_WORD"] : "in" === n ? [n, "TK_OPERATOR"] : [n, "TK_RESERVED"];
                        }
                        if ("(" === n || "[" === n) return [n, "TK_START_EXPR"];
                        if (")" === n || "]" === n) return [n, "TK_END_EXPR"];
                        if ("{" === n) return [n, "TK_START_BLOCK"];
                        if ("}" === n) return [n, "TK_END_BLOCK"];
                        if (" " === n) return [n, "TK_SEMICOLON"];
                        if ("/" === n) {
                            var s = "";
                            if ("*" === w.charAt(U)) {
                                (U += 1), (H.lastIndex = U);
                                var l = H.exec(w);
                                (s = "/*".concat(l[0])), (U += l[0].length);
                                var c = (function _(e) {
                                    if (!e.match(G)) return null;
                                    var t = {};
                                    Y.lastIndex = 0;
                                    for (var a = Y.exec(e); a;) (t[a[1]] = a[2]), (a = Y.exec(e));
                                    return t;
                                })(s);
                                return c && "start" === c.ignore && ((V.lastIndex = U), (s += (l = V.exec(w))[0]), (U += l[0].length)), [(s = s.replace(j.lineBreak, "\n")), "TK_BLOCK_COMMENT", c];
                            }
                            if ("/" === w.charAt(U)) {
                                (U += 1), ($.lastIndex = U);
                                var d = $.exec(w);
                                return (s = "//".concat(d[0])), (U += d[0].length), [s, "TK_COMMENT"];
                            }
                        }
                        if (
                            "`" === n ||
                            "'" === n ||
                            '"' === n ||
                            (("/" === n || (I.e4x && "<" === n && w.slice(U - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/))) &&
                                (("TK_RESERVED" === t.type && q(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"])) ||
                                    ("TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && q(t.parent.text, ["if", "while", "for"])) ||
                                    q(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"])))
                        ) {
                            var f = n,
                                p = !1,
                                u = !1;
                            if (((e = n), "/" === f))
                                for (var h = !1; U < W && (p || h || w.charAt(U) !== f) && !j.newline.test(w.charAt(U));)
                                    (e += w.charAt(U)), p ? (p = !1) : ((p = "\\" === w.charAt(U)), "[" === w.charAt(U) ? (h = !0) : "]" === w.charAt(U) && (h = !1)), (U += 1);
                            else if (I.e4x && "<" === f) {
                                ...
                                if (v && 0 === v.index) {
                                    for (var b = v[2], E = 0; v;) {
                                        var A = !!v[1],
                                            T = v[2],
                                            C = !!v[v.length - 1] || "![CDATA[" === T.slice(0, 8);
                                        if ((T !== b || C || (A ? --E : ++E), E <= 0)) break;
                                        v = g.exec(m);
                                    }
                                    var R = v ? v.index + v[0].length : m.length;
                                    return (m = m.slice(0, R)), (U += R - 1), [(m = m.replace(j.lineBreak, "\n")), "TK_STRING"];
                                }
                            } else
                                for (; U < W && (p || (w.charAt(U) !== f && ("`" === f || !j.newline.test(w.charAt(U)))));)
                                    (p || "`" === f) && j.newline.test(w.charAt(U)) ? ("\r" === w.charAt(U) && "\n" === w.charAt(U + 1) && (U += 1), (e += "\n")) : (e += w.charAt(U)),
                                        (p = p ? (("x" !== w.charAt(U) && "u" !== w.charAt(U)) || (u = !0), !1) : "\\" === w.charAt(U)),
                                        (U += 1);
                            if (
                                (u &&
                                    I.unescape_strings &&
                                    (e = (function y(e) {
                                        ...
                                        for (; a || r < e.length;)
                                            if (((t = e.charAt(r)), r++, a)) {
                                                ...
                                                if (0 <= (o = parseInt(i, 16)) && o < 32) {
                                                    n += "x" === t ? "\\x".concat(i) : "\\u".concat(i);
                                                    continue;
                                                }
                                                if (34 === o || 39 === o || 92 === o) n += "\\".concat(String.fromCharCode(o));
                                                else {
                                    ...
                                    U < W && w.charAt(U) === f && ((e += f), (U += 1), "/" === f))
                            )
                                for (; U < W && j.isIdentifierStart(w.charCodeAt(U));) (e += w.charAt(U)), (U += 1);
                            return [e, "TK_STRING"];
                        }
                        if ("#" === n) {
                            if (0 === P.length && "!" === w.charAt(U)) {
                                for (e = n; U < W && "\n" !== n;) (e += n = w.charAt(U)), (U += 1);
                                return ["".concat(X(e), "\n"), "TK_UNKNOWN"];
                            }
                            var S = "#";
                            if (U < W && x.test(w.charAt(U))) {
                                for (; (S += n = w.charAt(U)), (U += 1) < W && "#" !== n && "=" !== n;);
                                return "#" === n || ("[" === w.charAt(U) && "]" === w.charAt(U + 1) ? ((S += "[]"), (U += 2)) : "{" === w.charAt(U) && "}" === w.charAt(U + 1) && ((S += "{}"), (U += 2))), [S, "TK_WORD"];
                            }
                        }
                        if ("<" === n && ("?" === w.charAt(U) || "%" === w.charAt(U))) {
                            z.lastIndex = U - 1;
                            var L = z.exec(w);
                            if (L) return (n = L[0]), (U += n.length - 1), [(n = n.replace(j.lineBreak, "\n")), "TK_STRING"];
                        }
                        if ("<" === n && "\x3c!--" === w.substring(U - 1, U + 3)) {
                            for (U += 3, n = "\x3c!--"; !j.newline.test(w.charAt(U)) && U < W;) (n += w.charAt(U)), U++;
                            return (B = !0), [n, "TK_COMMENT"];
                        }
                        if ("-" === n && B && "--\x3e" === w.substring(U - 1, U + 2)) return (B = !1), (U += 2), ["--\x3e", "TK_COMMENT"];
                        if ("." === n) return [n, "TK_DOT"];
                        if (q(n, N)) {
                            for (; U < W && q(n + w.charAt(U), N) && ((n += w.charAt(U)), !(W <= (U += 1))););
                            return "," === n ? [n, "TK_COMMA"] : "=" === n ? [n, "TK_EQUALS"] : [n, "TK_OPERATOR"];
                        }
                        return [n, "TK_UNKNOWN"];
                    }
                    this.tokenize = function () {
                        var e, t, a;
                        (W = w.length), (U = 0), (B = !1), (P = []);
                        for (var n = null, r = [], i = []; !t || "TK_EOF" !== t.type;) {
                            for (a = o(), e = new Z(a[1], a[0], D, M); "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;)
                                "TK_BLOCK_COMMENT" === e.type && (e.directives = a[2]), i.push(e), (a = o()), (e = new Z(a[1], a[0], D, M));
                            i.length && ((e.comments_before = i), (i = [])),
                                "TK_START_BLOCK" === e.type || "TK_START_EXPR" === e.type
                                    ? ((e.parent = t), r.push(n), (n = e))
                                    : ("TK_END_BLOCK" === e.type || "TK_END_EXPR" === e.type) &&
                                    n &&
                                    (("]" === e.text && "[" === n.text) || (")" === e.text && "(" === n.text) || ("}" === e.text && "{" === n.text)) &&
                                    ((e.parent = n.parent), (n = r.pop())),
                                P.push(e),
                                (t = e);
                        }
                        return P;
                ...
                return {
                    run: function x(e, t) {
                        ...
                        var a, n, r, m, i, s, v, l, c, b, E, A, d, f;
                        for (
                            ...
                            n = t.indent_inner_html !== undefined && t.indent_inner_html,
                            r = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10),
                            m = t.indent_char === undefined ? " " : t.indent_char,
                            s = t.brace_style === undefined ? "collapse" : t.brace_style,
                            i = 0 === parseInt(t.wrap_line_length, 10) ? 32786 : parseInt(t.wrap_line_length || 250, 10),
                            v = t.unformatted || [
                                "a",
                                "span",
                                "img",
                            ...
                            l = t.preserve_newlines === undefined || t.preserve_newlines,
                            c = l ? (isNaN(parseInt(t.max_preserve_newlines, 10)) ? 32786 : parseInt(t.max_preserve_newlines, 10)) : 0,
                            b = t.indent_handlebars !== undefined && t.indent_handlebars,
                            E = t.wrap_attributes === undefined ? "auto" : t.wrap_attributes,
                            A = t.wrap_attributes_indent_size === undefined ? r : parseInt(t.wrap_attributes_indent_size, 10) || r,
                            d = t.end_with_newline !== undefined && t.end_with_newline,
                            f = Array.isArray(t.extra_liners) ? t.extra_liners.concat() : "string" == typeof t.extra_liners ? t.extra_liners.split(",") : "head,body,/html".split(","),
                            t.indent_with_tabs && ((m = "\t"), (r = 1)),
                            (a = new (function w() {
                                return (
                                    (this.pos = 0),
                                    (this.token = ""),
                                    ...
                                    (this.get_contents_to = function (e) {
                                        ...
                                        var t = "",
                                            a = new RegExp("</".concat(e, "\\s*>"), "igm");
                                        a.lastIndex = this.pos;
                                        var n = a.exec(this.input),
                                            r = n ? n.index : this.input.length;
                                        return this.pos < r && ((t = this.input.substring(this.pos, r)), (this.pos = r)), t;
                                    }),
                                    (this.record_tag = function (e) {
                                        this.tags["".concat(e, "count")] ? this.tags["".concat(e, "count")]++ : (this.tags["".concat(e, "count")] = 1),
                                            (this.tags[e + this.tags["".concat(e, "count")]] = this.indent_level),
                                            (this.tags[e + this.tags["".concat(e, "count")] + "parent"] = this.tags.parent),
                                            (this.tags.parent = e + this.tags["".concat(e, "count")]);
                                    }),
                                    (this.retrieve_tag = function (e) {
                                        if (this.tags["".concat(e, "count")]) {
                                            ...
                                            t && ((this.indent_level = this.tags[e + this.tags["".concat(e, "count")]]), (this.tags.parent = this.tags[t + "parent"])),
                                                delete this.tags[e + this.tags["".concat(e, "count")] + "parent"],
                                                delete this.tags[e + this.tags["".concat(e, "count")]],
                                                1 === this.tags["".concat(e, "count")] ? delete this.tags["".concat(e, "count")] : this.tags["".concat(e, "count")]--;
                                        }
                                    }),
                                    ...
                                    (this.get_tag = function (e) {
                                        ...
                                        do {
                                            ...
                                            if (((n = this.input.charAt(this.pos)), this.pos++, this.Utils.in_array(n, this.Utils.whitespace))) o = !0;
                                            else {
                                                if ((("'" !== n && '"' !== n) || ((n += this.get_unformatted(n)), (o = !0)), "=" === n && (o = !1), r.length && "=" != r[r.length - 1] && ">" != n && o)) {
                                                    if ((this.space_or_wrap(r), (o = !1), !s && "force" === E && "/" != n)) {
                                                        this.print_newline(!0, r), this.print_indentation(r);
                                                        for (var d = 0; d < A; d++) r.push(m);
                                                    }
                                                ...
                                                if (
                                                    (b &&
                                                        ...
                                                        ((n += this.get_unformatted("}}")), r.length && " " != r[r.length - 1] && "<" != r[r.length - 1] && (n = " ".concat(n)), (o = !0)),
                                                        "<" !== n || a || ((t = this.pos - 1), (a = "<")),
                                                        b && !a && 2 <= r.length && "{" === r[r.length - 1] && "{" === r[r.length - 2] && ((t = "#" === n || "/" === n || "!" === n ? this.pos - 3 : this.pos - 2), (a = "{")),
                                                ...
                                                if (b && "{" === a && 2 < r.length && "}" === r[r.length - 2] && "}" === r[r.length - 1]) break;
                                            }
                                        } while (">" != n);
                                        var p,
                                            u,
                                        ...
                                        return (
                                            "/" === h.charAt(h.length - 2) || this.Utils.in_array(g, this.Utils.single_token)
                                                ...
                                                : b && "{" === h[0] && "else" === g
                                                    ...
                                                    : this.is_unformatted(g, v)
                                                        ? ((i = this.get_unformatted("</".concat(g, ">"), h)), r.push(i), this.pos, (this.tag_type = "SINGLE"))
                                                        : "script" === g && (-1 === h.search("type") || (-1 < h.search("type") && -1 < h.search(/\b(text|application)\/(x-)?(javascript|ecmascript|jscript|livescript)/)))
                                                            ? e || (this.record_tag(g), (this.tag_type = "SCRIPT"))
                                                            : "style" === g && (-1 === h.search("type") || (-1 < h.search("type") && -1 < h.search("text/css")))
                                                                ? e || (this.record_tag(g), (this.tag_type = "STYLE"))
                                                                : "!" === g.charAt(0)
                                                                    ? e || ((this.tag_type = "SINGLE"), this.traverse_whitespace())
                                                                    : e ||
                                                                    ("/" === g.charAt(0)
                                                                        ? (this.retrieve_tag(g.substring(1)), (this.tag_type = "END"))
                                                                        : (this.record_tag(g), "html" != g.toLowerCase() && (this.indent_content = !0), (this.tag_type = "START")),
                                                                        this.traverse_whitespace() && this.space_or_wrap(r),
                                                                        this.Utils.in_array(g, this.Utils.extra_liners) &&
                                                                        (this.print_newline(!1, this.output), this.output.length && "\n" != this.output[this.output.length - 2] && this.print_newline(!0, this.output))),
                                            e && ((this.pos = l), (this.line_char_count = c)),
                                            r.join("")
                                        );
                                    }),
                                    (this.get_comment = function (e) {
                                        ...
                                        for (this.pos++; this.pos <= this.input.length && ((t += r)[t.length - 1] !== a[a.length - 1] || -1 == t.indexOf(a));)
                                            !n &&
                                                t.length < 10 &&
                                                (0 === t.indexOf("<![if")
                                                    ? ((a = "<![endif]>"), (n = !0))
                                    ...
                                    (this.get_unformatted = function (e, t) {
                                        ...
                                        do {
                                            ...
                                            (n += a), this.line_char_count++, (i = !0), b && "{" === a && n.length && "{" === n[n.length - 2] && (r = (n += this.get_unformatted("}}")).length);
                                        } while (-1 === n.toLowerCase().indexOf(e, r));
                                        return n;
                                    }),
                                            ...
                                            return "CONTENT" === this.current_mode
                                                ...
                                                : "TAG" === this.current_mode
                                                    ? "string" != typeof (e = this.get_tag())
                                                        ? e
                                                        : [e, "TK_TAG_".concat(this.tag_type)]
                                                    : void 0;
                                    ...
                                    (this.is_unformatted = function (e, t) {
                                        ...
                                        var a = (this.get_tag(!0) || "").match(/^\s*<\s*\/?([a-z]*)\s*[^>]*>\s*$/);
                                        return !(a && !this.Utils.in_array(a, t));
                                    }),
                                    (this.printer = function (e, t, a, n, r) {
                                        (this.input = e || ""),
                                            (this.output = []),
                                        ...
                                        for (var i = (this.line_char_count = 0); i < this.indent_size; i++) this.indent_string += this.indent_character;
                            ...
                            var p = a.get_token();
                            if (((a.token_text = p[0]), (a.token_type = p[1]), "TK_EOF" === a.token_type)) break;
                            switch (a.token_type) {
                                case "TK_TAG_START":
                                    a.print_newline(!1, a.output), a.print_token(a.token_text), a.indent_content && (a.indent(), (a.indent_content = !1)), (a.current_mode = "CONTENT");
                                    break;
                                case "TK_TAG_STYLE":
                                case "TK_TAG_SCRIPT":
                                ...
                                case "TK_TAG_END":
                                    if ("TK_CONTENT" === a.last_token && "" === a.last_text) {
                                        var u = a.token_text.match(/\w+/)[0],
                                            h = null;
                                        a.output.length && (h = a.output[a.output.length - 1].match(/(?:<|{{#)\/?\s*(\w+)/)), (null === h || (h[1] != u && !a.Utils.in_array(h[1], v))) && a.print_newline(!1, a.output);
                                    }
                                    a.print_token(a.token_text), (a.current_mode = "CONTENT");
                                    break;
                                case "TK_TAG_SINGLE":
                                    var g = a.token_text.match(/^\s*<([a-z-]+)/i);
                                    (g && a.Utils.in_array(g[1], v)) || a.print_newline(!1, a.output), a.print_token(a.token_text), (a.current_mode = "CONTENT");
                                    break;
                                case "TK_TAG_HANDLEBARS_ELSE":
                                    a.print_token(a.token_text), a.indent_content && (a.indent(), (a.indent_content = !1)), (a.current_mode = "CONTENT");
                                    break;
                                ...
                                case "TK_SCRIPT":
                                    if ("" !== a.token_text) {
                                        ...
                                        var T = a.token_text,
                                            C = void 0,
                                            R = 1;
                                        "TK_SCRIPT" === a.token_type ? (C = O) : "TK_STYLE" === a.token_type && (C = I), "keep" === t.indent_scripts ? (R = 0) : "separate" === t.indent_scripts && (R = -a.indent_level);
                                        var S = a.get_full_indent(R);
                                        if (C) T = C(T.replace(/^\s*/, S), t);
                                        else {
                                            var L =
                                                T.match(/^\s*/)[0]
                                                    .match(/[^\n\r]*$/)[0]
                                                    .split(a.indent_string).length - 1,
                                                _ = a.get_full_indent(R - L);
                                            T = T.replace(/^\s*/, S)
                                                .replace(/\r\n|\r|\n/g, "\n" + _)
                                                .replace(/\s+$/, "");
                                        }
                                        T && (a.print_token_raw(T), a.print_newline(!0, a.output));
                                    }
                                    a.current_mode = "TAG";
                                    break;
                                default:
                        ...
                        var y = a.output.join("").replace(/[\r\n\t ]+$/, "");
                        return d && (y += "\n"), y;
                    },
                };
            }),
            Object.assign(Be.DEFAULTS, {
            ...
            (Be.PLUGINS.codeView = function (c) {
                var d,
                    f,
                    p = c.$,
                    u = function u() {
                ...
                function g() {
                    u() &&
                        (f && f.setSize(null, c.opts.height ? c.opts.height : "auto"),
                            c.opts.heightMin || c.opts.height
                                ? (c.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", c.opts.heightMin || c.opts.height), d.css("height", c.opts.height))
                                : c.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", ""));
                }
                var m,
                    v = !1;
                function b() {
                ...
                function n(e) {
                    d ||
                        (!(function l() {
                            (d = p('<textarea class="fr-code" tabIndex="-1">')),
                                ...
                                ((m = p('<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch'.concat(c.helpers.isMobile() ? "" : " fr-desktop", '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'))),
                                    c.$box.append(m),
                                    c.events.bindClick(c.$box, "a.html-switch", function () {
                                        c.events.trigger("commands.before", ["html"]), A(!1), c.events.trigger("commands.after", ["html"]);
                                    }));
                            var e = function e() {
                                return !u();
                            };
                            ...
                            !f && c.opts.codeMirror
                                ? ((f = c.opts.codeMirror.fromTextArea(d.get(0), c.opts.codeMirrorOptions)).on("blur", b), f.on("focus", E))
                                : (c.events.$on(d, "keydown keyup change input", function () {
                        ...
                        (c.core.isEmpty() ||
                            (c.selection.save(),
                                c.$el.find('.fr-marker[data-type="true"]').first().replaceWith('<span class="fr-tmp fr-sm">F</span>'),
                                c.$el.find('.fr-marker[data-type="false"]').last().replaceWith('<span class="fr-tmp fr-em">F</span>')));
                    ...
                    var a,
                        ...
                        r = !1;
                    if (
                        (c.core.hasFocus() && ((r = !0), c.events.disableBlur(), c.$el.blur()),
                            (t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "FROALA-SM")).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM")),
                            c.codeBeautifier && !t.includes("fr-embedly") && (t = c.codeBeautifier.run(t, c.opts.codeBeautifierOptions)),
                            f)
                    ) {
                        (a = t.indexOf("FROALA-SM")), (n = t.indexOf("FROALA-EM")) < a ? (a = n) : (n -= 9);
                        var i = (t = t.replace(/FROALA-SM/g, "").replace(/FROALA-EM/g, "")).substring(0, a).length - t.substring(0, a).replace(/\n/g, "").length,
                            o = t.substring(0, n).length - t.substring(0, n).replace(/\n/g, "").length;
                        (a = t.substring(0, a).length - t.substring(0, t.substring(0, a).lastIndexOf("\n") + 1).length),
                            (n = t.substring(0, n).length - t.substring(0, t.substring(0, n).lastIndexOf("\n") + 1).length),
                            f.setSize(null, c.opts.height ? c.opts.height : "auto"),
                            c.opts.heightMin && c.$box.find(".CodeMirror-scroll").css("min-height", c.opts.heightMin),
                            f.setValue(t),
                            (v = !r),
                            f.focus(),
                            (v = !0),
                            f.setSelection({ line: i, ch: a }, { line: o, ch: n }),
                            f.refresh(),
                            f.clearHistory();
                    } else {
                        (a = t.indexOf("FROALA-SM")),
                            (n = t.indexOf("FROALA-EM") - 9),
                            c.opts.heightMin && d.css("min-height", c.opts.heightMin),
                            c.opts.height && d.css("height", c.opts.height),
                            c.opts.heightMax && d.css("max-height", c.opts.height || c.opts.heightMax),
                            d.val(t.replace(/FROALA-SM/g, "").replace(/FROALA-EM/g, "")).trigger("change");
                        var s = p(c.o_doc).scrollTop();
                        (v = !r), d.focus(), (v = !0), d.get(0).setSelectionRange(a, n), p(c.o_doc).scrollTop(s);
                    }
                    c.$tb
                        .find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-grp > .fr-btn-wrap > .fr-command, .fr-more-toolbar > .fr-btn-wrap > .fr-command")
                        .not(e)
                        .filter(function () {
                        ...
                        !c.helpers.isMobile() && c.opts.toolbarInline && c.toolbar.hide();
                }
                function A(e) {
                    void 0 === e && (e = !u());
                    var t = c.$tb.find('.fr-command[data-cmd="html"]');
                    e
                        ? (c.popups.hideAll(), n(t))
                        : (c.$box.toggleClass("fr-code-view", !1),
                            ...
                            c.events.trigger("codeView.update"));
                }
                function T() {
                    u() && A(!1), f && f.toTextArea(), d.val("").removeData().remove(), (d = null), m && (m.remove(), (m = null));
                }
                return {
                    _init: function e() {
                        if (
                                ...
                                c.opts.toolbarContainer &&
                                    (function t() {
                                        ...
                                        u()
                                            ...
                                            : (c.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command").not(e).removeClass("fr-disabled").attr("aria-disabled", !1), e.removeClass("fr-active").attr("aria-pressed", !1));
                                    })();
                            }),
                                !c.$wp)
                        )
            ...
            Be.DefineIcon("html", { NAME: "code", SVG_KEY: "codeView" }),
            Object.assign(Be.POPUP_TEMPLATES, { "textColor.picker": "[_BUTTONS_][_TEXT_COLORS_][_CUSTOM_COLOR_]", "backgroundColor.picker": "[_BUTTONS_][_BACKGROUND_COLORS_][_CUSTOM_COLOR_]" }),
            Object.assign(Be.DEFAULTS, {
                colorsText: [
                    "#61BD6D",
                    "#1ABC9C",
            ...
            (Be.PLUGINS.colors = function (m) {
                ...
                function l(e) {
                    for (var t = "text" === e ? m.opts.colorsText : m.opts.colorsBackground, a = '<div class="fr-color-set fr-'.concat(e, '-color fr-selected-set">'), n = 0; n < t.length; n++)
                        0 !== n && n % m.opts.colorsStep == 0 && (a += "<br>"),
                            "REMOVE" !== t[n]
                                ? (a += '<span class="fr-command fr-select-color" style="background:'
                                    .concat(t[n], ';" \n        tabIndex="-1" aria-selected="false" role="button" data-cmd="apply')
                                    .concat(e, 'Color" \n        data-param1="')
                                    .concat(t[n], '"><span class="fr-sr-only"> ')
                                    .concat(m.language.translate("Color"))
                                    .concat(t[n], " \n        &nbsp;&nbsp;&nbsp;</span></span>"))
                                : (a += '<span class="fr-command fr-select-color" data-cmd="apply'
                                    .concat(e, 'Color"\n         tabIndex="-1" role="button" data-param1="REMOVE" \n         title="')
                                    .concat(m.language.translate("Clear Formatting"), '">')
                                    .concat(m.icon.create("remove"), ' \n        <span class="fr-sr-only"> ')
                                    .concat(m.language.translate("Clear Formatting"), " </span></span>"));
                    return "".concat(a, "</div>");
                }
                function c(e) {
                    var t,
                        a = m.popups.get("".concat(e, "Color.picker")),
                        n = v(m.selection.element());
                    t = "background" === e ? "background-color" : "color";
                    var r = a.find(".fr-".concat(e, "-color .fr-select-color"));
                    for (r.find(".fr-selected-color").remove(), r.removeClass("fr-active-item"), r.not('[data-param1="REMOVE"]').attr("aria-selected", !1); n.get(0) !== m.el;) {
                        if ("transparent" !== n.css(t) && "rgba(0, 0, 0, 0)" !== n.css(t)) {
                            var i = a.find(".fr-".concat(e, '-color .fr-select-color[data-param1="').concat(m.helpers.RGBToHex(n.css(t)), '"]'));
                            i.append('<span class="fr-selected-color" aria-hidden="true">\uf00c</span>'), i.addClass("fr-active-item").attr("aria-selected", !0);
                            break;
                        }
                        n = n.parent();
                    }
                    !(function o(e) {
                        var t = m.popups.get("".concat(e, "Color.picker")),
                            a = t.find(".fr-".concat(e, "-color .fr-active-item")).attr("data-param1"),
                            n = t.find(".fr-color-hex-layer input");
                        a || (a = "");
                        n.length && v(n.val(a).input).trigger("change");
                    })(e);
                }
                function n(e) {
                ...
                return {
                    showColorsPopup: function d(e) {
                        var t = m.$tb.find('.fr-command[data-cmd="'.concat(e, '"]')),
                            a = m.popups.get("".concat(e, ".picker"));
                        if (
                            (a ||
                                (a = (function o(e) {
                                    var t = "";
                                    ...
                                    a =
                                        "textColor" === e
                                            ? (m.opts.colorsHEXInput && (n = s.replace(/\[ID\]/g, "fr-color-hex-layer-text-".concat(m.id)).replace(/\[COMMAND\]/g, "customTextColor")), { buttons: t, text_colors: l("text"), custom_color: n })
                                            : (m.opts.colorsHEXInput && (n = s.replace(/\[ID\]/g, "fr-color-hex-layer-background-".concat(m.id)).replace(/\[COMMAND\]/g, "customBackgroundColor")),
                                                { buttons: t, background_colors: l("background"), custom_color: n });
                                    var r = m.popups.create("".concat(e, ".picker"), a);
                                    return (
                                        (function i(h, g) {
                                            m.events.on(
                                                "popup.tab",
                                                function (e) {
                                                    ...
                                                    if (Be.KEYCODE.TAB === a) {
                                                        ...
                                                        n = !m.accessibility.focusToolbar(r, !!e.shiftKey);
                                                    } else if (Be.KEYCODE.ARROW_UP === a || Be.KEYCODE.ARROW_DOWN === a || Be.KEYCODE.ARROW_LEFT === a || Be.KEYCODE.ARROW_RIGHT === a) {
                                                        if (t.is("span.fr-select-color")) {
                                                            var i = t.parent().find("span.fr-select-color"),
                                                                o = i.index(t),
                                                                s = m.opts.colorsStep,
                                                                l = Math.floor(i.length / s),
                                                                c = o % s,
                                                                d = Math.floor(o / s),
                                                                f = d * s + c,
                                                                p = l * s;
                                                            Be.KEYCODE.ARROW_UP === a
                                                                ? (f = (((f - s) % p) + p) % p)
                                                                : Be.KEYCODE.ARROW_DOWN === a
                                                                    ? (f = (f + s) % p)
                                                                    : Be.KEYCODE.ARROW_LEFT === a
                                                                        ? (f = (((f - 1) % p) + p) % p)
                                                                        : Be.KEYCODE.ARROW_RIGHT === a && (f = (f + 1) % p);
                                                            var u = v(i.get(f));
                                                            m.events.disableBlur(), u.focus(), (n = !1);
                                                        }
                                                    } else Be.KEYCODE.ENTER === a && (m.button.exec(t), (n = !1));
                            ...
                            if ((m.popups.setContainer("".concat(e, ".picker"), m.$tb), c("textColor" === e ? "text" : "background"), t.isVisible())) {
                                var n = m.button.getPosition(t),
                                    r = n.left,
                                    i = n.top;
                                m.popups.show("".concat(e, ".picker"), r, i, t.outerHeight());
                            } else m.position.forSelection(a), m.popups.show("".concat(e, ".picker"));
                    },
                    background: n,
                    customColor: function i(e) {
                        var t = m.popups.get("".concat(e, "Color.picker")).find(".fr-color-hex-layer input");
                        if (t.length) {
                            var a = t.val();
                            "background" === e ? n(a) : r(a);
                        }
                    },
                    text: r,
                    back: function e() {
            ...
            Be.DefineIcon("textColor", { NAME: "tint", SVG_KEY: "textColor" }),
            Be.RegisterCommand("textColor", {
                title: "Text Color",
                undo: !1,
                focus: !0,
                refreshOnCallback: !1,
            ...
            Be.RegisterCommand("applytextColor", {
                undo: !0,
                callback: function (e, t) {
                    this.colors.text(t);
                },
            }),
            Be.RegisterCommand("customTextColor", {
                title: "OK",
                undo: !0,
                callback: function () {
            ...
            Be.DefineIcon("backgroundColor", { NAME: "paint-brush", SVG_KEY: "backgroundColor" }),
            Be.RegisterCommand("backgroundColor", {
                ...
                callback: function () {
                    this.popups.isVisible("backgroundColor.picker")
                        ? (this.$el.find(".fr-marker").length && (this.events.disableBlur(), this.selection.restore()), this.popups.hide("backgroundColor.picker"))
                        : this.colors.showColorsPopup("backgroundColor");
                },
            }),
            Be.RegisterCommand("applybackgroundColor", {
                undo: !0,
                callback: function (e, t) {
                    this.colors.background(t);
                },
            }),
            Be.RegisterCommand("customBackgroundColor", {
                title: "OK",
                undo: !0,
                callback: function () {
            ...
            Be.DefineIcon("colorsBack", { NAME: "arrow-left", SVG_KEY: "back" }),
            Be.RegisterCommand("colorsBack", {
                title: "Back",
                undo: !1,
                focus: !1,
                back: !0,
            ...
            Be.DefineIcon("remove", { NAME: "eraser", SVG_KEY: "remove" }),
            Object.assign(Be.DEFAULTS, { dragInline: !0 }),
            (Be.PLUGINS.draggable = function (d) {
                var f = d.$;
                function e(e) {
                    return (
                        !(!e.originalEvent || !e.originalEvent.target || e.originalEvent.target.nodeType !== Node.TEXT_NODE) ||
                        (e.target && "A" === e.target.tagName && 1 === e.target.childNodes.length && "IMG" === e.target.childNodes[0].tagName && (e.target = e.target.childNodes[0]),
                            f(e.target).hasClass("fr-draggable")
                                ? (d.undo.canDo() || d.undo.saveStep(),
                                    d.opts.dragInline ? d.$el.attr("contenteditable", !0) : d.$el.attr("contenteditable", !1),
                                    d.opts.toolbarInline && d.toolbar.hide(),
                                    f(e.target).addClass("fr-dragging"),
                                    d.browser.msie || d.browser.edge || d.selection.clear(),
                                    void e.originalEvent.dataTransfer.setData("text", "Froala"))
                                : (e.preventDefault(), !1))
                    );
                }
                var p,
                ...
                function h(e, t, a) {
                    if (d.opts.iframe) {
                        var n = d.helpers.getPX(d.$wp.find(".fr-iframe").css("padding-top")),
                            r = d.helpers.getPX(d.$wp.find(".fr-iframe").css("padding-left"));
                        (e += d.$iframe.offset().top + n), (t += d.$iframe.offset().left + r);
                    }
                    p.offset().top !== e && p.css("top", e), p.offset().left !== t && p.css("left", t), p.width() !== a && p.css("width", a);
                }
                function t(e) {
                    (e.originalEvent.dataTransfer.dropEffect = "move"),
                        d.opts.dragInline
                            ? (!(function a() {
                                for (var e = null, t = 0; t < Be.INSTANCES.length; t++) if ((e = Be.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0);
                            })() ||
                                d.browser.msie ||
                                d.browser.edge) &&
                            e.preventDefault()
                            : (e.preventDefault(),
                                (function c(e) {
                                    ...
                                    if (!u(t)) {
                                        for (var a = 0, n = t; !u(n) && n === t && 0 < e.originalEvent.pageY - d.win.pageYOffset - a;)
                                            a++, (n = d.doc.elementFromPoint(e.originalEvent.pageX - d.win.pageXOffset, e.originalEvent.pageY - d.win.pageYOffset - a));
                                        (!u(n) || (p && 0 === d.$el.find(n).length && n !== p.get(0))) && (n = null);
                                        for (var r = 0, i = t; !u(i) && i === t && e.originalEvent.pageY - d.win.pageYOffset + r < f(d.doc).height();)
                                            r++, (i = d.doc.elementFromPoint(e.originalEvent.pageX - d.win.pageXOffset, e.originalEvent.pageY - d.win.pageYOffset + r));
                                        (!u(i) || (p && 0 === d.$el.find(i).length && i !== p.get(0))) && (i = null), (t = null === i && n ? n : i && null === n ? i : i && n ? (a < r ? n : i) : null);
                                    }
                                    if (f(t).hasClass("fr-drag-helper")) return !1;
                                    if (
                                        (t && !d.node.isBlock(t) && (t = d.node.blockParent(t)),
                                            t && 0 <= ["TD", "TH", "TR", "THEAD", "TBODY"].indexOf(t.tagName) && (t = f(t).parents("table").get(0)),
                                            t && 0 <= ["LI"].indexOf(t.tagName) && (t = f(t).parents("UL, OL").get(0)),
                                            t && !f(t).hasClass("fr-drag-helper"))
                                    ) {
                                        var o;
                                        p ||
                                            (Be.$draggable_helper || (Be.$draggable_helper = f(document.createElement("div")).attr("class", "fr-drag-helper")),
                                                (p = Be.$draggable_helper),
                                                d.events.on(
                                                    "shared.destroy",
                                                    function () {
                                            ...
                                            (o = e.originalEvent.pageY < f(t).offset().top + f(t).outerHeight() / 2);
                                        var s = f(t),
                                            l = 0;
                                        o || 0 !== s.next().length
                                            ? (o || (s = s.next()),
                                                ("before" === p.data("fr-position") && s.is(p.data("fr-tag"))) ||
                                                (0 < s.prev().length && (l = parseFloat(s.prev().css("margin-bottom")) || 0),
                                                    (l = Math.max(l, parseFloat(s.css("margin-top")) || 0)),
                                                    h(s.offset().top - l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()),
                                                    p.data("fr-position", "before")))
                                            : ("after" === p.data("fr-position") && s.is(p.data("fr-tag"))) ||
                                            ((l = parseFloat(s.css("margin-bottom")) || 0),
                                                h(s.offset().top + f(t).height() + l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()),
                ...
                function r(e) {
                    var t, a;
                    d.$el.attr("contenteditable", !0);
                    for (var n = 0; n < Be.INSTANCES.length; n++)
                        if ((t = Be.INSTANCES[n].$el.find(".fr-dragging")).length) {
                            a = Be.INSTANCES[n];
                            break;
                        }
                    if (t.length) {
                        ...
                        else d.$el.find(".fr-marker").replaceWith(Be.MARKERS), d.selection.restore();
                        if ((a === d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty())) d.$el.html(r);
                        else {
                            var i = d.markers.insert();
                            0 === r.find(i).length ? f(i).replaceWith(r) : 0 === t.find(i).length && f(i).replaceWith(t), t.after(Be.MARKERS), d.selection.restore();
                        }
                        return (
                            d.popups.hideAll(),
                            d.selection.save(),
                            ...
                            a !== d &&
                            (a.popups.hideAll(),
                                a.$el.find(a.html.emptyBlockTagsQuery()).not("TD, TH, LI, .fr-inner").remove(),
                                a.html.wrap(),
                                a.html.fillEmptyBlocks(),
                                a.undo.saveStep(),
                                a.events.trigger("element.dropped"),
                                a.opts.iframe && a.size.syncIframe()),
                            d.events.trigger("element.dropped", [r]),
                            !1
                        );
                    }
                ...
                function i(e) {
                    ...
                    else if (e && e.nodeType === Node.ELEMENT_NODE) for (var t = e.querySelectorAll("div.fr-drag-helper"), a = 0; a < t.length; a++) t[a].parentNode.removeChild(t[a]);
                }
                return {
                    _init: function o() {
                        d.opts.enter === Be.ENTER_BR && (d.opts.dragInline = !0),
                            d.events.on("dragstart", e, !0),
                            d.events.on("dragover", t, !0),
                            d.events.on("dragenter", a, !0),
                            d.events.on("document.dragend", n, !0),
                            d.events.on("document.drop", n, !0),
                            d.events.on("drop", r, !0),
                            d.events.on("html.processGet", i);
                    },
                };
            }),
            Object.assign(Be.DEFAULTS, { editInPopup: !1 }),
            (Be.MODULES.editInPopup = function (n) {
                function e() {
                    n.events.$on(n.$el, n._mouseup, function () {
                        setTimeout(function () {
                            !(function a() {
                                ...
                                (e = "INPUT" === n.el.tagName ? n.$el.attr("placeholder") : n.$el.text()),
                ...
                return {
                            ...
                            (!(function t() {
                                var e = {
                                    edit: '<div id="fr-text-edit-'
                                        .concat(n.id, '" class="fr-layer fr-text-edit-layer"><div class="fr-input-line"><input type="text" placeholder="')
                                        .concat(n.language.translate("Text"), '" tabIndex="1"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="updateText" tabIndex="2">')
                                        .concat(n.language.translate("Update"), "</button></div></div>"),
                                };
                    ...
                    update: function t() {
                        ...
                        0 === e.length && (e = n.opts.placeholderText), "INPUT" === n.el.tagName ? n.$el.attr("placeholder", e) : n.$el.text(e), n.events.trigger("contentChanged"), n.popups.hide("text.edit");
                    },
                };
            }),
            Be.RegisterCommand("updateText", {
                focus: !1,
                undo: !1,
                callback: function () {
            ...
            Object.assign(Be.POPUP_TEMPLATES, { emoticons: "[_BUTTONS_][_CUSTOM_LAYER_]" }),
            Object.assign(Be.DEFAULTS, {
                emoticonsSet: [
                    {
                        id: "people",
            ...
            (Be.PLUGINS.emoticons = function (m) {
                var v = m.$,
                ...
                function s() {
                    ...
                    var a = m.selection.ranges(0),
                        n = a.startContainer;
                    if (n.nodeType == Node.ELEMENT_NODE && 0 < n.childNodes.length && 0 < a.startOffset) {
                        var r = n.childNodes[a.startOffset - 1];
                                        ...
                                        return (
                                            e.forEach(function (e) {
                                                var t = { image: e.code.toLowerCase() },
                                                    a = {
                                                        elementClass: e.id === n.id ? "fr-active fr-active-tab" : "",
                                                ...
                                                r += '<button class="fr-command fr-btn '
                                                    .concat(a.elementClass, " ")
                                                    .concat(a.emoticonsUnicodeClass, '" \n      title="')
                                                    .concat(a.title, '" data-cmd="')
                                                    .concat(a.dataCmd, '" data-param1="')
                                                    .concat(a.dataParam1, '">\n       ')
                                                    .concat(a.image, " </button>");
                                            }),
                                            r
                                        );
                                    })(e, t),
                                        ...
                                        return (
                                            e.emoticons.forEach(function (e) {
                                                var t = e.code.split("-").reduce(function (e, t) {
                                                    ...
                                                    a = { image: e.code.toLowerCase(), compiledCode: e.uCode ? e.uCode : t },
                                                    n = {
                                                        dataParam1: e.code.toLowerCase(),
                                                        dataParam2: a.compiledCode,
                                                        title: m.language.translate(e.desc),
                                                        image: m.opts.emoticonsUseImage ? '<img src="https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/'.concat(a.image, '.svg"/>') : "".concat(a.compiledCode),
                                                ...
                                                r += '<span class="fr-command fr-emoticon fr-icon" role="button" \n      data-cmd="insertEmoticon" data-param1="'
                                                    .concat(n.dataParam1, '" \n      data-param2="')
                                                    .concat(n.dataParam2, '"  title="')
                                                    .concat(n.title, '" >\n      ')
                                                    .concat(n.image, '<span class="fr-sr-only">')
                                                    .concat(n.desc, "&nbsp;&nbsp;&nbsp;</span></span>");
                                            }),
                                            r
                                        );
                                    })(e),
                ...
                return {
                    _init: function e() {
                        ...
                        a(),
                            m.events.on("html.set", a),
                            m.events.on("keydown", function (e) {
                                if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                                    var t = m.selection.ranges(0),
                                        a = s();
                                    m.node.hasClass(a, "fr-emoticon-img") &&
                                        a &&
                                        (0 === t.startOffset && m.selection.element() === a ? v(a).before(Be.MARKERS + Be.INVISIBLE_SPACE) : v(a).after(Be.INVISIBLE_SPACE + Be.MARKERS), m.selection.restore());
                                }
                            }),
                            m.events.on("keyup", function (e) {
                                for (var t = m.el.querySelectorAll(".fr-emoticon"), a = 0; a < t.length; a++) "undefined" != typeof t[a].textContent && 0 === t[a].textContent.replace(/\u200B/gi, "").length && v(t[a]).remove();
                                if (!(e.which >= Be.KEYCODE.ARROW_LEFT && e.which <= Be.KEYCODE.ARROW_DOWN)) {
                                    var n = s();
                                    m.node.hasClass(n, "fr-emoticon-img") && (v(n).append(Be.MARKERS), m.selection.restore());
                                }
                            });
                    },
                    insert: function c(e, t) {
                        var a = s(),
                            n = m.selection.ranges(0);
                        a
                            ? (0 === n.startOffset && m.selection.element() === a
                                ? v(a).before(Be.MARKERS + Be.INVISIBLE_SPACE)
                                : 0 < n.startOffset && m.selection.element() === a && n.commonAncestorContainer.parentNode.classList.contains("fr-emoticon") && v(a).after(Be.INVISIBLE_SPACE + Be.MARKERS),
                                m.selection.restore(),
                                m.html.insert(
                                    '<span class="fr-emoticon fr-deletable'
                                        .concat(t ? " fr-emoticon-img" : "", '"')
                                        .concat(t ? ' style="background: url('.concat(t, ');"') : "", ">")
                                        .concat(t ? "&nbsp;" : e, "</span>&nbsp;")
                                        .concat(Be.MARKERS),
                                    !0
                                ))
                    ...
                    setEmoticonCategory: function a(t) {
                        (i = r.filter(function (e) {
                            return e.id === t;
                        })[0]),
                            (function e() {
                                m.popups.get("emoticons").html(o + l());
                            })();
                    },
                    showEmoticonsPopup: function d() {
                        ...
                        if (
                            (e ||
                                (e = (function i() {
                                    m.opts.toolbarInline && 0 < m.opts.emoticonsButtons.length && (o = '<div class="fr-buttons fr-emoticons-buttons fr-tabs">'.concat(m.button.buildList(m.opts.emoticonsButtons), "</div>"));
                                    var e = { buttons: o, custom_layer: l() },
                                                ...
                                                function (e) {
                                                    ...
                                                    if (Be.KEYCODE.TAB == i) {
                                                        if ((t.is("span.fr-emoticon") && e.shiftKey) || (t.is("a") && !e.shiftKey)) {
                                                            ...
                                                            a = !m.accessibility.focusToolbar(o, !!e.shiftKey);
                                                        }
                                                        if (!1 !== a) {
                                                            var s = g
                                                                .find("span.fr-emoticon:focus")
                                                                .first()
                                                                .concat(g.findVisible(" div.fr-tabs").first().concat(g.find("a")));
                                                            t.is("span.fr-emoticon") && (s = s.not("span.fr-emoticon:not(:focus)")),
                                                                (n = s.index(t)),
                                                                (n = e.shiftKey ? (((n - 1) % s.length) + s.length) % s.length : (n + 1) % s.length),
                                                                (r = s.get(n)),
                                                                m.events.disableBlur(),
                                                                r.focus(),
                                                                (a = !1);
                                                        }
                                                    } else if (Be.KEYCODE.ARROW_UP == i || Be.KEYCODE.ARROW_DOWN == i || Be.KEYCODE.ARROW_LEFT == i || Be.KEYCODE.ARROW_RIGHT == i) {
                                                        if (t.is("span.fr-emoticon")) {
                                                            ...
                                                            var c = m.opts.emoticonsStep,
                                                                ...
                                                                u = p * c + f,
                                                                h = d * c;
                                                            Be.KEYCODE.ARROW_UP == i
                                                                ? (u = (((u - c) % h) + h) % h)
                                                                : Be.KEYCODE.ARROW_DOWN == i
                                                                    ? (u = (u + c) % h)
                                                                    : Be.KEYCODE.ARROW_LEFT == i
                                                                        ? (u = (((u - 1) % h) + h) % h)
                                                                        : Be.KEYCODE.ARROW_RIGHT == i && (u = (u + 1) % h),
                                                                (r = v(l.get(u))),
                                                                m.events.disableBlur(),
                                                                r.focus(),
                                                                (a = !1);
                                                        }
                                                    } else Be.KEYCODE.ENTER == i && (t.is("a") ? t[0].click() : m.button.exec(t), (a = !1));
                            ...
                            var t = m.$tb.find('.fr-command[data-cmd="emoticons"]'),
                                a = m.button.getPosition(t),
                                n = a.left,
                                r = a.top;
                            m.popups.show("emoticons", n, r, t.outerHeight());
                        }
                    },
                    back: function t() {
            ...
            Be.DefineIcon("emoticons", { NAME: "smile-o", FA5NAME: "smile", SVG_KEY: "smile" }),
            Be.RegisterCommand("emoticons", {
                title: "Emoticons",
                undo: !1,
                focus: !0,
                refreshAfterCallback: !1,
            ...
            Be.RegisterCommand("insertEmoticon", {
                callback: function (e, t, a) {
                    this.emoticons.insert(a, this.opts.emoticonsUseImage ? "https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/".concat(t, ".svg") : null), this.popups.hide("emoticons");
                },
            }),
            Be.RegisterCommand("setEmoticonCategory", {
                undo: !1,
                focus: !1,
                callback: function (e, t) {
            ...
            Be.DefineIcon("emoticonsBack", { NAME: "arrow-left", SVG_KEY: "back" }),
            Be.RegisterCommand("emoticonsBack", {
                title: "Back",
                undo: !1,
                focus: !1,
                back: !0,
            ...
            (Be.PLUGINS.entities = function (r) {
                var i,
                    o,
                    s = r.$;
                function n(e) {
                    var t = e.textContent;
                    if (t.match(i)) {
                        for (var a = "", n = 0; n < t.length; n++) o[t[n]] ? (a += o[t[n]]) : (a += t[n]);
                        e.textContent = a;
                    }
                }
                function l(e) {
                    if (e && 0 <= ["STYLE", "SCRIPT", "svg", "IFRAME"].indexOf(e.tagName)) return !0;
                    for (var t = r.node.contents(e), a = 0; a < t.length; a++) t[a].nodeType === Node.TEXT_NODE ? n(t[a]) : l(t[a]);
                    return e.nodeType === Node.TEXT_NODE && n(e), !1;
                }
                var c = function c(e) {
                ...
                return {
                    _init: function d() {
                        ...
                        for (var a = 0; a < e.length; a++) {
                            var n = e.charAt(a);
                            (o[n] = "".concat(t[a], ";")), (i += "\\".concat(n + (a < e.length - 1 ? "|" : "")));
                        }
                        (i = new RegExp("(".concat(i, ")"), "g")), r.events.on("html.get", c, !0);
                    },
                };
            }),
            Object.assign(Be.POPUP_TEMPLATES, { "file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]" }),
            Object.assign(Be.DEFAULTS, {
                fileUpload: !0,
                fileUploadURL: null,
            ...
            (Be.PLUGINS.file = function (d) {
                ...
                function m() {
                    ...
                    e || (e = R()),
                        ...
                        r(d.language.translate("Uploading"), 0);
                }
                function i(e) {
                    var t = d.popups.get("file.insert");
                    t &&
                        (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"),
                ...
                function r(e, t) {
                    ...
                    if (a) {
                        var n = a.find(".fr-file-progress-bar-layer");
                        n.find("h3").text(e + (t ? " ".concat(t, "%") : "")),
                            n.removeClass("fr-error"),
                            t ? (n.find("div").removeClass("fr-indeterminate"), n.find("div > span").css("width", "".concat(t, "%"))) : n.find("div").addClass("fr-indeterminate");
                    }
                }
                function v(e, t, a) {
                    d.edit.on(),
                        d.events.focus(!0),
                        d.selection.restore(),
                        d.opts.fileUseSelectedText && d.selection.text().length && (t = d.selection.text()),
                        d.html.insert('<a href="'.concat(e, '" target="_blank" id="fr-inserted-file" class="fr-file">').concat(t, "</a>"));
                    var n = d.$el.find("#fr-inserted-file");
                    n.removeAttr("id"), d.popups.hide("file.insert"), d.undo.saveStep(), L(), d.events.trigger("file.inserted", [n, a]);
                }
                function b(e) {
                    var t = this.status,
                        a = this.response,
                                ...
                                var i = (function s(e) {
                                    try {
                                        var t = f(e).find("Location").text(),
                                            a = f(e).find("Key").text();
                                        return !1 === d.events.trigger("file.uploadedToS3", [t, a, e], !0) ? (d.edit.on(), !1) : t;
                                    } catch (n) {
                                        return T(h, e), !1;
                                    }
                                })(n);
                ...
                function E() {
                    T(h, this.response || this.responseText || this.responseXML);
                }
                function A(e) {
                ...
                function T(e, t) {
                    d.edit.on(),
                        (function n(e) {
                            ...
                            t.addClass("fr-error");
                            var a = t.find("h3");
                            a.text(e), d.events.disableBlur(), a.focus();
                        })(d.language.translate("Something went wrong. Please try again.")),
                        d.events.trigger("file.error", [{ code: e, message: a[e] }, t]);
                }
                function C() {
                    d.edit.on(), i(!0);
                }
                function o(e) {
                    if (void 0 !== e && 0 < e.length) {
                        ...
                        var t,
                            a = e[0];
                        if ((null === d.opts.fileUploadURL || d.opts.fileUploadURL === l) && !d.opts.fileUploadToS3)
                            return (
                                (function s(r) {
                                    var i = new FileReader();
                                    (i.onload = function () {
                                        for (var e = i.result, t = atob(i.result.split(",")[1]), a = [], n = 0; n < t.length; n++) a.push(t.charCodeAt(n));
                                        (e = window.URL.createObjectURL(new Blob([new Uint8Array(a)], { type: r.type }))), d.file.insert(e, r.name, null);
                                    }),
                                        m(),
                                        i.readAsDataURL(r);
                                })(a),
                        ...
                        if (a.size > d.opts.fileMaxSize) return T(c), !1;
                        if (d.opts.fileAllowedTypes.indexOf("*") < 0 && d.opts.fileAllowedTypes.indexOf(a.type.replace(/file\//g, "")) < 0) return T(g), !1;
                        if ((d.drag_support.formdata && (t = d.drag_support.formdata ? new FormData() : null), t)) {
                            var n;
                            if (!1 !== d.opts.fileUploadToS3)
                                for (n in (t.append("key", d.opts.fileUploadToS3.keyStart + new Date().getTime() + "-" + (a.name || "untitled")),
                                    t.append("success_action_status", "201"),
                                    t.append("X-Requested-With", "xhr"),
                                    t.append("Content-Type", a.type),
                                    d.opts.fileUploadToS3.params))
                                    d.opts.fileUploadToS3.params.hasOwnProperty(n) && t.append(n, d.opts.fileUploadToS3.params[n]);
                            for (n in d.opts.fileUploadParams) d.opts.fileUploadParams.hasOwnProperty(n) && t.append(n, d.opts.fileUploadParams[n]);
                            t.append(d.opts.fileUploadParam, a);
                            ...
                            var i = d.core.getXHR(r, d.opts.fileUploadMethod);
                            (i.onload = function () {
                                b.call(i, a.name);
                            }),
                                (i.onerror = E),
                                (i.upload.onprogress = A),
                                (i.onabort = C),
                                m();
                            var o = d.popups.get("file.insert");
                            o &&
                                (o.off("abortUpload"),
                                    o.on("abortUpload", function () {
                ...
                function R(e) {
                    ...
                    var a = "";
                    d.opts.fileUpload &&
                        (a = '<div class="fr-file-upload-layer fr-layer fr-active" id="fr-file-upload-layer-'
                            .concat(d.id, '"><strong>')
                            .concat(d.language.translate("Drop file"), "</strong><br>(")
                            .concat(d.language.translate("or click"), ')<div class="fr-form"><input type="file" name="')
                            .concat(d.opts.fileUploadParam, '" accept="')
                            .concat(0 <= d.opts.fileAllowedTypes.indexOf("*") ? "/" : "")
                            .concat(d.opts.fileAllowedTypes.join(", ").toLowerCase(), '" tabIndex="-1" aria-labelledby="fr-file-upload-layer-')
                            .concat(d.id, '" role="button"></div></div>'));
                    var n = {
                        buttons: t,
                        upload_layer: a,
                        progress_bar:
                        ...
                        r = d.popups.create("file.insert", n);
                    return (
                        (function i(a) {
                            d.events.$on(
                                a,
                                ...
                                d.events.$on(
                                    ...
                                    function (e) {
                                        ...
                                        t && t.files && (a.data("instance") || d).file.upload(t.files);
                                    },
                                    !0
                                ),
                                d.helpers.isIOS() &&
                                d.events.$on(a, "touchstart", '.fr-file-upload-layer input[type="file"]', function () {
                                ...
                                d.events.$on(
                                    ...
                                    function () {
                                        if (this.files) {
                                            var e = a.data("instance") || d;
                                            e.events.disableBlur(), a.find("input:focus").blur(), e.events.enableBlur(), e.file.upload(this.files);
                                        }
                                        f(this).val("");
                                    },
                                    !0
                    ...
                    if (t && t.files && t.files.length) {
                        ...
                        if (a && "undefined" != typeof a.type) {
                            if (a.type.indexOf("image") < 0) {
                                ...
                                d.markers.remove(), d.markers.insertAtPoint(e.originalEvent), d.$el.find(".fr-marker").replaceWith(Be.MARKERS), d.popups.hideAll();
                                var n = d.popups.get("file.insert");
                                return n || (n = R()), d.popups.setContainer("file.insert", d.$sc), d.popups.show("file.insert", e.originalEvent.pageX, e.originalEvent.pageY), m(), o(t.files), e.preventDefault(), e.stopPropagation(), !1;
                            }
                        } else a.type.indexOf("image") < 0 && (e.preventDefault(), e.stopPropagation());
                    }
                }
                function L() {
                    var e,
                        ...
                        a = [];
                    for (e = 0; e < t.length; e++) a.push(t[e].getAttribute("href"));
                    if (n) for (e = 0; e < n.length; e++) a.indexOf(n[e].getAttribute("href")) < 0 && d.events.trigger("file.unlink", [n[e]]);
                    n = t;
                }
                return (
                    (a[1] = "File cannot be loaded from the passed link."),
                    (a[p] = "No link in upload response."),
                    (a[u] = "Error during file upload."),
                    (a[h] = "Parsing response failed."),
                    (a[c] = "File is too large."),
                    (a[g] = "File file type is invalid."),
                    (a[7] = "Files can be uploaded only to same domain in IE 8 and IE 9."),
                    {
                        _init: function _() {
                            !(function e() {
                                d.events.on("drop", S),
                                    d.events.$on(d.$win, "keydown", function (e) {
                                        var t = e.which,
                                            a = d.popups.get("file.insert");
                                        a && t === Be.KEYCODE.ESC && a.trigger("abortUpload");
                                    }),
            ...
            Be.DefineIcon("insertFile", { NAME: "file-o", FA5NAME: "file", SVG_KEY: "insertFile" }),
            Be.RegisterCommand("insertFile", {
                title: "Upload File",
                undo: !1,
                focus: !0,
                refreshAfterCallback: !1,
            ...
            Be.DefineIcon("fileBack", { NAME: "arrow-left", SVG_KEY: "back" }),
            Be.RegisterCommand("fileBack", {
                title: "Back",
                undo: !1,
                focus: !1,
                back: !0,
            ...
            Be.RegisterCommand("fileDismissError", {
                title: "OK",
                callback: function () {
            ...
            (Be.PLUGINS.fontFamily = function (r) {
                var i = r.$;
                function o(e) {
                    var t = e
                ...
                function s(e, t) {
                    for (var a = 0; a < e.length; a++) for (var n = 0; n < t.length; n++) if (e[a].toLowerCase() === t[n].toLowerCase()) return [a, n];
                    return null;
                }
                function a() {
                    var e = o(i(r.selection.element()).css("font-family")),
                        t = [];
                    for (var a in r.opts.fontFamily)
                        if (r.opts.fontFamily.hasOwnProperty(a)) {
                            var n = s(e, o(a));
                            n && t.push([a, n]);
                        }
                    return 0 === t.length
                ...
                return {
                    ...
                    refreshOnShow: function n(e, t) {
                        t.find(".fr-command.fr-active").removeClass("fr-active").attr("aria-selected", !1), t.find('.fr-command[data-param1="'.concat(a(), '"]')).addClass("fr-active").attr("aria-selected", !0);
                    },
                    refresh: function l(e) {
                        if (r.opts.fontFamilySelection) {
                            var t = i(r.selection.element())
                                .css("font-family")
                                .replace(/(sans-serif|serif|monospace|cursive|fantasy)/gi, "")
                                .replace(/"|'|/g, "")
                                .split(",");
                            e.find("> span").text(r.opts.fontFamily[a()] || t[0] || r.language.translate(r.opts.fontFamilyDefaultSelection));
                        }
                    },
                };
            }),
            Be.RegisterCommand("fontFamily", {
                type: "dropdown",
                ...
                html: function () {
                    ...
                    for (var a in t)
                        t.hasOwnProperty(a) &&
                            (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="fontFamily" data-param1="'
                                .concat(a, '" \n        style="font-family: ')
                                .concat(a, '" title="')
                                .concat(t[a], '">')
                                .concat(t[a], "</a></li>"));
            ...
            Be.DefineIcon("fontFamily", { NAME: "font", SVG_KEY: "fontFamily" }),
            Object.assign(Be.DEFAULTS, { fontSize: ["8", "9", "10", "11", "12", "14", "18", "24", "30", "36", "48", "60", "72", "96"], fontSizeSelection: !1, fontSizeDefaultSelection: "12", fontSizeUnit: "px" }),
            (Be.PLUGINS.fontSize = function (n) {
                var r = n.$;
                return {
                    apply: function t(e) {
                        n.format.applyStyle("font-size", e);
                    },
                    refreshOnShow: function i(e, t) {
                        var a = r(n.selection.element()).css("font-size");
                        "pt" === n.opts.fontSizeUnit && (a = "".concat(Math.round((72 * parseFloat(a, 10)) / 96), "pt")),
                            t.find(".fr-command.fr-active").removeClass("fr-active").attr("aria-selected", !1),
                            t.find('.fr-command[data-param1="'.concat(a, '"]')).addClass("fr-active").attr("aria-selected", !0);
                    },
                    refresh: function a(e) {
                        if (n.opts.fontSizeSelection) {
                            var t = n.helpers.getPX(r(n.selection.element()).css("font-size"));
                            "pt" === n.opts.fontSizeUnit && (t = "".concat(Math.round((72 * parseFloat(t, 10)) / 96), "pt")), e.find("> span").text(t);
                        }
                    },
                };
            }),
            Be.RegisterCommand("fontSize", {
                type: "dropdown",
                title: "Font Size",
                displaySelection: function (e) {
                ...
                html: function () {
                    for (var e = '<ul class="fr-dropdown-list" role="presentation">', t = this.opts.fontSize, a = 0; a < t.length; a++) {
                        var n = t[a];
                        e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="fontSize" data-param1="'.concat(n).concat(this.opts.fontSizeUnit, '" title="').concat(n, '">').concat(n, "</a></li>");
                    }
                    return (e += "</ul>");
                },
                callback: function (e, t) {
            ...
            Be.DefineIcon("fontSize", { NAME: "text-height", SVG_KEY: "fontSize" }),
            Object.assign(Be.POPUP_TEMPLATES, { "forms.edit": "[_BUTTONS_]", "forms.update": "[_BUTTONS_][_TEXT_LAYER_]" }),
            Object.assign(Be.DEFAULTS, { formEditButtons: ["inputStyle", "inputEdit"], formStyles: { "fr-rounded": "Rounded", "fr-large": "Large" }, formMultipleStyles: !0, formUpdateButtons: ["inputBack", "|"] }),
            (Be.PLUGINS.forms = function (o) {
                var s,
                    l = o.$;
                function t(e) {
                    o.selection.clear(), l(this).data("mousedown", !0);
                }
                function a(e) {
                    l(this).data("mousedown") && (e.stopPropagation(), l(this).removeData("mousedown"), d((s = this))), e.preventDefault();
                }
                function n() {
                    o.$el.find("input, textarea, button").removeData("mousedown");
                }
                function r() {
                ...
                function d(e) {
                    if (-1 == ["checkbox", "radio"].indexOf(e.type)) {
                        var t = o.popups.get("forms.edit");
                        t ||
                            (t = (function i() {
                                var e = "";
                                0 < o.opts.formEditButtons.length && (e = '<div class="fr-buttons">'.concat(o.button.buildList(o.opts.formEditButtons), "</div>"));
                                var t = { buttons: e },
                                    a = o.popups.create("forms.edit", t);
                                return (
                                    o.$wp &&
                                    o.events.$on(o.$wp, "scroll.link-edit", function () {
                                        c() && o.popups.isVisible("forms.edit") && d(c());
                                    }),
                                    a
                                );
                            })());
                        var a = l((s = e));
                        o.popups.refresh("forms.edit"), o.popups.setContainer("forms.edit", o.$sc);
                        var n = a.offset().left + a.outerWidth() / 2,
                            r = a.offset().top + a.outerHeight();
                        o.popups.show("forms.edit", n, r, a.outerHeight());
                    }
                }
                function i() {
                    var e = o.popups.get("forms.update"),
                        t = c();
                    if (t) {
                        var a = l(t);
                        a.is("button")
                            ? e.find('input[type="text"][name="text"]').val(a.text())
                            : a.is("input[type=button]") || a.is("input[type=submit]") || a.is("input[type=reset]")
                                ? e.find('input[type="text"][name="text"]').val(a.val())
                ...
                function p(e) {
                    if (e) return o.popups.onRefresh("forms.update", i), o.popups.onHide("forms.update", f), !0;
                    var t = "";
                    1 <= o.opts.formUpdateButtons.length && (t = '<div class="fr-buttons">'.concat(o.button.buildList(o.opts.formUpdateButtons), "</div>"));
                    var a = 0,
                        n = {
                            buttons: t,
                            text_layer: '<div class="fr-forms-text-layer fr-layer fr-active"> \n    <div class="fr-input-line"><input name="text" type="text" placeholder="Text" tabIndex=" '
                                ...
                                .concat(o.language.translate("Update"), "</button></div></div>"),
                        };
                    return o.popups.create("forms.update", n);
                }
                return {
                    _init: function u() {
                        !(function e() {
                            o.events.$on(o.$el, o._mousedown, "input, textarea, button", t),
                                o.events.$on(o.$el, o._mouseup, "input, textarea, button", a),
                                o.events.$on(o.$el, "touchmove", "input, textarea, button", r),
                                o.events.$on(o.$el, o._mouseup, n),
                                o.events.$on(o.$win, o._mouseup, n),
                                p(!0);
                        })(),
                            o.events.$on(o.$el, "submit", "form", function (e) {
                    ...
                    updateInput: function h() {
                        ...
                        if (t) {
                            var a = l(t),
                                n = e.find('input[type="text"][name="text"]').val() || "";
                            a.is("button") ? (n.length ? a.text(n) : a.text("\u200b")) : -1 != ["button", "submit", "reset"].indexOf(t.type) ? a.attr("value", n) : a.attr("placeholder", n), o.popups.hide("forms.update"), d(t);
                        }
                    },
                    getInput: c,
                    applyStyle: function g(e, t, a) {
                        void 0 === t && (t = o.opts.formStyles), void 0 === a && (a = o.opts.formMultipleStyles);
                        var n = c();
                        if (!n) return !1;
                        if (!a) {
                            var r = Object.keys(t);
                            r.splice(r.indexOf(e), 1), l(n).removeClass(r.join(" "));
                        }
                        l(n).toggleClass(e);
                    },
                    showUpdatePopup: function m() {
                        ...
                        if (e) {
                            var t = l(e),
                                a = o.popups.get("forms.update");
                            a || (a = p()), o.popups.isVisible("forms.update") || o.popups.refresh("forms.update"), o.popups.setContainer("forms.update", o.$sc);
                    ...
                    showEditPopup: d,
                    back: function v() {
                        o.events.disableBlur(), o.selection.restore(), o.events.enableBlur();
                        var e = c();
                        e && o.$wp && ("BUTTON" === e.tagName && o.selection.restore(), d(e));
                    },
                };
            }),
            Be.RegisterCommand("updateInput", {
                undo: !1,
                focus: !1,
                title: "Update",
                callback: function () {
            ...
            Be.DefineIcon("inputStyle", { NAME: "magic", SVG_KEY: "inlineStyle" }),
            Be.RegisterCommand("inputStyle", {
                title: "Style",
                type: "dropdown",
                html: function () {
                    var e = '<ul class="fr-dropdown-list">',
                        t = this.opts.formStyles;
                    for (var a in t) t.hasOwnProperty(a) && (e += '<li><a class="fr-command" tabIndex="-1" data-cmd="inputStyle" data-param1="'.concat(a, '">').concat(this.language.translate(t[a]), "</a></li>"));
                    return (e += "</ul>");
                },
                callback: function (e, t) {
                    var a = this.forms.getInput();
                    a && (this.forms.applyStyle(t), this.forms.showEditPopup(a));
                },
                refreshOnShow: function (e, t) {
                    var a = this.$,
                        n = this.forms.getInput();
                    if (n) {
                        var r = a(n);
                        t.find(".fr-command").each(function () {
                            var e = a(this).data("param1");
                            a(this).toggleClass("fr-active", r.hasClass(e));
                        });
                    }
                },
            }),
            Be.DefineIcon("inputEdit", { NAME: "edit", SVG_KEY: "edit" }),
            Be.RegisterCommand("inputEdit", {
                title: "Edit Button",
                undo: !1,
                refreshAfterCallback: !1,
                callback: function () {
            ...
            Be.DefineIcon("inputBack", { NAME: "arrow-left", SVG_KEY: "back" }),
            Be.RegisterCommand("inputBack", {
                title: "Back",
                undo: !1,
                focus: !1,
                back: !0,
            ...
            (Be.PLUGINS.fullscreen = function (r) {
                var t,
                    a,
                    n,
                    i,
                ...
                function l() {
                    if (r.helpers.isIOS() && r.core.hasFocus()) return r.$el.blur(), setTimeout(d, 250), !1;
                    (t = r.helpers.scrollTop()),
                        r.$box.toggleClass("fr-fullscreen"),
                        o("body").first().toggleClass("fr-fullscreen"),
                        r.helpers.isMobile() && (r.$tb.data("parent", r.$tb.parent()), r.$box.prepend(r.$tb), r.$tb.data("sticky-dummy") && r.$tb.after(r.$tb.data("sticky-dummy"))),
                        (a = r.opts.height),
                        (n = r.opts.heightMax),
                        (i = r.opts.z_index),
                        (r.opts.height = r.o_win.innerHeight - (r.opts.toolbarInline ? 0 : r.$tb.outerHeight() + (r.$second_tb ? r.$second_tb.outerHeight() : 0))),
                        (r.opts.zIndex = 2147483641),
                        (r.opts.heightMax = null),
                        r.size.refresh(),
                        r.opts.toolbarInline && r.toolbar.showInline();
                    for (var e = r.$box.parent(); !e.first().is("body");) e.addClass("fr-fullscreen-wrapper"), (e = e.parent());
                ...
                function c() {
                    ...
                    r.$box.toggleClass("fr-fullscreen"),
                        o("body").first().toggleClass("fr-fullscreen"),
                        r.$tb.data("parent") && r.$tb.data("parent").prepend(r.$tb),
                        r.$tb.data("sticky-dummy") && r.$tb.after(r.$tb.data("sticky-dummy")),
                        (r.opts.height = a),
                        (r.opts.heightMax = n),
                        (r.opts.zIndex = i),
                        r.size.refresh(),
                        o(r.o_win).scrollTop(t),
                        r.opts.toolbarInline && r.toolbar.showInline(),
                        r.events.trigger("charCounter.update"),
                        r.opts.toolbarSticky &&
                        r.opts.toolbarStickyOffset &&
                        (r.opts.toolbarBottom ? r.$tb.css("bottom", r.opts.toolbarStickyOffset).data("bottom", r.opts.toolbarStickyOffset) : r.$tb.css("top", r.opts.toolbarStickyOffset).data("top", r.opts.toolbarStickyOffset));
                    for (var e = r.$box.parent(); !e.first().is("body");) e.removeClass("fr-fullscreen-wrapper"), (e = e.parent());
                    r.opts.toolbarContainer && o(r.opts.toolbarContainer).append(r.$tb), o(r.o_win).trigger("scroll"), r.events.trigger("codeView.update");
                }
                function d() {
                    s() ? c() : l(), f(r.$tb.find('.fr-command[data-cmd="fullscreen"]'));
                    var e = r.$tb.find('.fr-command[data-cmd="moreText"]'),
                        t = r.$tb.find('.fr-command[data-cmd="moreParagraph"]'),
                        a = r.$tb.find('.fr-command[data-cmd="moreRich"]'),
                        n = r.$tb.find('.fr-command[data-cmd="moreMisc"]');
                    e.length && r.refresh.moreText(e), t.length && r.refresh.moreParagraph(t), a.length && r.refresh.moreRich(a), n.length && r.refresh.moreMisc(n);
                }
                function f(e) {
                    var t = s();
                    e.toggleClass("fr-active", t).attr("aria-pressed", t),
                        e
                            .find("> *")
                            .not(".fr-sr-only")
                            .replaceWith(t ? r.icon.create("fullscreenCompress") : r.icon.create("fullscreen"));
                }
                return {
                    _init: function e() {
                        if (!r.$wp) return !1;
                        r.events.$on(o(r.o_win), "resize", function () {
                            s() && (c(), l());
                        }),
                            r.events.on("toolbar.hide", function () {
                                if (s() && r.helpers.isMobile()) return !1;
                            }),
                            r.events.on("position.refresh", function () {
                                if (r.helpers.isIOS()) return !s();
                            }),
                            r.events.on(
                                "destroy",
                                function () {
            ...
            Be.DefineIcon("fullscreen", { NAME: "expand", SVG_KEY: "fullscreen" }),
            Be.DefineIcon("fullscreenCompress", { NAME: "compress", SVG_KEY: "exitFullscreen" }),
            Object.assign(Be.DEFAULTS, {
                helpSets: [
                    { title: "Inline Editor", commands: [{ val: "OSkeyE", desc: "Show the editor" }] },
                    {
                            ...
                            var e = "<h4>".concat(s.language.translate("Shortcuts"), "</h4>"),
                                t = (function o() {
                                    for (var e = '<div class="fr-help-modal">', t = 0; t < s.opts.helpSets.length; t++) {
                                        var a = s.opts.helpSets[t],
                                            n = "<table>";
                                        (n += "<thead><tr><th>".concat(s.language.translate(a.title), "</th></tr></thead>")), (n += "<tbody>");
                                        for (var r = 0; r < a.commands.length; r++) {
                                            var i = a.commands[r];
                                            (n += "<tr>"), (n += "<td>".concat(s.language.translate(i.desc), "</td>")), (n += "<td>".concat(i.val.replace("OSkey", s.helpers.isMac() ? "&#8984;" : "Ctrl+"), "</td>")), (n += "</tr>");
                                        }
                                        e += n += "</tbody></table>";
                                    }
                                    return (e += "</div>");
                                })(),
                                a = s.modals.create(i, e, t);
                            (n = a.$modal),
                                s.events.$on(r(s.o_win), "resize", function () {
                                    s.modals.resize(i);
                                });
                        }
                        s.modals.show(i), s.modals.resize(i);
                    },
                    hide: function t() {
                        s.modals.hide(i);
                    },
            ...
            Be.DefineIcon("help", { NAME: "question", SVG_KEY: "help" }),
            Be.RegisterShortcut(Be.KEYCODE.SLASH, "help", null, "/"),
            Be.RegisterCommand("help", {
                title: "Help",
                icon: "help",
                undo: !1,
                focus: !1,
            ...
            Object.assign(Be.POPUP_TEMPLATES, { "image.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_BY_URL_LAYER_][_PROGRESS_BAR_]", "image.edit": "[_BUTTONS_]", "image.alt": "[_BUTTONS_][_ALT_LAYER_]", "image.size": "[_BUTTONS_][_SIZE_LAYER_]" }),
            Object.assign(Be.DEFAULTS, {
            ...
            (Be.PLUGINS.image = function (f) {
                ...
                function i() {
                    ...
                    if ((e || (e = x()), e)) {
                        var t = Ae();
                        Te() && (t = t.find(".fr-img-wrap")), f.popups.setContainer("image.edit", f.$sc), f.popups.refresh("image.edit");
                        var a = t.offset().left + t.outerWidth() / 2,
                            n = t.offset().top + t.outerHeight();
                        p.hasClass("fr-uploading") ? F() : f.popups.show("image.edit", a, n, t.outerHeight(), !0);
                    }
                }
                function A() {
                    k();
                ...
                function T(e) {
                    ...
                    var t = e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null,
                        a = e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : ge(e);
                    he(e, t, a), e.removeClass("fr-dib fr-dii fr-fir fr-fil");
                }
                function C() {
                    for (var e, t = "IMG" == f.el.tagName ? [f.el] : f.el.querySelectorAll("img"), a = 0; a < t.length; a++) {
                        var n = u(t[a]);
                        !f.opts.htmlUntouched && f.opts.useClasses
                            ? ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) &&
                                (0 < (e = n).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption").first()),
                                    e.hasClass("fr-dii") ||
                                    e.hasClass("fr-dib") ||
                                    (e.addClass("fr-fi".concat(ge(e)[0])),
                                        e.addClass("fr-di".concat(me(e)[0])),
                                        e.css("margin", ""),
                                        e.css("float", ""),
                                        e.css("display", ""),
                                        e.css("z-index", ""),
                                ...
                                f.opts.imageTextNear || (0 < n.parents(".fr-img-caption").length ? n.parents(".fr-img-caption").first().removeClass("fr-dii").addClass("fr-dib") : n.removeClass("fr-dii").addClass("fr-dib")))
                            : f.opts.htmlUntouched || f.opts.useClasses || ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) && T(n)),
                            f.opts.iframe && n.on("load", f.size.syncIframe);
                    }
                }
                function R(e) {
                    void 0 === e && (e = !0);
                    var t,
                        a = Array.prototype.slice.call(f.el.querySelectorAll("img")),
                        n = [];
                    for (t = 0; t < a.length; t++)
                        if (
                            (n.push(a[t].getAttribute("src")),
                                u(a[t]).toggleClass("fr-draggable", f.opts.imageMove),
                                "" === a[t].getAttribute("class") && a[t].removeAttribute("class"),
                                "" === a[t].getAttribute("style") && a[t].removeAttribute("style"),
                                a[t].parentNode && a[t].parentNode.parentNode && f.node.hasClass(a[t].parentNode.parentNode, "fr-img-caption"))
                        ) {
                            ...
                            i && !f.browser.mozilla && i.setAttribute("contenteditable", !0);
                        }
                    if (s) for (t = 0; t < s.length; t++) n.indexOf(s[t].getAttribute("src")) < 0 && f.events.trigger("image.removed", [u(s[t])]);
                    if (s && e) {
                        var o = [];
                        for (t = 0; t < s.length; t++) o.push(s[t].getAttribute("src"));
                        for (t = 0; t < a.length; t++) o.indexOf(a[t].getAttribute("src")) < 0 && f.events.trigger("image.loaded", [u(a[t])]);
                    }
                    s = a;
                }
                function S() {
                        ...
                        (l ||
                            (function o() {
                                ...
                                f.shared.$image_resizer
                                    ...
                                    : ((f.shared.$image_resizer = u(document.createElement("div")).attr("class", "fr-image-resizer")),
                                        (l = f.shared.$image_resizer),
                                        f.events.$on(
                                            l,
                                            "mousedown",
                                        ...
                                        f.opts.imageResize &&
                                        (l.append(L("nw") + L("ne") + L("sw") + L("se")),
                                            (f.shared.$img_overlay = u(document.createElement("div")).attr("class", "fr-image-overlay")),
                                            (d = f.shared.$img_overlay),
                                            (e = l.get(0).ownerDocument),
                                            u(e).find("body").first().append(d)));
                                f.events.on(
                                    "shared.destroy",
                                    function () {
                                    ...
                                    f.helpers.isMobile() ||
                                    f.events.$on(u(f.o_win), "resize", function () {
                                        p && !p.hasClass("fr-uploading") ? de(!0) : p && (S(), ve(), F(!1));
                                    });
                                if (f.opts.imageResize) {
                                    (e = l.get(0).ownerDocument),
                                        f.events.$on(l, f._mousedown, ".fr-handler", y),
                                        f.events.$on(u(e), f._mousemove, w),
                                        f.events.$on(u(e.defaultView || e.parentWindow), f._mouseup, I),
                                        f.events.$on(d, "mouseleave", I);
                                    var n = 1,
                                        r = null,
                                        i = 0;
                                    f.events.on(
                                        ...
                                        function (e) {
                                            if (p) {
                                                var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                                    a = e.which;
                                                (a !== r || 200 < e.timeStamp - i) && (n = 1),
                                                    (a == Be.KEYCODE.EQUALS || (f.browser.mozilla && a == Be.KEYCODE.FF_EQUALS)) && t && !e.altKey
                                                        ? (n = ee.call(this, e, 1, 1, n))
                                                        : (a == Be.KEYCODE.HYPHEN || (f.browser.mozilla && a == Be.KEYCODE.FF_HYPHEN)) && t && !e.altKey
                                                            ? (n = ee.call(this, e, 2, -1, n))
                                                            : f.keys.ctrlKey(e) || a != Be.KEYCODE.ENTER || (p.before("<br>"), M(p)),
                                                    (r = a),
                                                    (i = e.timeStamp);
                                            }
                                        },
                    ...
                    (a -= f.helpers.getPX(e.css("border-left-width"))), (t -= f.helpers.getPX(e.css("border-top-width"))), f.$el.is("img") && f.$sc.is("body") && (a = t = 0);
                    var n = Ae();
                    Te() && (n = n.find(".fr-img-wrap"));
                    var r = 0,
                        i = 0;
                    f.opts.iframe && ((r = f.helpers.getPX(f.$wp.find(".fr-iframe").css("padding-top"))), (i = f.helpers.getPX(f.$wp.find(".fr-iframe").css("padding-left")))),
                        l
                            .css("top", (f.opts.iframe ? n.offset().top + r : n.offset().top + t) - 1)
                            .css("left", (f.opts.iframe ? n.offset().left + i : n.offset().left + a) - 1)
                            .css("width", n.get(0).getBoundingClientRect().width)
                            .css("height", n.get(0).getBoundingClientRect().height)
                            .addClass("fr-active");
                }
                function L(e) {
                ...
                function _(e) {
                    Te() ? p.parents(".fr-img-caption").css("width", e) : p.css("width", e);
                }
                function y(e) {
                    ...
                    if ("mousedown" == e.type) {
                        var a = f.$oel.get(0).ownerDocument,
                            n = a.defaultView || a.parentWindow,
                            r = !1;
                        try {
                            r = n.location != n.parent.location && !(n.$ && n.$.FE);
                        } catch (s) { }
                        r && n.frameElement && (t += f.helpers.getPX(u(n.frameElement).offset().left) + n.frameElement.clientLeft);
                    }
                    ...
                    if (f.opts.imageResizeWithPercent) {
                        ...
                        i = ((i / u(o).outerWidth()) * 100).toFixed(2) + "%";
                    }
                    _(i), d.show(), f.popups.hideAll(), ue();
                }
                function w(e) {
                    if (!f.core.sameInstance(l)) return !0;
                    var t;
                    if (c && p) {
                        ...
                        if (!a) return !1;
                        var n = a - c.data("start-x"),
                            r = c.data("start-width");
                        if (((c.hasClass("fr-hnw") || c.hasClass("fr-hsw")) && (n = 0 - n), f.opts.imageResizeWithPercent)) {
                            var i = p.parentsUntil(f.$el, f.html.blockTagsQuery()).get(0) || f.el;
                            (r = (((r + n) / u(i).outerWidth()) * 100).toFixed(2)),
                                f.opts.imageRoundPercent && (r = Math.round(r)),
                                _("".concat(r, "%")),
                                (t = Te() ? ((f.helpers.getPX(p.parents(".fr-img-caption").css("width")) / u(i).outerWidth()) * 100).toFixed(2) : ((f.helpers.getPX(p.css("width")) / u(i).outerWidth()) * 100).toFixed(2)) === r ||
                                f.opts.imageRoundPercent ||
                                _("".concat(t, "%")),
                                p.css("height", "").removeAttr("height");
                        } else
                            r + n >= f.opts.imageMinWidth && (_(r + n), (t = Te() ? f.helpers.getPX(p.parents(".fr-img-caption").css("width")) : f.helpers.getPX(p.css("width")))),
                                t !== r + n && _(t),
                                ((p.attr("style") || "").match(/(^height:)|(; *height:)/) || p.attr("height")) && (p.css("height", (c.data("start-height") * p.width()) / c.data("start-width")), p.removeAttr("height"));
                        S(), f.events.trigger("image.resize", [Ee()]);
                    }
                }
                function I(e) {
                    if (!f.core.sameInstance(l)) return !0;
                    if (c && p) {
                        ...
                        (c = null), d.hide(), S(), i(), f.undo.saveStep(), f.events.trigger("image.resizeEnd", [Ee()]);
                    } else l.removeClass("fr-active");
                }
                function O(e, t, a) {
                    f.edit.on(),
                        p && p.addClass("fr-error"),
                        r[e] ? D(f.language.translate(r[e])) : D(f.language.translate("Something went wrong. Please try again.")),
                        !p && a && te(a),
                        f.events.trigger("image.error", [{ code: e, message: r[e] }, t, a]);
                }
                function x(e) {
                    if (e)
                        return (
                            f.$wp &&
                            f.events.$on(f.$wp, "scroll.image-edit", function () {
                                p && f.popups.isVisible("image.edit") && (f.events.disableBlur(), i());
                            }),
                            !0
                        );
                    var t = "";
                    if (0 < f.opts.imageEditButtons.length) {
                        ...
                        return f.popups.create("image.edit", a);
                    }
                    return !1;
                }
                function F(e) {
                    ...
                    if ((t || (t = z()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), p)) {
                        ...
                        f.popups.show("image.insert", n, r, a.outerHeight());
                    }
                    void 0 === e && N(f.language.translate("Uploading"), 0);
                }
                function k(e) {
                    var t = f.popups.get("image.insert");
                    if (
                        t &&
                        (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || f.$el.find("img.fr-error").length)
                    ) {
                        if ((f.events.focus(), f.$el.find("img.fr-error").length && (f.$el.find("img.fr-error").remove(), f.undo.saveStep(), f.undo.run(), f.undo.dropRedo()), !f.$wp && p)) {
                            var a = p;
                            de(!0), f.selection.setAfter(a.get(0)), f.selection.restore();
                        }
                ...
                function N(e, t) {
                    ...
                    if (a) {
                        var n = a.find(".fr-image-progress-bar-layer");
                        n.find("h3").text(e + (t ? " ".concat(t, "%") : "")),
                            n.removeClass("fr-error"),
                            t ? (n.find("div").removeClass("fr-indeterminate"), n.find("div > span").css("width", "".concat(t, "%"))) : n.find("div").addClass("fr-indeterminate");
                    }
                ...
                function D(e) {
                    ...
                    t.addClass("fr-error");
                    var a = t.find("h3");
                    a.text(e), f.events.disableBlur(), a.focus();
                }
                function M(e) {
                    ce.call(e.get(0));
                }
                function B() {
                    var e = u(this);
                    f.popups.hide("image.insert"), e.removeClass("fr-uploading"), e.next().is("br") && e.next().remove(), M(e), f.events.trigger("image.loaded", [e]);
                }
                function P(o, e, s, l, c) {
                    l && "string" == typeof l && (l = f.$(l)), f.edit.off(), N(f.language.translate("Loading image")), e && (o = f.helpers.sanitizeURL(o));
                    var t = new Image();
                    (t.onload = function () {
                        var e, t;
                        if (l) {
                            ...
                            l.data("fr-image-pasted") && (a = null),
                                f.$wp ? ((e = l.clone().removeData("fr-old-src").removeClass("fr-uploading").removeAttr("data-fr-image-pasted")).off("load"), a && l.attr("src", a), l.replaceWith(e)) : (e = l);
                            for (var n = e.get(0).attributes, r = 0; r < n.length; r++) {
                                var i = n[r];
                                0 === i.nodeName.indexOf("data-") && e.removeAttr(i.nodeName);
                            }
                            if (void 0 !== s) for (t in s) s.hasOwnProperty(t) && "link" != t && e.attr("data-".concat(t), s[t]);
                            e.on("load", B), e.attr("src", o), f.edit.on(), R(!1), f.undo.saveStep(), f.events.disableBlur(), f.$el.blur(), f.events.trigger(a ? "image.replaced" : "image.inserted", [e, c]);
                        } else (e = H(o, s, B)), R(!1), f.undo.saveStep(), f.events.disableBlur(), f.$el.blur(), f.events.trigger("image.inserted", [e, c]);
                    }),
                        (t.onerror = function () {
                            O(n);
                        }),
                        F(f.language.translate("Loading image")),
                        (t.src = o);
                }
                function U(e) {
                    N(f.language.translate("Loading image"));
                    var t = this.status,
                        a = this.response,
                        n = this.responseXML,
                        r = this.responseText;
                        ...
                        if (f.opts.imageUploadToS3)
                                ...
                                var i = (function s(e) {
                                    try {
                                        var t = u(e).find("Location").text(),
                                            a = u(e).find("Key").text();
                                        return !1 === f.events.trigger("image.uploadedToS3", [t, a, e], !0) ? (f.edit.on(), !1) : t;
                                    } catch (n) {
                                        return O(m, e), !1;
                                    }
                                })(n);
                            ...
                            var o = (function l(e) {
                                try {
                                    ...
                                    var t = JSON.parse(e);
                                    return t.link ? t : (O(h, e), !1);
                                } catch (a) {
                                    return O(m, e), !1;
                                }
                            })(r);
                            o && P(o.link, !1, o, e, a || r);
                        } else O(g, a || r, e);
                    } catch (c) {
                        O(m, a || r, e);
                    }
                ...
                function W() {
                    O(m, this.response || this.responseText || this.responseXML);
                }
                function K(e) {
                    if (e.lengthComputable) {
                        var t = ((e.loaded / e.total) * 100) | 0;
                ...
                function H(e, t, a) {
                    var n,
                        r = u(document.createElement("img")).attr("src", e);
                    if (t && void 0 !== t) for (n in t) t.hasOwnProperty(n) && "link" != n && (" data-".concat(n, '="').concat(t[n], '"'), r.attr("data-str".concat(n), t[n]));
                    var i = f.opts.imageDefaultWidth;
                    i && "auto" != i && (i = f.opts.imageResizeWithPercent ? "100%" : "".concat(i, "px")),
                        r.attr("style", i ? "width: ".concat(i, ";") : ""),
                        ...
                        f.selection.restore(),
                        f.undo.saveStep(),
                        f.opts.imageSplitHTML ? f.markers.split() : f.markers.insert(),
                        f.html.wrap();
                    var o = f.$el.find(".fr-marker");
                    return o.length ? (o.parent().is("hr") && o.parent().after(o), f.node.isLastSibling(o) && o.parent().hasClass("fr-deletable") && o.insertAfter(o.parent()), o.replaceWith(r)) : f.$el.append(r), f.selection.clear(), r;
                }
                function $() {
                    f.edit.on(), k(!0);
                }
                function G(e, t) {
                    if (void 0 !== e && 0 < e.length) {
                        ...
                        var a,
                            n = e[0];
                        if ((null === f.opts.imageUploadURL || f.opts.imageUploadURL == o) && !f.opts.imageUploadToS3)
                            return (
                                (function s(r, i) {
                                    ...
                                    (o.onload = function () {
                                        ...
                                        if (o.result.indexOf("svg+xml") < 0) {
                                            for (var t = atob(o.result.split(",")[1]), a = [], n = 0; n < t.length; n++) a.push(t.charCodeAt(n));
                                            (e = window.URL.createObjectURL(new Blob([new Uint8Array(a)], { type: r.type }))), f.image.insert(e, !1, null, i);
                                        }
                                    }),
                                        F(),
                                        o.readAsDataURL(r);
                        ...
                        if ((n.name || (n.name = new Date().getTime() + "." + (n.type || "image/jpeg").replace(/image\//g, "")), n.size > f.opts.imageMaxSize)) return O(v), !1;
                        if (f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) < 0) return O(b), !1;
                        if ((f.drag_support.formdata && (a = f.drag_support.formdata ? new FormData() : null), a)) {
                            var r;
                            if (!1 !== f.opts.imageUploadToS3)
                                for (r in (a.append("key", f.opts.imageUploadToS3.keyStart + new Date().getTime() + "-" + (n.name || "untitled")),
                                    a.append("success_action_status", "201"),
                                    a.append("X-Requested-With", "xhr"),
                                    a.append("Content-Type", n.type),
                                    f.opts.imageUploadToS3.params))
                                    f.opts.imageUploadToS3.params.hasOwnProperty(r) && a.append(r, f.opts.imageUploadToS3.params[r]);
                            for (r in f.opts.imageUploadParams) f.opts.imageUploadParams.hasOwnProperty(r) && a.append(r, f.opts.imageUploadParams[r]);
                            a.append(f.opts.imageUploadParam, n, n.name);
                            var i = f.opts.imageUploadURL;
                            f.opts.imageUploadToS3 && (i = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://".concat(f.opts.imageUploadToS3.region, ".amazonaws.com/").concat(f.opts.imageUploadToS3.bucket)),
                                (function l(t, a, e, r) {
                                    function i() {
                                        var e = u(this);
                                        e.off("load"),
                                            ...
                                            (t.onabort = $),
                                            u(e.off("abortUpload")).on("abortUpload", function () {
                                    ...
                                    (o.onload = function () {
                                        ...
                                        o.readAsDataURL(e);
                                })(f.core.getXHR(i, f.opts.imageUploadMethod), a, n, t || p);
                        }
                    }
                }
                function Y(e) {
                ...
                function V(e) {
                    ...
                    if (t && t.files && t.files.length) {
                        var a = t.files[0];
                        if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
                            if (!f.opts.imageUpload) return e.preventDefault(), e.stopPropagation(), !1;
                            f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(Be.MARKERS), 0 === f.$el.find(".fr-marker").length && f.selection.setAtEnd(f.el), f.popups.hideAll();
                            var n = f.popups.get("image.insert");
                            n || (n = z()), f.popups.setContainer("image.insert", f.$sc);
                            var r = e.originalEvent.pageX,
                                i = e.originalEvent.pageY;
                            if (f.opts.iframe) {
                                var o = f.helpers.getPX(f.$wp.find(".fr-iframe").css("padding-top")),
                                    s = f.helpers.getPX(f.$wp.find(".fr-iframe").css("padding-left"));
                                (i += f.$iframe.offset().top + o), (r += f.$iframe.offset().left + s);
                            }
                            return f.popups.show("image.insert", r, i), F(), 0 <= f.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, "")) ? (de(!0), G(t.files)) : O(b), e.preventDefault(), e.stopPropagation(), !1;
                        }
                    }
                }
                function z(e) {
                    if (e) return f.popups.onRefresh("image.insert", E), f.popups.onHide("image.insert", A), !0;
                    var t,
                        a,
                        n = "";
                    ...
                    "" !== r && (n = '<div class="fr-buttons fr-tabs">'.concat(r, "</div>"));
                    var i = f.opts.imageInsertButtons.indexOf("imageUpload"),
                    ...
                    0 <= i &&
                        ((t = " fr-active"),
                            ...
                            (s = '<div class="fr-image-upload-layer'
                                ...
                                .concat(f.id, '"><strong>')
                                .concat(f.language.translate("Drop image"), "</strong><br>(")
                                .concat(f.language.translate("or click"), ')<div class="fr-form"><input type="file" accept="image/')
                                .concat(f.opts.imageAllowedTypes.join(", image/").toLowerCase(), '" tabIndex="-1" aria-labelledby="fr-image-upload-layer-')
                                .concat(f.id, '" role="button"></div></div>')));
                    var l = "";
                    0 <= o &&
                        ((t = " fr-active"),
                            0 <= i && i < o && (t = ""),
                            (l = '<div class="fr-image-by-url-layer'
                                ...
                                .concat(f.id, '"><div class="fr-input-line"><input id="fr-image-by-url-layer-text-')
                                .concat(
                                    f.id,
                                ...
                                .concat(f.language.translate("Insert"), "</button></div></div>")));
                    var c = {
                        buttons: n,
                        upload_layer: s,
                        by_url_layer: l,
                    ...
                    return (
                        1 <= f.opts.imageInsertButtons.length && (a = f.popups.create("image.insert", c)),
                        f.$wp &&
                        ...
                        (function d(n) {
                            f.events.$on(
                                ...
                                f.events.$on(
                                    ...
                                    function () {
                                        if (this.files) {
                                            var e = n.data("instance") || f;
                                            e.events.disableBlur(), n.find("input:focus").blur(), e.events.enableBlur(), e.image.upload(this.files, p);
                                        }
                                        u(this).val("");
                                    },
                                    !0
                ...
                function q() {
                    ...
                    var t = Ae();
                    Te() && (t = t.find(".fr-img-wrap"));
                    var a = t.offset().left + t.outerWidth() / 2,
                        n = t.offset().top + t.outerHeight();
                    f.popups.show("image.alt", a, n, t.outerHeight(), !0);
                }
                function X(e) {
                    ...
                    var t = {
                        ...
                        alt_layer: '<div class="fr-image-alt-layer fr-layer fr-active" id="fr-image-alt-layer-'
                            .concat(f.id, '"><div class="fr-input-line"><input id="fr-image-alt-layer-text-')
                            .concat(f.id, '" type="text" placeholder="')
                            .concat(f.language.translate("Alternative Text"), '" tabIndex="1"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageSetAlt" tabIndex="2" role="button">')
                            .concat(f.language.translate("Update"), "</button></div></div>"),
                    },
                        a = f.popups.create("image.alt", t);
                    return (
                        f.$wp &&
                ...
                function J() {
                    var e = f.popups.get("image.size");
                    e || (e = Z()), k(), f.popups.refresh("image.size"), f.popups.setContainer("image.size", f.$sc);
                    var t = Ae();
                    Te() && (t = t.find(".fr-img-wrap"));
                    var a = t.offset().left + t.outerWidth() / 2,
                        n = t.offset().top + t.outerHeight();
                    f.popups.show("image.size", a, n, t.outerHeight(), !0);
                }
                function Z(e) {
                    if (e) return f.popups.onRefresh("image.size", Q), !0;
                    var t = {
                        ...
                        size_layer: '<div class="fr-image-size-layer fr-layer fr-active" id="fr-image-size-layer-'
                            .concat(f.id, '"><div class="fr-image-group"><div class="fr-input-line"><input id="fr-image-size-layer-width-\'')
                            .concat(f.id, '" type="text" name="width" placeholder="')
                            .concat(f.language.translate("Width"), '" tabIndex="1"></div><div class="fr-input-line"><input id="fr-image-size-layer-height')
                            .concat(f.id, '" type="text" name="height" placeholder="')
                            .concat(f.language.translate("Height"), '" tabIndex="1"></div></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageSetSize" tabIndex="2" role="button">')
                            .concat(f.language.translate("Update"), "</button></div></div>"),
                    },
                        a = f.popups.create("image.size", t);
                    return (
                        f.$wp &&
                        f.events.$on(f.$wp, "scroll.image-size", function () {
                            p && f.popups.isVisible("image.size") && J();
                        }),
                        a
                    );
                }
                function ee(e, t, a, n) {
                    return (e.pageX = t), y.call(this, e), (e.pageX = e.pageX + a * Math.floor(Math.pow(1.1, n))), w.call(this, e), I.call(this, e), ++n;
                }
                function te(e) {
                    (e = e || Ae()) &&
                        ...
                        (f.popups.hideAll(),
                            ...
                            e.get(0) == f.el
                                ...
                                : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName
                                    ? (f.selection.setBefore(e.get(0).parentNode) || f.selection.setAfter(e.get(0).parentNode) || e.parent().after(Be.MARKERS), u(e.get(0).parentNode).remove())
                                    : (f.selection.setBefore(e.get(0)) || f.selection.setAfter(e.get(0)) || e.after(Be.MARKERS), e.remove()),
                ...
                function ae(e) {
                    var t = e.which;
                    if (p && (t == Be.KEYCODE.BACKSPACE || t == Be.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), te(), !1;
                    if (p && t == Be.KEYCODE.ESC) {
                        var a = p;
                        return de(!0), f.selection.setAfter(a.get(0)), f.selection.restore(), e.preventDefault(), !1;
                    }
                    if (!p || (t != Be.KEYCODE.ARROW_LEFT && t != Be.KEYCODE.ARROW_RIGHT))
                        return p && t === Be.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), de(!0), !1) : p && t != Be.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0;
                    var n = p.get(0);
                    return de(!0), t == Be.KEYCODE.ARROW_LEFT ? f.selection.setBefore(n) : f.selection.setAfter(n), f.selection.restore(), e.preventDefault(), !1;
                }
                function ne(e) {
                    if (e && "IMG" == e.tagName) {
                        if (
                            (f.node.hasClass(e, "fr-uploading") || f.node.hasClass(e, "fr-error") ? e.parentNode.removeChild(e) : f.node.hasClass(e, "fr-draggable") && e.classList.remove("fr-draggable"),
                                e.parentNode && e.parentNode.parentNode && f.node.hasClass(e.parentNode.parentNode, "fr-img-caption"))
                        ) {
                    ...
                    } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var n = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), r = 0; r < n.length; r++) ne(n[r]);
                }
                function re(e) {
                    ...
                    (p = u(e)),
                        ...
                        p.on("load", function () {
                            var t = [];
                            S(),
                                u(f.popups.get("image.insert").get(0)).find("div.fr-active.fr-error").length < 1 && F(),
                                u(this)
                                    .data("events")
                                    .find(function (e) {
                                        "load" === e[0] && t.push(e);
                    ...
                    for (var t = u(e).attr("src").split(","), a = atob(t[1]), n = [], r = 0; r < a.length; r++) n.push(a.charCodeAt(r));
                    G([new Blob([new Uint8Array(n)], { type: t[0].replace(/data\:/g, "").replace(/;base64/g, "") })], p);
                }
                function ie() {
                    f.opts.imagePaste
                        ? f.$el.find("img[data-fr-image-pasted]").each(function (e, n) {
                            if (f.opts.imagePasteProcess) {
                                var t = f.opts.imageDefaultWidth;
                                t && "auto" != t && (t += f.opts.imageResizeWithPercent ? "%" : "px"), u(n).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), he(u(n), f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign);
                            }
                            if (0 === n.src.indexOf("data:")) re(n);
                            else if (0 === n.src.indexOf("blob:") || (0 === n.src.indexOf("http") && f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy)) {
                                var a = new Image();
                                (a.crossOrigin = "Anonymous"),
                                    (a.onload = function () {
                                        var e,
                                            t = f.o_doc.createElement("CANVAS"),
                                            a = t.getContext("2d");
                                        (t.height = this.naturalHeight),
                                            ...
                                            (n.src = t.toDataURL("image/".concat(e)));
                                    }),
                                    (a.src = (0 === n.src.indexOf("blob:") ? "" : "".concat(f.opts.imageCORSProxy, "/")) + n.src);
                            } else 0 !== n.src.indexOf("http") || 0 === n.src.indexOf("https://mail.google.com/mail") ? (f.selection.save(), u(n).remove(), f.selection.restore()) : u(n).removeAttr("data-fr-image-pasted");
                        })
                        : f.$el.find("img[data-fr-image-pasted]").remove();
                }
                function oe(e) {
                    var t = e.target.result,
                        a = f.opts.imageDefaultWidth;
                    a && "auto" != a && (a += f.opts.imageResizeWithPercent ? "%" : "px"), f.undo.saveStep(), f.html.insert('<img data-fr-image-pasted="true" src="'.concat(t, '"').concat(a ? ' style="width: '.concat(a, ';"') : "", ">"));
                    var n = f.$el.find('img[data-fr-image-pasted="true"]');
                    n && he(n, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign), f.events.trigger("paste.after");
                }
                function se(e) {
                ...
                function ce(e) {
                    ...
                    for (var t = 0; t < Be.INSTANCES.length; t++) Be.INSTANCES[t] != f && Be.INSTANCES[t].events.trigger("image.hideResizer");
                    f.toolbar.disable(),
                        ...
                        S(),
                        i(),
                        f.browser.msie ? (f.popups.areVisible() && f.events.disableBlur(), f.win.getSelection && (f.win.getSelection().removeAllRanges(), f.win.getSelection().addRange(f.doc.createRange()))) : f.selection.clear(),
                ...
                function de(e) {
                    p &&
                        ((function t() {
                            ...
                            !0 === e) &&
                        (f.toolbar.enable(), l.removeClass("fr-active"), f.popups.hide("image.edit"), (p = null), ue(), (c = null), d && d.hide());
                }
                (r[n] = "Image cannot be loaded from the passed link."),
                    (r[h] = "No link in upload response."),
                    (r[g] = "Error during file upload."),
                    (r[m] = "Parsing response failed."),
                ...
                function he(e, t, a) {
                    !f.opts.htmlUntouched && f.opts.useClasses
                        ...
                        : "inline" == t
                            ? (e.css({ display: "inline-block", verticalAlign: "bottom", margin: f.opts.imageDefaultMargin }),
                                "center" == a
                                    ? e.css({ float: "none", marginBottom: "", marginTop: "", maxWidth: "calc(100% - ".concat(2 * f.opts.imageDefaultMargin, "px)"), textAlign: "center" })
                                    : "left" == a
                                        ? e.css({ float: "left", marginLeft: 0, maxWidth: "calc(100% - ".concat(f.opts.imageDefaultMargin, "px)"), textAlign: "left" })
                                        : e.css({ float: "right", marginRight: 0, maxWidth: "calc(100% - ".concat(f.opts.imageDefaultMargin, "px)"), textAlign: "right" }))
                            : "block" == t &&
                            (e.css({ display: "block", float: "none", verticalAlign: "top", margin: "".concat(f.opts.imageDefaultMargin, "px auto"), textAlign: "center" }),
                ...
                function ve() {
                    ...
                    e || (e = z()), f.popups.isVisible("image.insert") || (k(), f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$sc));
                    var t = Ae();
                    Te() && (t = t.find(".fr-img-wrap"));
                    var a = t.offset().left + t.outerWidth() / 2,
                        n = t.offset().top + t.outerHeight();
                    f.popups.show("image.insert", a, n, t.outerHeight(!0), !0);
                }
                function be() {
                    if (p) {
                ...
                function Ae() {
                    return Te() ? p.parents(".fr-img-caption").first() : p;
                }
                function Te() {
                ...
                return {
                        ...
                        (function e() {
                            f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                                ...
                                f.helpers.isMobile() || f.selection.clear(),
                                    ...
                                    f.browser.msie && (f.events.disableBlur(), f.$el.attr("contenteditable", !1)),
                                    f.draggable || "touchstart" == e.type || e.preventDefault(),
                                    e.stopPropagation();
                            }),
                                    ...
                                    function (e) {
                                        if (e.shiftKey && "" === f.selection.text().replace(/\n/g, "") && f.keys.isArrow(e.which)) {
                                            var t = f.selection.element(),
                                                a = f.selection.endElement();
                                            t && "IMG" == t.tagName ? M(u(t)) : a && "IMG" == a.tagName && M(u(a));
                                        }
                                    },
                                    !0
                                ),
                                f.events.on("drop", V),
                                f.events.on("element.beforeDrop", Y),
                                f.events.on("window.mousedown", pe),
                                ...
                                f.events.on("image.inserted", function (e) {
                                    ...
                                    f.node.isElement(t) && (f.opts.enter === Be.ENTER_BR ? e.after("<br>") : u(f.node.blockParent(e.get(0))).after("<".concat(f.html.defaultTag(), "><br></").concat(f.html.defaultTag(), ">")));
                                });
                        })(),
                            "IMG" == f.el.tagName && f.$el.addClass("fr-view"),
                            f.events.$on(f.$el, f.helpers.isMobile() && !f.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', ce),
                            f.helpers.isMobile() &&
                            (f.events.$on(f.$el, "touchstart", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function () {
                                a = !1;
                            }),
                            ...
                            f.$wp
                                ? (f.events.on("window.keydown keydown", ae, !0),
                                    f.events.on(
                                        "keyup",
                                        function (e) {
                                            if (p && e.which == Be.KEYCODE.ENTER) return !1;
                                        },
                                        !0
                                    ),
                                    f.events.$on(f.$el, "keydown", function () {
                                        var e = f.selection.element();
                                        (e.nodeType === Node.TEXT_NODE || ("BR" == e.tagName && f.node.isLastSibling(e))) && (e = e.parentNode),
                                            f.node.hasClass(e, "fr-inner") ||
                                            (f.node.hasClass(e, "fr-img-caption") || (e = u(e).parents(".fr-img-caption").get(0)), f.node.hasClass(e, "fr-img-caption") && (u(e).after(Be.INVISIBLE_SPACE + Be.MARKERS), f.selection.restore()));
                                    }))
                                : f.events.$on(f.$win, "keydown", ae),
                            f.events.on(
                                "toolbar.esc",
                                function () {
                                    if (p) {
                            ...
                            f.events.on(
                                ...
                                function (e) {
                                    if (p && f.popups.isVisible("image.edit") && !f.popups.get("image.edit").find(":focus").length) {
                                        var t = Ae();
                                        Te() ? (t.before(Be.START_MARKER), t.after(Be.END_MARKER), f.selection.restore(), f.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (be(), f.paste.saveCopiedText(p.get(0).outerHTML, p.attr("alt"))),
                                            "copy" == e.type
                                                ? setTimeout(function () {
                                                    M(p);
                                                })
                            ...
                            f.events.on("keydown", function (e) {
                                ...
                                var t = e.which;
                                t == Be.KEYCODE.C && f.keys.ctrlKey(e) ? f.events.trigger("window.copy") : t == Be.KEYCODE.X && f.keys.ctrlKey(e) && f.events.trigger("window.cut");
                            }),
                            f.events.$on(u(f.o_win), "keydown", function (e) {
                                var t = e.which;
                                if (p && t == Be.KEYCODE.BACKSPACE) return e.preventDefault(), !1;
                            }),
                            f.events.$on(f.$win, "keydown", function (e) {
                                var t = e.which;
                                p && p.hasClass("fr-uploading") && t == Be.KEYCODE.ESC && p.trigger("abortUpload");
                            }),
                            ...
                            f.events.on("html.processGet", ne),
                            f.opts.imageOutputSize &&
                            f.events.on("html.beforeGet", function () {
                                n = f.el.querySelectorAll("img");
                                for (var e = 0; e < n.length; e++) {
                                    var t = n[e].style.width || u(n[e]).width(),
                                        a = n[e].style.height || u(n[e]).height();
                                    t && n[e].setAttribute("width", "".concat(t).replace(/px/, "")), a && n[e].setAttribute("height", "".concat(a).replace(/px/, ""));
                                }
                            }),
                            f.opts.iframe && f.events.on("image.loaded", f.size.syncIframe),
                            f.$wp && (R(), f.events.on("contentChanged", R)),
                            f.events.$on(u(f.o_win), "orientationchange.image", function () {
                                setTimeout(function () {
                                    p && M(p);
                                }, 100);
                            }),
                    ...
                    showLayer: function Se(e) {
                        var t,
                            a,
                            n = f.popups.get("image.insert");
                        if (p || f.opts.toolbarInline) {
                            if (p) {
                                var r = Ae();
                                Te() && (r = r.find(".fr-img-wrap")), (a = r.offset().top + r.outerHeight()), (t = r.offset().left);
                            }
                        } else {
                            var i = f.$tb.find('.fr-command[data-cmd="insertImage"]');
                            (t = i.offset().left), (a = i.offset().top + (f.opts.toolbarBottom ? 10 : i.outerHeight() - 10));
                        }
                        !p && f.opts.toolbarInline && ((a = n.offset().top - f.helpers.getPX(n.css("margin-top"))), n.hasClass("fr-above") && (a += n.outerHeight())),
                            n.find(".fr-layer").removeClass("fr-active"),
                            n.find(".fr-".concat(e, "-layer")).addClass("fr-active"),
                            f.popups.show("image.insert", t, a, p ? p.outerHeight() : 0),
                            f.accessibility.focusPopup(n);
                    },
                    refreshUploadButton: function Le(e) {
                        var t = f.popups.get("image.insert");
                        t && t.find(".fr-image-upload-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
                    },
                    refreshByURLButton: function _e(e) {
                        var t = f.popups.get("image.insert");
                        t && t.find(".fr-image-by-url-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
                    },
                    upload: G,
                    insertByURL: function ye() {
                        var e = f.popups.get("image.insert").find(".fr-image-by-url-layer input");
                        if (0 < e.val().length) {
                            F(), N(f.language.translate("Loading image"));
                            var t = e.val().trim();
                            if (f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy && f.opts.imageUpload) {
                                var a = new XMLHttpRequest();
                                (a.onload = function () {
                                    200 == this.status ? G([new Blob([this.response], { type: this.response.type || "image/png" })], p) : O(n);
                                }),
                                    (a.onerror = function () {
                                        P(t, !0, [], p);
                                    }),
                                    a.open("GET", "".concat(f.opts.imageCORSProxy, "/").concat(t), !0),
                                    (a.responseType = "blob"),
                                    a.send();
                            } else P(t, !0, [], p);
                            e.val(""), e.blur();
                    ...
                    align: function we(e) {
                        var t = Ae();
                        t.removeClass("fr-fir fr-fil"), !f.opts.htmlUntouched && f.opts.useClasses ? ("left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir")) : he(t, me(), e), be(), S(), i(), f.selection.clear();
                    },
                    refreshAlign: function Ie(e) {
                        p &&
                            e
                                .find("> *")
                                .first()
                                .replaceWith(f.icon.create("image-align-".concat(ge())));
                    },
                    refreshAlignOnShow: function Oe(e, t) {
                        p && t.find('.fr-command[data-param1="'.concat(ge(), '"]')).addClass("fr-active").attr("aria-selected", !0);
                    },
                    display: function xe(e) {
                        var t = Ae();
                        t.removeClass("fr-dii fr-dib"), !f.opts.htmlUntouched && f.opts.useClasses ? ("inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib")) : he(t, e, ge()), be(), S(), i(), f.selection.clear();
                    },
                    refreshDisplayOnShow: function Fe(e, t) {
                        p && t.find('.fr-command[data-param1="'.concat(me(), '"]')).addClass("fr-active").attr("aria-selected", !0);
                    },
                    replace: ve,
                    back: function e() {
                        p ? (f.events.disableBlur(), u(".fr-popup input:focus").blur(), M(p)) : (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur(), f.popups.hide("image.insert"), f.toolbar.showInline());
                    },
                    get: Ee,
                    getEl: Ae,
                    insert: P,
                    ...
                    applyStyle: function ke(e, t, a) {
                        if ((void 0 === t && (t = f.opts.imageStyles), void 0 === a && (a = f.opts.imageMultipleStyles), !p)) return !1;
                        var n = Ae();
                        if (!a) {
                            var r = Object.keys(t);
                            r.splice(r.indexOf(e), 1), n.removeClass(r.join(" "));
                        }
                        "object" == Pe(t[e]) ? (n.removeAttr("style"), n.css(t[e].style)) : n.toggleClass(e), M(p);
                    },
                    showAltPopup: q,
                    showSizePopup: J,
                    setAlt: function Ne(e) {
                        if (p) {
                            ...
                            p.attr("alt", e || t.find("input").val() || ""), t.find("input:focus").blur(), M(p);
                        }
                    },
                    setSize: function De(e, t) {
                        if (p) {
                            var a = f.popups.get("image.size");
                            (e = e || a.find('input[name="width"]').val() || ""), (t = t || a.find('input[name="height"]').val() || "");
                            var n = /^[\d]+((px)|%)*$/g;
                            p.removeAttr("width").removeAttr("height"),
                                e.match(n) ? p.css("width", e) : p.css("width", ""),
                                t.match(n) ? p.css("height", t) : p.css("height", ""),
                                Te() &&
                                (p.parents(".fr-img-caption").removeAttr("width").removeAttr("height"),
                                    e.match(n) ? p.parents(".fr-img-caption").css("width", e) : p.parents(".fr-img-caption").css("width", ""),
                                    t.match(n) ? p.parents(".fr-img-caption").css("height", t) : p.parents(".fr-img-caption").css("height", "")),
                                a && a.find("input:focus").blur(),
                                M(p);
                        }
                    },
                    toggleCaption: function Me() {
                        var e;
                        if (p && !Te()) {
                            (e = p).parent().is("a") && (e = p.parent());
                            var t,
                                a,
                                n = p.parents("ul") && 0 < p.parents("ul").length ? p.parents("ul") : p.parents("ol") && 0 < p.parents("ol").length ? p.parents("ol") : [];
                            if (0 < n.length) {
                                var r = n.find("li").length,
                                    i = p.parents("li"),
                                    o = document.createElement("li");
                                r - 1 === i.index() && (n.append(o), (o.innerHTML = "&nbsp;"));
                            }
                            e.attr("style") && (a = -1 < (t = e.attr("style").split(":")).indexOf("width") ? t[t.indexOf("width") + 1].replace(";", "") : "");
                            var s = f.opts.imageResizeWithPercent ? (-1 < a.indexOf("px") ? null : a) || "100%" : p.width() + "px";
                            e.wrap(
                                '<div class="fr-img-space-wrap"><span ' +
                                (f.browser.mozilla ? "" : 'contenteditable="false"') +
                                ...
                                p.after(
                                    '<span class="fr-inner"'
                                        .concat(f.browser.mozilla ? "" : ' contenteditable="true"', ">")
                                        .concat(Be.START_MARKER)
                                        .concat(f.language.translate("Image Caption"))
                                        .concat(Be.END_MARKER, "</span>")
                                ),
                                p.removeAttr("class").removeAttr("style").removeAttr("width"),
                                p.parents(".fr-img-caption").css("width", s),
                                de(!0),
                                f.selection.restore();
                        } else (e = Ae()), p.insertAfter(e), p.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), M(p);
                    },
                    hasCaption: Te,
                    exitEdit: de,
                    edit: M,
            ...
            Be.DefineIcon("insertImage", { NAME: "image", SVG_KEY: "insertImage" }),
            Be.RegisterShortcut(Be.KEYCODE.P, "insertImage", null, "P"),
            Be.RegisterCommand("insertImage", {
                title: "Insert Image",
                undo: !1,
                focus: !0,
                refreshAfterCallback: !1,
            ...
            Be.DefineIcon("imageUpload", { NAME: "upload", SVG_KEY: "upload" }),
            Be.RegisterCommand("imageUpload", {
                title: "Upload Image",
                undo: !1,
                focus: !1,
                toggle: !0,
            ...
            Be.DefineIcon("imageByURL", { NAME: "link", SVG_KEY: "insertLink" }),
            Be.RegisterCommand("imageByURL", {
                title: "By URL",
                undo: !1,
                focus: !1,
                toggle: !0,
            ...
            Be.RegisterCommand("imageInsertByURL", {
                title: "Insert Image",
                undo: !0,
                refreshAfterCallback: !1,
                callback: function () {
            ...
            Be.DefineIcon("imageDisplay", { NAME: "star", SVG_KEY: "imageDisplay" }),
            Be.RegisterCommand("imageDisplay", {
                title: "Display",
                type: "dropdown",
            ...
            Be.DefineIcon("image-align", { NAME: "align-left", SVG_KEY: "alignLeft" }),
            Be.DefineIcon("image-align-left", { NAME: "align-left", SVG_KEY: "alignLeft" }),
            Be.DefineIcon("image-align-right", { NAME: "align-right", SVG_KEY: "alignRight" }),
            Be.DefineIcon("image-align-center", { NAME: "align-justify", SVG_KEY: "alignCenter" }),
            Be.DefineIcon("imageAlign", { NAME: "align-justify", SVG_KEY: "alignJustify" }),
            Be.RegisterCommand("imageAlign", {
                type: "dropdown",
                title: "Align",
                options: { left: "Align Left", center: "None", right: "Align Right" },
                html: function () {
                    var e = '<ul class="fr-dropdown-list" role="presentation">',
                        t = Be.COMMANDS.imageAlign.options;
                    for (var a in t)
                        t.hasOwnProperty(a) &&
            ...
            Be.DefineIcon("imageReplace", { NAME: "exchange", FA5NAME: "exchange-alt", SVG_KEY: "replaceImage" }),
            Be.RegisterCommand("imageReplace", {
                title: "Replace",
                undo: !1,
                focus: !1,
                popup: !0,
            ...
            Be.DefineIcon("imageRemove", { NAME: "trash", SVG_KEY: "remove" }),
            Be.RegisterCommand("imageRemove", {
                title: "Remove",
                callback: function () {
                    this.image.remove();
                },
            }),
            Be.DefineIcon("imageBack", { NAME: "arrow-left", SVG_KEY: "back" }),
            Be.RegisterCommand("imageBack", {
                title: "Back",
                undo: !1,
                focus: !1,
                back: !0,
            ...
            Be.RegisterCommand("imageDismissError", {
                title: "OK",
                undo: !1,
                callback: function () {
            ...
            Be.DefineIcon("imageStyle", { NAME: "magic", SVG_KEY: "imageClass" }),
            Be.RegisterCommand("imageStyle", {
                title: "Style",
                type: "dropdown",
                html: function () {
                    var e = '<ul class="fr-dropdown-list" role="presentation">',
                    ...
                    for (var a in t)
                        if (t.hasOwnProperty(a)) {
                            var n = t[a];
                            "object" == Pe(n) && (n = n.title),
                                (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="imageStyle" data-param1="'.concat(a, '">').concat(this.language.translate(n), "</a></li>"));
                        }
                    return (e += "</ul>");
                },
                callback: function (e, t) {
            ...
            Be.DefineIcon("imageAlt", { NAME: "info", SVG_KEY: "imageAltText" }),
            Be.RegisterCommand("imageAlt", {
                undo: !1,
                focus: !1,
                popup: !0,
            ...
            Be.RegisterCommand("imageSetAlt", {
                undo: !0,
                focus: !1,
                title: "Update",
                refreshAfterCallback: !1,
            ...
            Be.DefineIcon("imageSize", { NAME: "arrows-alt", SVG_KEY: "imageSize" }),
            Be.RegisterCommand("imageSize", {
                undo: !1,
                focus: !1,
                popup: !0,
                title: "Change Size",
            ...
            Be.RegisterCommand("imageSetSize", {
                undo: !0,
                focus: !1,
                title: "Update",
                refreshAfterCallback: !1,
            ...
            Be.DefineIcon("imageCaption", { NAME: "commenting", FA5NAME: "comment-alt", SVG_KEY: "imageCaption" }),
            Be.RegisterCommand("imageCaption", {
                undo: !0,
                focus: !1,
                title: "Image Caption",
            ...
            (Be.PLUGINS.imageManager = function (s) {
                var l,
                    c,
                    i,
                    o,
                ...
                function _() {
                    if (h < p.length && (d.outerHeight() <= i.outerHeight() + s.opts.imageManagerScrollOffset || i.scrollTop() + s.opts.imageManagerScrollOffset > d.outerHeight() - i.outerHeight())) {
                        u++;
                ...
                function t(r) {
                    var i = new Image(),
                        o = v(document.createElement("div"))
                            .attr("class", "fr-image-container fr-empty fr-image-" + g++)
                    ...
                    O(!1),
                        (i.onload = function () {
                            ...
                            var a = v(document.createElement("img"));
                            if (r.thumb) a.attr("src", r.thumb);
                            else {
                                if ((N(C, r), !r.url)) return N(R, r), !1;
                                a.attr("src", r.url);
                            }
                            if ((r.url && a.attr("data-url", r.url), r.tag))
                                if ((c.find(".fr-modal-more.fr-not-available").removeClass("fr-not-available"), c.find(".fr-modal-tags").show(), 0 <= r.tag.indexOf(","))) {
                                    for (var e = r.tag.split(","), t = 0; t < e.length; t++)
                                        (e[t] = e[t].trim()), 0 === f.find('a[title="'.concat(e[t], '"]')).length && f.append('<a role="button" title="'.concat(e[t], '">').concat(e[t], "</a>"));
                                    a.attr("data-tag", e.join());
                                } else 0 === f.find('a[title="'.concat(r.tag.trim(), '"]')).length && f.append('<a role="button" title="'.concat(r.tag.trim(), '">').concat(r.tag.trim(), "</a>")), a.attr("data-tag", r.tag.trim());
                            for (var n in (r.name && a.attr("alt", r.name), r)) r.hasOwnProperty(n) && "thumb" !== n && "url" !== n && "tag" !== n && a.attr("data-".concat(n), r[n]);
                            o
                                .append(a)
                                ...
                                a.on("load", function () {
                                    o.removeClass("fr-empty"),
                                        ...
                                        O(!1),
                                        h % s.opts.imageManagerPageSize == 0 && _();
                                }),
                                s.events.trigger("imageManager.imageLoaded", [a]);
                        }),
                        (i.onerror = function () {
                            h++, o.remove(), I(w(parseInt(o.attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), N(e, r), h % s.opts.imageManagerPageSize == 0 && _();
                        }),
                        (i.src = r.thumb || r.url),
                        y().append(o);
                }
                function y() {
                    ...
                    return (
                        d.find(".fr-list-column").each(function (e, t) {
                            var a = v(t);
                            0 === e ? ((r = a.outerHeight()), (n = a)) : a.outerHeight() < r && ((r = a.outerHeight()), (n = a));
                        }),
                        n
                    );
                }
                function w(e) {
                    e === undefined && (e = 0);
                    for (var t = [], a = g - 1; e <= a; a--) {
                        var n = d.find(".fr-image-".concat(a));
                        n.length && (t.push(n), v(document.createElement("div")).attr("id", "fr-image-hidden-container").append(n), d.find(".fr-image-".concat(a)).remove());
                    }
                    return t;
                }
                function I(e) {
                    for (var t = e.length - 1; 0 <= t; t--) y().append(e[t]);
                }
                function O(e) {
                    ...
                    s.modals.resize(b), e && _();
                }
                function x(e) {
                    var t = {},
                        a = e.data();
                    for (var n in a) a.hasOwnProperty(n) && "url" !== n && "tag" !== n && (t[n] = a[n]);
                    return t;
                }
                function F(e) {
                    var t = v(e.currentTarget).siblings("img"),
                        a = l.data("instance") || s,
                        n = l.data("current-image");
                    if ((s.modals.hide(b), a.image.showProgressBar(), n)) n.data("fr-old-src", n.attr("src")), n.trigger("click");
                    else {
                        a.events.focus(!0), a.selection.restore();
                        var r = a.position.getBoundingRect(),
                            i = r.left + r.width / 2 + v(s.doc).scrollLeft(),
                            o = r.top + r.height + v(s.doc).scrollTop();
                        a.popups.setContainer("image.insert", s.$sc), a.popups.show("image.insert", i, o);
                    }
                    a.image.insert(t.data("url"), !1, x(t), n);
                }
                function k(e) {
                        ...
                        (s.opts.imageManagerDeleteURL
                            ...
                            (i.parent().addClass("fr-image-deleting"),
                                v(this).ajax({
                                    ...
                                    data: Object.assign(Object.assign({ src: i.attr("src") }, x(i)), s.opts.imageManagerDeleteParams),
                                    ...
                                    fail: function (e) {
                                        N(a, e.response || e.responseText);
                                    },
                                }))
                            : N(n));
                }
                function N(e, t) {
                    10 <= e && e < 20 ? o.hide() : 20 <= e && e < 30 && v(".fr-image-deleting").removeClass("fr-image-deleting"), s.events.trigger("imageManager.error", [{ code: e, message: r[e] }, t]);
                }
                function D() {
                    var e = c.find(".fr-modal-head-line").outerHeight(),
                        t = f.outerHeight();
                    c.toggleClass("fr-show-tags"), c.hasClass("fr-show-tags") ? (c.css("height", e + t), i.css("marginTop", e + t), f.find("a").css("opacity", 1)) : (c.css("height", e), i.css("marginTop", e), f.find("a").css("opacity", 0));
                }
                function M() {
                ...
                function B(e) {
                    e.preventDefault();
                    var t = v(e.currentTarget);
                    t.toggleClass("fr-selected-tag"), s.opts.imageManagerToggleTags && t.siblings("a").removeClass("fr-selected-tag"), M();
                }
                function P(e, t) {
                    for (var a = (e.attr("data-tag") || "").split(","), n = 0; n < a.length; n++) if (a[n] === t) return !0;
                    return !1;
                }
                return (
                    (r[e] = "Image cannot be loaded from the passed link."),
                    (r[E] = "Error during load images request."),
                    (r[A] = "Missing imageManagerLoadURL option."),
                    (r[T] = "Parsing load response failed."),
                    (r[C] = "Missing image thumb."),
                    (r[R] = "Missing image URL."),
                    (r[a] = "Error during delete image request."),
                    (r[n] = "Missing imageManagerDeleteURL option."),
                    {
                        require: ["image"],
                        _init: function U() {
                            ...
                            if (!l) {
                                var e,
                                    t = '<button class="fr-command fr-btn fr-modal-more fr-not-available" id="fr-modal-more-'
                                        ...
                                        .concat(Be.SVG.tags, '"/></svg></button><h4 data-text="true">')
                                ...
                                var a = s.modals.create(b, t, e);
                                (l = a.$modal), (c = a.$head), (i = a.$body);
                            }
                            l.data("current-image", s.image.get()),
                                s.modals.show(b),
                                o ||
                                (function n() {
                                    (o = l.find("#fr-preloader")),
                                        (d = l.find("#fr-image-list")),
                                        (f = l.find("#fr-modal-tags")),
                                        (m = S()),
                                        L(),
                                        c.css("height", c.find(".fr-modal-head-line").outerHeight()),
                                        s.events.$on(v(s.o_win), "resize", function () {
                                            O(!!p);
                                        }),
                                        s.events.bindClick(d, ".fr-insert-img", F),
                                        s.events.bindClick(d, ".fr-delete-img", k),
                                        s.helpers.isMobile() &&
                                        (s.events.bindClick(d, "div.fr-image-container", function (e) {
                                        ...
                                        i.on("scroll", _),
                                        s.events.bindClick(l, "button#fr-modal-more-".concat(s.sid), D),
                                        s.events.bindClick(f, "a", B);
                                })(),
                                (function r() {
                                    o.show(),
                                            ...
                                            ? v(this).ajax({
                                                ...
                                                headers: s.opts.requestHeaders,
                                                    ...
                                                    s.events.trigger("imageManager.imagesLoaded", [e]),
                                                        (function n(e, t) {
                                                            try {
                                                                d.find(".fr-list-column").empty(), (g = h = u = 0), (p = JSON.parse(e)), _();
                                                            } catch (a) {
                                                                N(T, t);
                                                            }
                                                        })(e, a.response),
    ...
    Be.DEFAULTS.imageInsertButtons.push("imageManager"),
        Be.RegisterCommand("imageManager", {
            title: "Browse",
            undo: !1,
            focus: !1,
            modal: !0,
        ...
        Be.DefineIcon("imageManager", { NAME: "folder", SVG_KEY: "imageManager" }),
        Be.DefineIcon("imageManagerInsert", { NAME: "plus", SVG_KEY: "add" }),
        Be.DefineIcon("imageManagerDelete", { NAME: "trash", SVG_KEY: "remove" }),
        Object.assign(Be.DEFAULTS, { inlineClasses: { "fr-class-code": "Code", "fr-class-highlighted": "Highlighted", "fr-class-transparency": "Transparent" } }),
        (Be.PLUGINS.inlineClass = function (a) {
            var n = a.$;
            return {
                apply: function t(e) {
                    a.format.toggle("span", { class: e });
                },
                refreshOnShow: function r(e, t) {
                    t.find(".fr-command").each(function () {
                        var e = n(this).data("param1"),
                            t = a.format.is("span", { class: e });
                        n(this).toggleClass("fr-active", t).attr("aria-selected", t);
                    });
                },
            };
        }),
        Be.RegisterCommand("inlineClass", {
            type: "dropdown",
            title: "Inline Class",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    t.hasOwnProperty(a) && (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="inlineClass" data-param1="'.concat(a, '" title="').concat(t[a], '">').concat(t[a], "</a></li>"));
                return (e += "</ul>");
            },
            callback: function (e, t) {
        ...
        Be.DefineIcon("inlineClass", { NAME: "tag", SVG_KEY: "inlineClass" }),
        Object.assign(Be.DEFAULTS, { inlineStyles: { "Big Red": "font-size: 20px; color: red;", "Small Blue": "font-size: 14px; color: blue;" } }),
        (Be.PLUGINS.inlineStyle = function (r) {
            return {
                apply: function i(e) {
                    for (var t = e.split(";"), a = 0; a < t.length; a++) {
                        var n = t[a].split(":");
                        t[a].length && 2 == n.length && r.format.applyStyle(n[0].trim(), n[1].trim());
                    }
                },
            };
        }),
        Be.RegisterCommand("inlineStyle", {
            type: "dropdown",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    if (t.hasOwnProperty(a)) {
                        var n = t[a] + (-1 === t[a].indexOf("display:block;") ? " display:block;" : "");
                        e += '<li role="presentation"><span style="'
                            .concat(n, '" role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="inlineStyle" data-param1="')
                            .concat(t[a], '" title="')
                            .concat(this.language.translate(a), '">')
                            .concat(this.language.translate(a), "</a></span></li>");
                    }
                return (e += "</ul>");
            },
            title: "Inline Style",
        ...
        Be.DefineIcon("inlineStyle", { NAME: "paint-brush", SVG_KEY: "inlineStyle" }),
        Object.assign(Be.DEFAULTS, { lineBreakerTags: ["table", "hr", "form", "dl", "span.fr-video", ".fr-embedly", "img"], lineBreakerOffset: 15, lineBreakerHorizontalOffset: 10 }),
        (Be.PLUGINS.lineBreaker = function (h) {
            var g,
                t,
                r,
                m = h.$;
            function l(e, t) {
                var a, n, r, i, o, s, l, c;
                if (null == e) (o = (i = t.parent()).offset().top), (a = (l = t.offset().top) - Math.min((l - o) / 2, h.opts.lineBreakerOffset)), (r = i.outerWidth()), (n = i.offset().left);
                else if (null == t)
                    (s = (i = e.parent()).offset().top + i.outerHeight()) < (c = e.offset().top + e.outerHeight()) && (s = (i = m(i).parent()).offset().top + i.outerHeight()),
                        (a = c + Math.min(Math.abs(s - c) / 2, h.opts.lineBreakerOffset)),
                        (r = i.outerWidth()),
                        (n = i.offset().left);
                else {
                    i = e.parent();
                    var d = e.offset().top + e.height(),
                        f = t.offset().top;
                    if (f < d) return !1;
                    (a = (d + f) / 2), (r = i.outerWidth()), (n = i.offset().left);
                }
                if (h.opts.iframe) {
                    var p = h.helpers.getPX(h.$wp.find(".fr-iframe").css("padding-top")),
                        u = h.helpers.getPX(h.$wp.find(".fr-iframe").css("padding-left"));
                    (n += h.$iframe.offset().left - h.helpers.scrollLeft() + u), (a += h.$iframe.offset().top - h.helpers.scrollTop() + p);
                }
                h.$box.append(g), g.css("top", a - h.win.pageYOffset), g.css("left", n - h.win.pageXOffset), g.css("width", r), g.data("tag1", e), g.data("tag2", t), g.addClass("fr-visible").data("instance", h);
            }
            function c(e) {
                if (e) {
                    var t = m(e);
            ...
            function i(e, t) {
                var a = h.doc.elementFromPoint(e, t);
                return a &&
                    !m(a).closest(".fr-line-breaker").length &&
                    !h.node.isElement(a) &&
                    a != h.$wp.get(0) &&
                    (function n(e) {
            ...
            function o(e, t, a) {
                for (var n = a, r = null; n <= h.opts.lineBreakerOffset && !r;) (r = i(e, t - n)) || (r = i(e, t + n)), (n += a);
                return r;
            }
            function d(e, t, a) {
                for (var n = null, r = 100; !n && e > h.$box.offset().left && e < h.$box.offset().left + h.$box.outerWidth() && 0 < r;)
                    (n = i(e, t)) || (n = o(e, t, 5)), "left" == a ? (e -= h.opts.lineBreakerHorizontalOffset) : (e += h.opts.lineBreakerHorizontalOffset), (r -= h.opts.lineBreakerHorizontalOffset);
                return n;
            }
            function a(e) {
                var t = (r = null),
                    a = null,
                    n = h.doc.elementFromPoint(e.pageX - h.win.pageXOffset, e.pageY - h.win.pageYOffset);
                (t =
                    n && ("HTML" == n.tagName || "BODY" == n.tagName || h.node.isElement(n) || 0 <= (n.getAttribute("class") || "").indexOf("fr-line-breaker"))
                        ? ((a = o(e.pageX - h.win.pageXOffset, e.pageY - h.win.pageYOffset, 1)) || (a = d(e.pageX - h.win.pageXOffset - h.opts.lineBreakerHorizontalOffset, e.pageY - h.win.pageYOffset, "left")),
                            a || (a = d(e.pageX - h.win.pageXOffset + h.opts.lineBreakerHorizontalOffset, e.pageY - h.win.pageYOffset, "right")),
                            c(a))
                        : c(n))
                    ? (function s(e, t) {
                        var a,
                        ...
                        if (Math.abs(i - t) <= h.opts.lineBreakerOffset || Math.abs(t - r) <= h.opts.lineBreakerOffset)
                            if (Math.abs(i - t) < Math.abs(t - r)) {
                                for (var o = (n = e.get(0)).nextSibling; o && o.nodeType == Node.TEXT_NODE && 0 === o.textContent.length;) o = o.nextSibling;
                                if (!o) return l(e, null), !0;
                                if ((a = c(o))) return l(e, a), !0;
                            } else {
                                if (!(n = e.get(0)).previousSibling) return l(null, e), !0;
                                if ((a = c(n.previousSibling))) return l(a, e), !0;
                            }
                        g.removeClass("fr-visible").removeData("instance");
                    })(t, e.pageY)
                    : h.core.sameInstance(g) && g.removeClass("fr-visible").removeData("instance");
            }
            function n(e) {
                return (
                    !(g.hasClass("fr-visible") && !h.core.sameInstance(g)) &&
                    (h.popups.areVisible() || h.el.querySelector(".fr-selected-cell") ? (g.removeClass("fr-visible"), !0) : void (!1 !== t || h.edit.isDisabled() || (r && clearTimeout(r), (r = setTimeout(a, 30, e)))))
                );
            }
            function s() {
            ...
            function u(e) {
                ...
                var a = g.data("tag1"),
                    ...
                    r = h.html.defaultTag();
                null == a
                    ? r && "TD" != n.parent().get(0).tagName && 0 === n.parents(r).length
                        ? n.before("<".concat(r, ">").concat(Be.MARKERS, "<br></").concat(r, ">"))
                        : n.before("".concat(Be.MARKERS, "<br>"))
                    : r && "TD" != a.parent().get(0).tagName && 0 === a.parents(r).length
                        ? a.after("<".concat(r, ">").concat(Be.MARKERS, "<br></").concat(r, ">"))
                        : a.after("".concat(Be.MARKERS, "<br>")),
                    t.selection.restore(),
                    h.toolbar.enable();
            }
            return {
                _init: function v() {
                    ...
                    !(function e() {
                        h.shared.$line_breaker ||
                            (h.shared.$line_breaker = m(document.createElement("div"))
        ...
        Object.assign(Be.DEFAULTS, { lineHeights: { Default: "", Single: "1", 1.15: "1.15", 1.5: "1.5", Double: "2" } }),
        (Be.PLUGINS.lineHeight = function (n) {
            var s = n.$;
            return {
                _init: function e() { },
                apply: function r(e) {
                    ...
                    t.length && s(t[0]).parent().is("td") && n.format.applyStyle("line-height", e.toString()), n.selection.save();
                    for (var a = 0; a < t.length; a++) s(t[a]).css("line-height", e), "" === s(t[a]).attr("style") && s(t[a]).removeAttr("style");
                    n.html.unwrap(), n.selection.restore();
                },
                refreshOnShow: function i(e, t) {
                    var a = n.selection.blocks();
                    if (a.length) {
                        var o = s(a[0]);
                        t.find(".fr-command").each(function () {
                            var e = s(this).data("param1"),
                                t = o.attr("style"),
                                a = 0 <= (t || "").indexOf("line-height: " + e + ";");
                            if (t) {
                                var n = t.substring(t.indexOf("line-height")),
                                    r = n.substr(0, n.indexOf(";")),
                                    i = r && r.split(":")[1];
                                (i && i.length) || "Default" !== o.text() || (a = !0);
                            }
                            (t && -1 !== t.indexOf("line-height")) || "" !== e || (a = !0), s(this).toggleClass("fr-active", a).attr("aria-selected", a);
                        });
                    }
                },
            };
        }),
        Be.RegisterCommand("lineHeight", {
            type: "dropdown",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command '
                            .concat(a, '" tabIndex="-1" role="option" data-cmd="lineHeight" data-param1="')
                            .concat(t[a], '" title="')
                            .concat(this.language.translate(a), '">')
                            .concat(this.language.translate(a), "</a></li>"));
                return (e += "</ul>");
            },
            title: "Line Height",
            callback: function (e, t) {
        ...
        Be.DefineIcon("lineHeight", { NAME: "arrows-v", FA5NAME: "arrows-alt-v", SVG_KEY: "lineHeight" }),
        Object.assign(Be.POPUP_TEMPLATES, { "link.edit": "[_BUTTONS_]", "link.insert": "[_BUTTONS_][_INPUT_LAYER_]" }),
        Object.assign(Be.DEFAULTS, {
        ...
        (Be.PLUGINS.link = function (u) {
            ...
            function g() {
                ...
                var a = u.selection.element(),
                    n = u.selection.endElement();
                "A" == a.tagName || u.node.isElement(a) || (a = h(a).parentsUntil(u.$el, "a").first().get(0)), "A" == n.tagName || u.node.isElement(n) || (n = h(n).parentsUntil(u.$el, "a").first().get(0));
                try {
                ...
                return n && n == a && "A" == n.tagName ? ((u.browser.msie || u.helpers.isMobile()) && (u.selection.info(a).atEnd || u.selection.info(a).atStart) ? null : a) : null;
            }
            function m() {
                var e,
                    t,
                    ...
                    i = [];
                if (r) "A" == r.get(0).parentNode.tagName && i.push(r.get(0).parentNode);
                else if (u.win.getSelection) {
                    var o = u.win.getSelection();
                    if (o.getRangeAt && o.rangeCount) {
                        n = u.doc.createRange();
                        for (var s = 0; s < o.rangeCount; ++s)
                            if (((t = (e = o.getRangeAt(s)).commonAncestorContainer) && 1 != t.nodeType && (t = t.parentNode), t && "a" == t.nodeName.toLowerCase())) i.push(t);
                            else {
                                a = t.getElementsByTagName("a");
                                for (var l = 0; l < a.length; ++l) n.selectNodeContents(a[l]), n.compareBoundaryPoints(e.END_TO_START, e) < 1 && -1 < n.compareBoundaryPoints(e.START_TO_END, e) && i.push(a[l]);
                            }
                    }
                } else if (u.doc.selection && "Control" != u.doc.selection.type)
                    if ("a" == (t = (e = u.doc.selection.createRange()).parentElement()).nodeName.toLowerCase()) i.push(t);
                    else {
                        (a = t.getElementsByTagName("a")), (n = u.doc.body.createTextRange());
                        for (var c = 0; c < a.length; ++c) n.moveToElementText(a[c]), -1 < n.compareEndPoints("StartToEnd", e) && n.compareEndPoints("EndToStart", e) < 1 && i.push(a[c]);
                    }
                return i;
            }
            function v(r) {
                if (u.core.hasFocus()) {
                    if ((i(), r && "keyup" === r.type && (r.altKey || r.which == Be.KEYCODE.ALT))) return !0;
                    setTimeout(
                        function () {
                            if (!r || (r && (1 == r.which || "mouseup" != r.type))) {
                                ...
                                if (e && !t) {
                                    if (u.image) {
                                        var a = u.node.contents(e);
                                        if (1 == a.length && "IMG" == a[0].tagName) {
                                            var n = u.selection.ranges(0);
                                            return 0 === n.startOffset && 0 === n.endOffset ? h(e).before(Be.MARKERS) : h(e).after(Be.MARKERS), u.selection.restore(), !1;
                                        }
                                    }
                                    r && r.stopPropagation(), o(e);
                                }
                            }
                        },
            ...
            function o(e) {
                ...
                t ||
                    (t = (function i() {
                        ...
                        1 <= u.opts.linkEditButtons.length &&
                            ("A" == u.el.tagName && 0 <= u.opts.linkEditButtons.indexOf("linkRemove") && u.opts.linkEditButtons.splice(u.opts.linkEditButtons.indexOf("linkRemove"), 1),
                                (e = '<div class="fr-buttons">'.concat(u.button.buildList(u.opts.linkEditButtons), "</div>")));
                        var t = { buttons: e },
                            a = u.popups.create("link.edit", t);
                        u.$wp &&
                            u.events.$on(u.$wp, "scroll.link-edit", function () {
                                g() && u.popups.isVisible("link.edit") && o(g());
                            });
                        return a;
                    })());
                var a = h(e);
                ...
                var n = a.offset().left + a.outerWidth() / 2,
                    r = a.offset().top + a.outerHeight();
                u.popups.show("link.edit", n, r, a.outerHeight(), !0);
            }
            function i() {
            ...
            function l() {
                ...
                if (t) {
                    var a,
                        n,
                        r = h(t),
                        i = e.find('input.fr-link-attr[type="text"]'),
                        o = e.find('input.fr-link-attr[type="checkbox"]');
                    for (a = 0; a < i.length; a++) (n = h(i[a])).val(r.attr(n.attr("name") || ""));
                    for (o.attr("checked", !1), a = 0; a < o.length; a++) (n = h(o[a])), r.attr(n.attr("name")) == n.data("checked") && n.attr("checked", !0);
            ...
            function s(e) {
                ...
                var a = "",
                    n = 0;
                for (var r in ((a = '<div class="fr-link-insert-layer fr-layer fr-active" id="fr-link-insert-layer-'.concat(u.id, '">')),
                    (a += '<div class="fr-input-line"><input id="fr-link-insert-layer-url-'
                        .concat(u.id, '" name="href" type="text" class="fr-link-attr" placeholder="')
                        .concat(u.language.translate("URL"), '" tabIndex="')
                        .concat(++n, '"></div>')),
                    u.opts.linkText &&
                    (a += '<div class="fr-input-line"><input id="fr-link-insert-layer-text-'
                        .concat(u.id, '" name="text" type="text" class="fr-link-attr" placeholder="')
                        .concat(u.language.translate("Text"), '" tabIndex="')
                        .concat(++n, '"></div>')),
                    u.opts.linkAttributes))
                    if (u.opts.linkAttributes.hasOwnProperty(r)) {
                        var i = u.opts.linkAttributes[r];
                        a += '<div class="fr-input-line"><input name="'
                            .concat(r, '" type="text" class="fr-link-attr" placeholder="')
                            .concat(u.language.translate(i), '" tabIndex="')
                            .concat(++n, '"></div>');
                    }
                u.opts.linkAlwaysBlank ||
                    (a += '<div class="fr-checkbox-line"><span class="fr-checkbox"><input name="target" class="fr-link-attr" data-checked="_blank" type="checkbox" id="fr-link-target-'
                ...
                var o = {
                    buttons: t,
                    input_layer: (a += '<div class="fr-action-buttons"><button class="fr-command fr-submit" role="button" data-cmd="linkInsert" href="#" tabIndex="'
                        .concat(++n, '" type="button">')
                        .concat(u.language.translate("Insert"), "</button></div></div>")),
                },
                    s = u.popups.create("link.insert", o);
                return (
                    u.$wp &&
            ...
            function c(e, t, a) {
                if ((void 0 === a && (a = {}), !1 === u.events.trigger("link.beforeInsert", [e, t, a]))) return !1;
                var n = u.image ? u.image.get() : null;
                n || "A" == u.el.tagName ? "A" == u.el.tagName && u.$el.focus() : (u.selection.restore(), u.popups.hide("link.insert"));
                var r = e;
                u.opts.linkConvertEmailAddress && u.helpers.isEmail(e) && !/^mailto:.*/i.test(e) && (e = "mailto:".concat(e));
                if (
                    ("" === u.opts.linkAutoPrefix ||
                        new RegExp("^(" + Be.LinkProtocols.join("|") + "):.", "i").test(e) ||
                        /^data:image.*/i.test(e) ||
                        /^(https?:|ftps?:|file:|)\/\//i.test(e) ||
                        /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ||
                        (["/", "{", "[", "#", "(", "."].indexOf((e || "")[0]) < 0 && (e = u.opts.linkAutoPrefix + u.helpers.sanitizeURL(e))),
                        (e = u.helpers.sanitizeURL(e)),
                        u.opts.linkAlwaysBlank && (a.target = "_blank"),
                        u.opts.linkAlwaysNoFollow && (a.rel = "nofollow"),
                        u.helpers.isEmail(r) && ((a.target = null), (a.rel = null)),
                        "_blank" == a.target
                            ? (u.opts.linkNoOpener && (a.rel ? (a.rel += " noopener") : (a.rel = "noopener")), u.opts.linkNoReferrer && (a.rel ? (a.rel += " noreferrer") : (a.rel = "noreferrer")))
                            : null == a.target && (a.rel ? (a.rel = a.rel.replace(/noopener/, "").replace(/noreferrer/, "")) : (a.rel = null)),
                        (t = t || ""),
                        e === u.opts.linkAutoPrefix)
                )
                    return u.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"), u.events.trigger("link.bad", [r]), !1;
                var i,
                    o = g();
                if (o) {
                    if (((i = h(o)).attr("href", e), 0 < t.length && i.text() != t && !n)) {
                        for (var s = i.get(0); 1 === s.childNodes.length && s.childNodes[0].nodeType == Node.ELEMENT_NODE;) s = s.childNodes[0];
                        h(s).text(t);
                    }
                    for (var l in (n || i.prepend(Be.START_MARKER).append(Be.END_MARKER), a)) a[l] ? i.attr(l, a[l]) : i.removeAttr(l);
                    n || u.selection.restore();
                } else {
                    n
                        ? (n.wrap('<a href="'.concat(e, '"></a>')), u.image.hasCaption() && n.parent().append(n.parents(".fr-img-caption").find(".fr-inner")))
                        : (u.format.remove("a"),
                            u.selection.isCollapsed()
                                ? ((t = 0 === t.length ? r : t),
                                    u.html.insert('<a href="'.concat(e, '">').concat(Be.START_MARKER).concat(t.replace(/&/g, "&amp;").replace(/</, "&lt;", ">", "&gt;")).concat(Be.END_MARKER, "</a>")),
                                    u.selection.restore())
                                : 0 < t.length && t != u.selection.text().replace(/\n/g, "")
                                    ? (u.selection.remove(), u.html.insert('<a href="'.concat(e, '">').concat(Be.START_MARKER).concat(t.replace(/&/g, "&amp;")).concat(Be.END_MARKER, "</a>")), u.selection.restore())
                                    : (!(function p() {
                                        if (!u.selection.isCollapsed()) {
                                            ...
                                            for (var e = u.$el.find(".fr-marker").addClass("fr-unprocessed").toArray(); e.length;) {
                                                ...
                                                var a = u.node.deepestParent(t.get(0));
                                                if (a) {
                                                    for (var n = t.get(0), r = "", i = ""; (n = n.parentNode), u.node.isBlock(n) || ((r += u.node.closeTagString(n)), (i = u.node.openTagString(n) + i)), n != a;);
                                                    var o = u.node.openTagString(t.get(0)) + t.html() + u.node.closeTagString(t.get(0));
                                                    t.replaceWith('<span id="fr-break"></span>');
                                                    var s = a.outerHTML;
                                                    (s = (s = s.replace(/<span id="fr-break"><\/span>/g, r + o + i)).replace(i + r, "")), (a.outerHTML = s);
                                                }
                    ...
                    for (var c = m(), d = 0; d < c.length; d++) (i = h(c[d])).attr(a), i.removeAttr("_moz_dirty");
                    1 == c.length && u.$wp && !n && (h(c[0]).prepend(Be.START_MARKER).append(Be.END_MARKER), u.selection.restore());
                }
                if (n) {
                    var f = u.popups.get("link.insert");
                    f && f.find("input:focus").blur(), u.image.edit(n);
                } else v();
            }
            function d() {
                i();
                ...
                if (e) {
                    ...
                    t || (t = s()),
                        u.popups.isVisible("link.insert") || (u.popups.refresh("link.insert"), u.selection.save(), u.helpers.isMobile() && (u.events.disableBlur(), u.$el.blur(), u.events.enableBlur())),
                        u.popups.setContainer("link.insert", u.$sc);
                    var a = (u.image ? u.image.get() : null) || h(e),
                        n = a.offset().left + a.outerWidth() / 2,
                        r = a.offset().top + a.outerHeight();
                    u.popups.show("link.insert", n, r, a.outerHeight(), !0);
                }
            }
            function f() {
                ...
                if (e) {
                    ...
                    u.popups.show("link.insert", a, n, e.outerHeight(), !0);
                }
            }
            return {
                _init: function e() {
                    u.events.on("keyup", function (e) {
                        e.which != Be.KEYCODE.ESC && v(e);
                    }),
                        u.events.on("window.mouseup", v),
                        u.events.$on(u.$el, "click", "a", function (e) {
                            u.edit.isDisabled() && e.preventDefault();
                        }),
                        u.helpers.isMobile() && u.events.$on(u.$doc, "selectionchange", v),
                        s(!0),
                ...
                remove: function a() {
                    ...
                    t && e ? (t.unwrap(), u.image.edit(t)) : e && (u.selection.save(), h(e).replaceWith(h(e).html()), u.selection.restore(), i());
                },
                showInsertPopup: function p() {
                    ...
                    if ((t || (t = s()), !t.hasClass("fr-active")))
                        if ((u.popups.refresh("link.insert"), u.popups.setContainer("link.insert", u.$tb || u.$sc), e.isVisible())) {
                            var a = u.button.getPosition(e),
                                n = a.left,
                                r = a.top;
                            u.popups.show("link.insert", n, r, e.outerHeight());
                ...
                usePredefined: function b(e) {
                    var t,
                        ...
                        i = r.find('input.fr-link-attr[type="text"]'),
                        o = r.find('input.fr-link-attr[type="checkbox"]');
                    for (n.rel && (r.rel = n.rel), a = 0; a < i.length; a++) n[(t = h(i[a])).attr("name")] ? (t.val(n[t.attr("name")]), t.toggleClass("fr-not-empty", !0)) : "text" != t.attr("name") && t.val("");
                    for (a = 0; a < o.length; a++) (t = h(o[a])).attr("checked", t.data("checked") == n[t.attr("name")]);
                    u.accessibility.focusPopup(r);
                },
                insertCallback: function E() {
                    var e,
                        t,
                        a = u.popups.get("link.insert"),
                        n = a.find('input.fr-link-attr[type="text"]'),
                        r = a.find('input.fr-link-attr[type="checkbox"]'),
                        i = (n.filter('[name="href"]').val() || "").trim(),
                        o = n.filter('[name="text"]').val(),
                        s = {};
                    for (t = 0; t < n.length; t++) (e = h(n[t])), ["href", "text"].indexOf(e.attr("name")) < 0 && (s[e.attr("name")] = e.val());
                ...
                back: function t() {
                    u.image && u.image.get()
                        ...
                        : (u.events.disableBlur(),
                            u.selection.restore(),
                            u.events.enableBlur(),
                            g() && u.$wp ? (u.selection.restore(), i(), v()) : "A" == u.el.tagName ? (u.$el.focus(), v()) : (u.popups.hide("link.insert"), u.toolbar.showInline()));
                },
                imageLink: f,
                applyStyle: function A(e, t, a) {
                    void 0 === a && (a = u.opts.linkMultipleStyles), void 0 === t && (t = u.opts.linkStyles);
                    var n = g();
                    if (!n) return !1;
                    if (!a) {
                        var r = Object.keys(t);
                        r.splice(r.indexOf(e), 1), h(n).removeClass(r.join(" "));
                    }
                    h(n).toggleClass(e), v();
                },
            };
        }),
        Be.DefineIcon("insertLink", { NAME: "link", SVG_KEY: "insertLink" }),
        Be.RegisterShortcut(Be.KEYCODE.K, "insertLink", null, "K"),
        Be.RegisterCommand("insertLink", {
            title: "Insert Link",
            undo: !1,
            focus: !0,
            refreshOnCallback: !1,
        ...
        Be.DefineIcon("linkOpen", { NAME: "external-link", FA5NAME: "external-link-alt", SVG_KEY: "openLink" }),
        Be.RegisterCommand("linkOpen", {
            title: "Open Link",
            undo: !1,
            refresh: function (e) {
            ...
            callback: function () {
                ...
                e &&
                    (-1 !== e.href.indexOf("mailto:")
                        ...
                        : (e.target || (e.target = "_self"), this.browser.msie || this.browser.edge ? this.o_win.open(e.href, e.target) : this.o_win.open(e.href, e.target, "noopener")),
                        this.popups.hide("link.edit"));
            },
            plugin: "link",
        }),
        Be.DefineIcon("linkEdit", { NAME: "edit", SVG_KEY: "edit" }),
        Be.RegisterCommand("linkEdit", {
            title: "Edit Link",
            undo: !1,
            refreshAfterCallback: !1,
            popup: !0,
        ...
        Be.DefineIcon("linkRemove", { NAME: "unlink", SVG_KEY: "unlink" }),
        Be.RegisterCommand("linkRemove", {
            title: "Unlink",
            callback: function () {
                this.link.remove();
            },
        ...
        Be.DefineIcon("linkBack", { NAME: "arrow-left", SVG_KEY: "back" }),
        Be.RegisterCommand("linkBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        Be.DefineIcon("linkList", { NAME: "search", SVG_KEY: "search" }),
        Be.RegisterCommand("linkList", {
            title: "Choose Link",
            type: "dropdown",
            focus: !1,
            undo: !1,
            refreshAfterCallback: !1,
            html: function () {
                for (var e = '<ul class="fr-dropdown-list" role="presentation">', t = this.opts.linkList, a = 0; a < t.length; a++)
                    e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="linkList" data-param1="'.concat(a, '">').concat(t[a].displayText || t[a].text, "</a></li>");
                return (e += "</ul>");
            },
            callback: function (e, t) {
        ...
        Be.DefineIcon("imageLink", { NAME: "link", SVG_KEY: "insertLink" }),
        Be.RegisterCommand("imageLink", {
            title: "Insert Link",
            undo: !1,
            focus: !1,
            popup: !0,
        ...
        Be.DefineIcon("linkStyle", { NAME: "magic", SVG_KEY: "linkStyles" }),
        Be.RegisterCommand("linkStyle", {
            title: "Style",
            type: "dropdown",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    t.hasOwnProperty(a) && (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="linkStyle" data-param1="'.concat(a, '">').concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
            },
            callback: function (e, t) {
        ...
        Object.assign(Be.DEFAULTS, { listAdvancedTypes: !0 }),
        (Be.PLUGINS.lists = function (f) {
            var p = f.$;
            function u(e) {
            ...
            function i(e, t) {
                    ...
                    for (var i = a.length - 1; 0 <= i; i--) {
                        ...
                        o.replaceWith(
                            "<"
                                ...
                                .concat(f.node.attributes(o.get(0)), ">")
                                .concat(o.html(), "</")
                                .concat(t.toLowerCase(), ">")
                        );
                    }
                ...
                var a,
                    n = f.html.defaultTag(),
                    r = null;
                e.length && (a = "rtl" == f.opts.direction || "rtl" == p(e[0]).css("direction") ? "margin-right" : "margin-left");
                for (var i = 0; i < e.length; i++)
                    if ("TD" != e[i].tagName && "TH" != e[i].tagName && "LI" != e[i].tagName) {
                        var o = f.helpers.getPX(p(e[i]).css(a)) || 0;
                        (e[i].style.marginLeft = null) === r && (r = o);
                        var s = 0 < r ? "<".concat(t, ' style="').concat(a, ": ").concat(r, 'px ">') : "<".concat(t, ">"),
                            l = "</".concat(t, ">");
                        for (o -= r; 0 < o / f.opts.indentMargin;) (s += "</".concat(t, ">")), (l += l), (o -= f.opts.indentMargin);
                        n && e[i].tagName.toLowerCase() == n ? p(e[i]).replaceWith("".concat(s, "<li").concat(f.node.attributes(e[i]), ">").concat(p(e[i]).html(), "</li>").concat(l)) : p(e[i]).wrap("".concat(s, "<li></li>").concat(l));
                    }
                f.clean.lists();
            }
            function o(e) {
                ...
                for (t = e.length - 1; 0 <= t; t--)
                    for (a = t - 1; 0 <= a; a--)
                        if (p(e[a]).find(e[t]).length || e[a] == e[t]) {
                            e.splice(t, 1);
                            break;
                        }
                var n = [];
                for (t = 0; t < e.length; t++) {
                    var r = p(e[t]),
                        i = e[t].parentNode,
                        o = r.attr("class");
                    if ((r.before(h(i.tagName)), "LI" == i.parentNode.tagName)) r.before(h("LI")), r.after(u("LI"));
                    else {
                        var s = "";
                        o && (s += ' class="'.concat(o, '"'));
                        var l = "rtl" == f.opts.direction || "rtl" == r.css("direction") ? "margin-right" : "margin-left";
                        f.helpers.getPX(p(i).css(l)) && 0 <= (p(i).attr("style") || "").indexOf("".concat(l, ":")) && (s += ' style="'.concat(l, ":").concat(f.helpers.getPX(p(i).css(l)), 'px;"')),
                            f.html.defaultTag() && 0 === r.find(f.html.blockTagsQuery()).length && r.wrapInner(f.html.defaultTag() + s),
                            f.node.isEmpty(r.get(0), !0) || 0 !== r.find(f.html.blockTagsQuery()).length || r.append("<br>"),
                            r.append(u("LI")),
                            r.prepend(h("LI"));
                    }
                    r.after(u(i.tagName)), "LI" == i.parentNode.tagName && (i = i.parentNode.parentNode), n.indexOf(i) < 0 && n.push(i);
                }
                for (t = 0; t < n.length; t++) {
                    var c = p(n[t]),
                        d = c.html();
                    (d = (d = d.replace(/<span class="fr-close-([a-z]*)"><\/span>/g, "</$1>")).replace(/<span class="fr-open-([a-z]*)"><\/span>/g, "<$1>")),
                        c.replaceWith(f.node.openTagString(c.get(0)) + d + f.node.closeTagString(c.get(0)));
                }
            ...
            function s(e) {
                ...
                for (var t = 0; t < e.length; t++) {
                    ...
                    if (a) {
                        var n = p(e[t]).find("> ul, > ol").last().get(0);
                        if (n) {
                            var r = p(document.createElement("li"));
                            p(n).prepend(r);
                            for (var i = f.node.contents(e[t])[0]; i && !f.node.isList(i);) {
                                var o = i.nextSibling;
                                r.append(i), (i = o);
                            }
                            p(a).append(p(n)), p(e[t]).remove();
                        } else {
                            var s = p(a).find("> ul, > ol").last().get(0);
                            if (s) p(s).append(p(e[t]));
                            else {
                                var l = p("<".concat(e[t].parentNode.tagName, ">"));
                                p(a).append(l), l.append(p(e[t]));
                            }
                        }
                    }
                }
            ...
            function l(e) {
                f.selection.save(), o(e), f.selection.restore();
            }
            function e(e) {
                if ("indent" == e || "outdent" == e) {
                    ...
                    for (var i = 0; i < a.length; i++) "LI" == a[i].tagName ? ((t = !0), n.push(a[i])) : "LI" == a[i].parentNode.tagName && ((t = !0), n.push(a[i].parentNode));
                    t && ("indent" == e ? s(n) : l(n));
                }
            }
            return {
                _init: function t() {
                    f.events.on("commands.after", e),
                        f.events.on(
                            "keydown",
                            function (e) {
                                if (e.which == Be.KEYCODE.TAB) {
                                    for (var t = f.selection.blocks(), a = [], n = 0; n < t.length; n++) "LI" == t[n].tagName ? a.push(t[n]) : "LI" == t[n].parentNode.tagName && a.push(t[n].parentNode);
                                    if (1 < a.length || (a.length && (f.selection.info(a[0]).atStart || f.node.isEmpty(a[0])))) return e.preventDefault(), e.stopPropagation(), e.shiftKey ? l(a) : s(a), !1;
                                }
                            },
                            !0
                        );
                ...
                format: function c(e, t) {
                    var a, n;
                    for (f.html.syncInputs(), f.selection.save(), f.html.wrap(!0, !0, !0, !0), f.selection.restore(), n = f.selection.blocks(), a = 0; a < n.length; a++)
                    ...
                    if (
                        ...
                        for (n = f.selection.blocks(), a = 0; a < n.length; a++) "LI" != n[a].tagName && "LI" == n[a].parentNode.tagName && (n[a] = n[a].parentNode);
                        for (a = 0; a < n.length; a++)
                            "LI" == n[a].tagName && (p(n[a].parentNode).css("list-style-type", "default" === t ? "" : t), 0 === (p(n[a].parentNode).attr("style") || "").length && p(n[a].parentNode).removeAttr("style"));
                    }
                },
                refresh: function r(e, t) {
                    var a = p(f.selection.element());
                    if (a.get(0) != f.el) {
                        var n = a.get(0);
                        (n =
                            "LI" != n.tagName && n.firstElementChild && "LI" != n.firstElementChild.tagName
                                ? a.parents("li").get(0)
                                : "LI" == n.tagName || n.firstElementChild
                                    ? n.firstElementChild && "LI" == n.firstElementChild.tagName
                                        ? a.get(0).firstChild
                                        : a.get(0)
                                    : a.parents("li").get(0)) &&
                            n.parentNode.tagName == t &&
                            f.el.contains(n.parentNode) &&
                            e.addClass("fr-active");
                    }
                },
            };
        }),
        Be.DefineIcon("formatOLSimple", { NAME: "list-ol", SVG_KEY: "orderedList" }),
        Be.RegisterCommand("formatOLSimple", {
            title: "Ordered List",
            type: "button",
        ...
        Be.DefineIcon("formatUL", { NAME: "list-ul", SVG_KEY: "unorderedList" }),
        Be.DefineIcon("formatOL", { NAME: "list-ol", SVG_KEY: "orderedList" }),
        Object.assign(Be.DEFAULTS, { paragraphFormat: { N: "Normal", H1: "Heading 1", H2: "Heading 2", H3: "Heading 3", H4: "Heading 4", PRE: "Code" }, paragraphFormatSelection: !1, paragraphDefaultSelection: "Paragraph Format" }),
        (Be.PLUGINS.paragraphFormat = function (p) {
            var u = p.$;
            function h(e, t) {
                var a = p.html.defaultTag();
                        ...
                        if (c[d].tagName != e && !p.node.isList(c[d])) {
                            ...
                            "LI" == c[d].tagName
                                ...
                                : "LI" == c[d].parentNode.tagName && c[d]
                                    ? ((o = f), (s = e), (l = p.html.defaultTag()), (s && s.toLowerCase() != l) || (s = 'div class="fr-temp-div"'), o.replaceWith(u("<" + s + ">").html(o.html())))
                                    : 0 <= ["TD", "TH"].indexOf(c[d].parentNode.tagName)
                                        ? ((n = f),
                                            (r = e),
                                            (i = p.html.defaultTag()),
                                            r || (r = 'div class="fr-temp-div"' + (p.node.isEmpty(n.get(0), !0) ? ' data-empty="true"' : "")),
                                            r.toLowerCase() == i ? (p.node.isEmpty(n.get(0), !0) || n.append("<br/>"), n.replaceWith(n.html())) : n.replaceWith(u("<" + r + ">").html(n.html())))
                                        : ((t = f),
                                            (a = e) || (a = 'div class="fr-temp-div"' + (p.node.isEmpty(t.get(0), !0) ? ' data-empty="true"' : "")),
                                            ("H1" != a && "H2" != a && "H3" != a && "H4" != a && "H5" != a) || !p.node.attributes(t.get(0)).includes("font-size:")
                                                ? t.replaceWith(
                                                    u("<" + a + " " + p.node.attributes(t.get(0)) + ">")
                                                        .html(t.html())
                                                        .removeAttr("data-empty")
                                                )
                                                : t.replaceWith(
                                                    u("<" + a + " " + p.node.attributes(t.get(0)).replace(/font-size:[0-9]+px;?/, "") + ">")
                                                        .html(t.html())
                                                        .removeAttr("data-empty")
                                                ));
                        }
                    ...
                    if (p.opts.paragraphFormatSelection) {
                        ...
                        if (t.length) {
                            var a = t[0],
                                n = "N",
                                r = p.html.defaultTag();
                            a.tagName.toLowerCase() != r && a != p.el && (n = a.tagName), 0 <= ["LI", "TD", "TH"].indexOf(n) && (n = "N"), e.find(">span").text(p.language.translate(p.opts.paragraphFormat[n]));
                        } else e.find(">span").text(p.language.translate(p.opts.paragraphFormat.N));
                    }
                },
            };
        }),
        Be.RegisterCommand("paragraphFormat", {
            type: "dropdown",
            displaySelection: function (e) {
            ...
            html: function () {
                ...
                for (var a in t)
                    if (t.hasOwnProperty(a)) {
                        var n = this.shortcuts.get("paragraphFormat." + a);
                        (n = n ? '<span class="fr-shortcut">' + n + "</span>" : ""),
                            (e +=
                                '<li role="presentation"><' +
                                ("N" == a ? this.html.defaultTag() || "DIV" : a) +
        ...
        Be.DefineIcon("paragraphFormat", { NAME: "paragraph", SVG_KEY: "paragraphFormat" }),
        Object.assign(Be.DEFAULTS, { paragraphStyles: { "fr-text-gray": "Gray", "fr-text-bordered": "Bordered", "fr-text-spaced": "Spaced", "fr-text-uppercase": "Uppercase" }, paragraphMultipleStyles: !0 }),
        (Be.PLUGINS.paragraphStyle = function (s) {
            var l = s.$;
            return {
                _init: function e() { },
                apply: function c(e, t, a) {
                    void 0 === t && (t = s.opts.paragraphStyles), void 0 === a && (a = s.opts.paragraphMultipleStyles);
                    var n = "";
                    a || ((n = Object.keys(t)).splice(n.indexOf(e), 1), (n = n.join(" "))), s.selection.save(), s.html.wrap(!0, !0, !0, !0), s.selection.restore();
                    var r = s.selection.blocks();
                    s.selection.save();
                    for (var i = l(r[0]).hasClass(e), o = 0; o < r.length; o++)
                        l(r[o]).removeClass(n).toggleClass(e, !i), l(r[o]).hasClass("fr-temp-div") && l(r[o]).removeClass("fr-temp-div"), "" === l(r[o]).attr("class") && l(r[o]).removeAttr("class");
        ...
        Be.RegisterCommand("paragraphStyle", {
            type: "dropdown",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command '
                            .concat(a, '" tabIndex="-1" role="option" data-cmd="paragraphStyle" data-param1="')
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
            },
        ...
        Object.assign(Be.DEFAULTS, { html2pdf: window.html2pdf }),
        (Be.PLUGINS.print = function (l) {
            return {
                run: function e() {
                    !(function s(e) {
                        var t = l.html.get(),
                        ...
                        l.shared.print_iframe
                            ? (a = l.shared.print_iframe)
                            : (((a = document.createElement("iframe")).name = "fr-print"),
                                ...
                                (l.shared.print_iframe = a));
                        try {
                            document.body.removeChild(a);
                        } catch (o) { }
                        document.body.appendChild(a);
                        var n = function n() {
                            e(), a.removeEventListener("load", n);
                        };
                        a.addEventListener("load", n);
                        var r = a.contentWindow;
                        r.document.open(),
                            r.document.write("<!DOCTYPE html><html " + (l.opts.documentReady ? 'style="margin: 0; padding: 0;"' : "") + "><head><title>" + document.title + "</title>"),
                        ...
                        Array.prototype.forEach.call(i, function (e) {
                            ...
                            r.document.write(
                                ...
                                ("rtl" == l.opts.direction ? "right" : "left") +
                                "; direction: " +
                                l.opts.direction +
                                "; " +
                                (l.opts.documentReady ? " padding: 2cm; width: 17cm; margin: 0;" : "") +
                                '"><div class="fr-view">'
                            ),
                            r.document.write(t),
                            r.document.write("</div></body></html>"),
                            r.document.close();
                    })(function () {
                        setTimeout(function () {
                ...
                toPDF: function t() {
                    l.opts.html2pdf &&
                        (l.$el.css("text-align", "left"),
                            l.opts
                                .html2pdf()
                                .set({ margin: [10, 20], html2canvas: { useCORS: !0 } })
                                .from(l.el)
                                .save(),
                            setTimeout(function () {
                                l.$el.css("text-align", "");
        ...
        Be.DefineIcon("print", { NAME: "print", SVG_KEY: "print" }),
        Be.RegisterCommand("print", {
            title: "Print",
            undo: !1,
            focus: !1,
            plugin: "print",
        ...
        Be.DefineIcon("getPDF", { NAME: "file-pdf-o", FA5NAME: "file-pdf", SVG_KEY: "pdfExport" }),
        Be.RegisterCommand("getPDF", {
            title: "Download PDF",
            type: "button",
            focus: !1,
            undo: !1,
        ...
        Object.assign(Be.DEFAULTS, { quickInsertButtons: ["image", "video", "embedly", "table", "ul", "ol", "hr"], quickInsertTags: ["p", "div", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote"], quickInsertEnabled: !0 }),
        (Be.QUICK_INSERT_BUTTONS = {}),
        Be.DefineIcon("quickInsert", { SVG_KEY: "add", template: "svg" }),
        (Be.RegisterQuickInsertButton = function (e, t) {
            Be.QUICK_INSERT_BUTTONS[e] = Object.assign({ undo: !0 }, t);
        }),
        Be.RegisterQuickInsertButton("image", {
            icon: "insertImage",
            ...
            callback: function () {
                ...
                e.shared.$qi_image_input ||
                    ((e.shared.$qi_image_input = t(document.createElement("input"))
                        .attr("accept", "image/" + e.opts.imageAllowedTypes.join(", image/").toLowerCase())
                        .attr("name", "quickInsertImage".concat(this.id))
                        .attr("style", "display: none;")
                        .attr("type", "file")),
                        t("body").first().append(e.shared.$qi_image_input),
                        e.events.$on(
                            e.shared.$qi_image_input,
                            "change",
                            function () {
        ...
        Be.RegisterQuickInsertButton("video", {
            icon: "insertVideo",
        ...
        Be.RegisterQuickInsertButton("embedly", {
            icon: "embedly",
        ...
        Be.RegisterQuickInsertButton("table", {
            icon: "insertTable",
        ...
        Be.RegisterQuickInsertButton("ol", {
            icon: "formatOL",
        ...
        Be.RegisterQuickInsertButton("ul", {
            icon: "formatUL",
            requiredPlugin: "lists",
            title: "Unordered List",
            callback: function () {
        ...
        Be.RegisterQuickInsertButton("hr", {
            icon: "insertHR",
        ...
        (Be.PLUGINS.quickInsert = function (o) {
            var s,
                l,
                c = o.$;
            function a(e) {
                var t, a, n;
                ((t = e.offset().top - o.$box.offset().top), (a = ((o.$iframe && o.$iframe.offset().left) || 0) + e.offset().left < s.outerWidth() ? e.offset().left + s.outerWidth() : 0 - s.outerWidth()), o.opts.enter != Be.ENTER_BR)
                    ? (n = (s.outerHeight() - e.outerHeight()) / 2)
                    : (c(document.createElement("span")).html(Be.INVISIBLE_SPACE).insertAfter(e), (n = (s.outerHeight() - e.next().outerHeight()) / 2), e.next().remove());
                if (o.opts.iframe) {
                    var r = o.helpers.getPX(o.$wp.find(".fr-iframe").css("padding-top"));
                    t += o.$iframe.offset().top + r;
                }
                s.hasClass("fr-on") && 0 <= t && l.css("top", t - n),
                    0 <= t && t - Math.abs(n) <= o.$box.outerHeight() - e.outerHeight()
                        ? (s.hasClass("fr-hidden") && (s.hasClass("fr-on") && d(), s.removeClass("fr-hidden")), s.css("top", t - n))
                        : s.hasClass("fr-visible") && (s.addClass("fr-hidden"), f()),
                    s.css("left", a);
            }
            function r(e) {
                s ||
                    (function t() {
                        o.shared.$quick_insert ||
                            (o.shared.$quick_insert = c(document.createElement("div"))
                                .attr("class", "fr-quick-insert")
                                .html('<a class="fr-floating-btn" role="button" tabIndex="-1" title="'.concat(o.language.translate("Quick Insert"), '">').concat(o.icon.create("quickInsert"), "</a>")));
                        (s = o.shared.$quick_insert),
                            ...
                            o.events.on("commands.after", function () {
                                o.popups.areVisible() || n();
                            }),
                            o.events.bindClick(o.$box, ".fr-quick-insert > a", d),
                            o.events.bindClick(o.$box, ".fr-qi-helper > a.fr-btn", function (e) {
                                var t = c(e.currentTarget).data("cmd");
                                if (!1 === o.events.trigger("quickInsert.commands.before", [t])) return !1;
                                Be.QUICK_INSERT_BUTTONS[t].callback.apply(o, [e.currentTarget]), Be.QUICK_INSERT_BUTTONS[t].undo && o.undo.saveStep(), o.events.trigger("quickInsert.commands.after", [t]), o.quickInsert.hide();
                            }),
                            o.events.$on(o.$wp, "scroll", p),
                            o.events.$on(o.$tb, "transitionend", ".fr-more-toolbar", p);
                    })(),
                    s.hasClass("fr-on") && f(),
                    o.$box.append(s),
                    a(e),
            ...
            function n() {
                if (o.core.hasFocus()) {
                    ...
                    if ((o.opts.enter == Be.ENTER_BR || o.node.isBlock(e) || (e = o.node.blockParent(e)), o.opts.enter == Be.ENTER_BR && !o.node.isBlock(e))) {
                        var t = o.node.deepestParent(e);
                        t && (e = t);
                    }
                    var a = function a() {
                        return o.opts.enter != Be.ENTER_BR && o.node.isEmpty(e) && 0 <= o.opts.quickInsertTags.indexOf(e.tagName.toLowerCase());
                    },
                        n = function n() {
                            return (
                                o.opts.enter == Be.ENTER_BR &&
                                (("BR" == e.tagName && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling))) ||
                                    (o.node.isEmpty(e) && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling)) && (!e.nextSibling || "BR" == e.nextSibling.tagName || o.node.isBlock(e.nextSibling))))
                            );
                        };
                    e && (a() || n()) ? (s && s.data("tag").is(c(e)) && s.hasClass("fr-on") ? f() : o.selection.isCollapsed() && r(c(e))) : i();
                }
            }
            function i() {
            ...
            function d(e) {
                if ((e && e.preventDefault(), s.hasClass("fr-on") && !s.hasClass("fr-hidden"))) f();
                    ...
                    if (!o.shared.$qi_helper) {
                        for (var t = o.opts.quickInsertButtons, a = '<div class="fr-qi-helper">', n = 0, r = 0; r < t.length; r++) {
                            var i = Be.QUICK_INSERT_BUTTONS[t[r]];
                            i &&
                                (!i.requiredPlugin || (Be.PLUGINS[i.requiredPlugin] && 0 <= o.opts.pluginsEnabled.indexOf(i.requiredPlugin))) &&
                                (a += '<a class="fr-btn fr-floating-btn" role="button" title="'
                                    .concat(o.language.translate(i.title), '" tabIndex="-1" data-cmd="')
                                    .concat(t[r], '" style="transition-delay: ')
                                    .concat(0.025 * n++, 's;">')
                                    .concat(o.icon.create(i.icon), "</a>"));
                        }
                        (a += "</div>"),
                            (o.shared.$qi_helper = c(a)),
            ...
            function f() {
                var a = o.$box.find(".fr-qi-helper");
                a.length &&
                    (function () {
                        for (var t = a.find("a"), e = 0; e < t.length; e++)
                            !(function (e) {
                                setTimeout(function () {
                                    a.children()
                                        .eq(t.length - 1 - e)
                        ...
                        setTimeout(function () {
                            a.css("left", -9999), s && !s.hasClass("fr-hidden") && s.removeClass("fr-on");
                        }, 25 * e);
                    })();
            }
            function p() {
                s.hasClass("fr-visible") && a(s.data("tag"));
            }
            return {
                _init: function e() {
                    if (!o.$wp || !o.opts.quickInsertEnabled) return !1;
                    o.popups.onShow("image.edit", i),
                        o.events.on("mouseup", n),
                        o.helpers.isMobile() && o.events.$on(c(o.o_doc), "selectionchange", n),
                        o.events.on("blur", i),
                        o.events.on("keyup", n),
                        o.events.on("keydown", function () {
                            setTimeout(function () {
                                n();
                            }, 0);
                        });
                    ...
                    r.selection.save(),
                        ...
                        "increase" == e
                            ? (function n() {
                                ...
                                r.selection.save();
                                var a = i(document.createElement("blockquote"));
                                for (a.insertBefore(t[0]), e = 0; e < t.length; e++) a.append(t[e]);
        ...
        Be.RegisterShortcut(Be.KEYCODE.SINGLE_QUOTE, "quote", "increase", "'"),
        Be.RegisterShortcut(Be.KEYCODE.SINGLE_QUOTE, "quote", "decrease", "'", !0),
        Be.RegisterCommand("quote", {
            title: "Quote",
            type: "dropdown",
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                ...
                for (var a in t)
                    if (t.hasOwnProperty(a)) {
                        var n = this.shortcuts.get("quote.".concat(a));
                        e += '<li role="presentation"><a class="fr-command fr-active '
                            .concat(a, '" tabIndex="-1" role="option" data-cmd="quote" data-param1="')
                            .concat(a, '" title="')
                            .concat(t[a], '">')
                            .concat(this.language.translate(t[a]))
                            .concat(n ? '<span class="fr-shortcut">'.concat(n, "</span>") : "", "</a></li>");
                    }
                return (e += "</ul>");
            },
            callback: function (e, t) {
        ...
        Be.DefineIcon("quote", { NAME: "quote-left", SVG_KEY: "blockquote" }),
        Object.assign(Be.DEFAULTS, { saveInterval: 1e4, saveURL: null, saveParams: {}, saveParam: "body", saveMethod: "POST" }),
        (Be.PLUGINS.save = function (s) {
            var l = s.$,
                e = null,
                c = null,
                t = !1,
                ...
                a = {};
            function p(e, t) {
                s.events.trigger("save.error", [{ code: e, message: a[e] }, t]);
            }
            function n(e) {
                ...
                if (("string" == typeof t && (e = t), s.opts.saveURL)) {
                    ...
                    for (var r in s.opts.saveParams)
                        if (s.opts.saveParams.hasOwnProperty(r)) {
                            var i = s.opts.saveParams[r];
                            a[r] = "function" == typeof i ? i.call(this) : i;
                        }
                    var o = {};
                    (o[s.opts.saveParam] = e),
                        l(this).ajax({
                            ...
                            url: s.opts.saveURL,
                            data: Object.assign(o, a),
                            crossDomain: s.opts.requestWithCORS,
                            withCredentials: s.opts.requestWithCredentials,
                            headers: s.opts.requestHeaders,
                            done: function (e, t, a) {
                                (c = n), s.events.trigger("save.after", [e]);
                            },
                            fail: function (e) {
            ...
            return (
                (a[d] = "Missing saveURL option."),
                (a[f] = "Something went wrong during save."),
                {
                    _init: function i() {
                        s.opts.saveInterval &&
                            ((c = s.html.get()),
                                s.events.on("contentChanged", function () {
        ...
        Be.DefineIcon("save", { NAME: "floppy-o", FA5NAME: "save" }),
        Be.RegisterCommand("save", {
            title: "Save",
            undo: !1,
            focus: !1,
            refreshAfterCallback: !1,
        ...
        Object.assign(Be.POPUP_TEMPLATES, { specialCharacters: "[_BUTTONS_][_CUSTOM_LAYER_]" }),
        (Be.PLUGINS.specialCharacters = function (g) {
            var m = g.$,
                a = g.opts.specialCharactersSets[0],
                ...
                return '\n        <div class="fr-buttons fr-tabs fr-tabs-scroll">\n          '
                    .concat(
                        (function t(e, a) {
                            ...
                            return (
                                e.forEach(function (e) {
                                    var t = { elementClass: e.title === a.title ? "fr-active fr-active-tab" : "", title: e.title, dataParam1: e.title, desc: e["char"] };
                                    n += '<button class="fr-command fr-btn fr-special-character-category '
                                        .concat(t.elementClass, '" title="')
                                        .concat(t.title, '" data-cmd="setSpecialCharacterCategory" data-param1="')
                        ...
                        (function n(e) {
                            ...
                            return (
                                e.list.forEach(function (e) {
                                    ...
                                    a += '<span class="fr-command fr-special-character fr-icon" role="button" \n      data-cmd="insertSpecialCharacter" data-param1="'
                                        .concat(t.dataParam1, '" \n      title="')
                                        .concat(t.title, '">')
            ...
            return {
                setSpecialCharacterCategory: function n(t) {
                    (a = r.filter(function (e) {
                        return e.title === t;
                    })[0]),
                        (function e() {
                            g.popups.get("specialCharacters").html(o + s());
                        })();
                },
                showSpecialCharsPopup: function l() {
                    ...
                    if (
                        (e ||
                            (e = (function i() {
                                g.opts.toolbarInline && 0 < g.opts.specialCharButtons.length && (o = '<div class="fr-buttons fr-tabs">'.concat(g.button.buildList(g.opts.specialCharButtons), "</div>"));
                                var e = { buttons: o, custom_layer: s() },
                                            ...
                                            function (e) {
                                                ...
                                                if (Be.KEYCODE.TAB == i) {
                                                    if ((t.is("span.fr-icon") && e.shiftKey) || (t.is("a") && !e.shiftKey)) {
                                                        var o = h.find(".fr-buttons");
                                                        a = !g.accessibility.focusToolbar(o, !!e.shiftKey);
                                                    }
                                                    if (!1 !== a) {
                                                        var s = h
                                                            .find("span.fr-icon:focus")
                                                            .first()
                                                            .concat(h.findVisible(" span.fr-icon").first().concat(h.find("a")));
                                                        t.is("span.fr-icon") && (s = s.not("span.fr-icon:not(:focus)")),
                                                            (n = s.index(t)),
                                                            (n = e.shiftKey ? (((n - 1) % s.length) + s.length) % s.length : (n + 1) % s.length),
                                                            (r = s.get(n)),
                                                    ...
                                                    if (t.is("span.fr-icon")) {
                                                        ...
                                                        Be.KEYCODE.ARROW_UP == i
                                                            ...
                                                            : Be.KEYCODE.ARROW_DOWN == i
                                                                ...
                                                                : Be.KEYCODE.ARROW_LEFT == i
                                                                    ? (p = (((p - 1) % u) + u) % u)
                                                                    : Be.KEYCODE.ARROW_RIGHT == i && (p = (p + 1) % u),
                                                            (r = m(l.get(p))),
                                                            g.events.disableBlur(),
                                                            r.focus(),
                                                            (a = !1);
                                                    }
                                                } else Be.KEYCODE.ENTER == i && (t.is("a") ? t[0].click() : g.button.exec(t), (a = !1));
                                                return !1 === a && (e.preventDefault(), e.stopPropagation()), a;
                                            },
                                            !0
                                        );
                        ...
                        var t = g.$tb.find('.fr-command[data-cmd="specialCharacters"]'),
                            a = g.button.getPosition(t),
                            n = a.left,
                            r = a.top;
                        g.popups.show("specialCharacters", n, r, outerHeight);
                    }
                },
                back: function e() {
        ...
        Be.DefineIcon("specialCharacters", { NAME: "dollar-sign", SVG_KEY: "symbols" }),
        Be.RegisterCommand("specialCharacters", {
        ...
        Be.DefineIcon("specialCharBack", { NAME: "arrow-left", SVG_KEY: "back" }),
        Be.RegisterCommand("specialCharBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        Object.assign(Be.POPUP_TEMPLATES, { "table.insert": "[_BUTTONS_][_ROWS_COLUMNS_]", "table.edit": "[_BUTTONS_]", "table.colors": "[_BUTTONS_][_COLORS_][_CUSTOM_COLOR_]" }),
        Object.assign(Be.DEFAULTS, {
        ...
        (Be.PLUGINS.table = function (C) {
            ...
            function u() {
                ...
                if (e) {
                    ...
                    if ((t || (t = p()), t)) {
                        ...
                        var a = x(e),
                            n = a.left + (a.right - a.left) / 2,
                            r = a.bottom;
                        C.popups.show("table.edit", n, r, a.bottom - a.top, !0),
                            C.edit.isDisabled() &&
                            (1 < J().length && C.toolbar.disable(), C.$el.removeClass("fr-no-selection"), C.edit.on(), C.button.bulkRefresh(), C.selection.setAtEnd(C.$el.find(".fr-selected-cell").last().get(0)), C.selection.restore());
                    }
                }
            }
            function s() {
                ...
                if (e) {
                    ...
                    t ||
                        (t = (function o() {
                            ...
                            C.opts.colorsHEXInput &&
                                (t = '<div class="fr-color-hex-layer fr-table-colors-hex-layer fr-active fr-layer" id="fr-table-colors-hex-layer-'
                                    .concat(C.id, '"><div class="fr-input-line"><input maxlength="7" id="fr-table-colors-hex-layer-text-')
                                    ...
                                    .concat(C.language.translate("OK"), "</button></div></div>"));
                            var a = {
                                buttons: e,
                                colors: (function r() {
                                    for (var e = '<div class="fr-color-set fr-table-colors">', t = 0; t < C.opts.tableColors.length; t++)
                                        0 !== t && t % C.opts.tableColorsStep == 0 && (e += "<br>"),
                                            "REMOVE" != C.opts.tableColors[t]
                                                ? (e += '<span class="fr-command" style="background: '
                                                    .concat(C.opts.tableColors[t], ';" tabIndex="-1" role="button" data-cmd="tableCellBackgroundColor" data-param1="')
                                                    .concat(C.opts.tableColors[t], '"><span class="fr-sr-only">')
                                                    .concat(C.language.translate("Color"), " ")
                                                    .concat(C.opts.tableColors[t], "&nbsp;&nbsp;&nbsp;</span></span>"))
                                                : (e += '<span class="fr-command" data-cmd="tableCellBackgroundColor" tabIndex="-1" role="button" data-param1="REMOVE" title="'
                                                    .concat(C.language.translate("Clear Formatting"), '">')
                                                    .concat(C.icon.create("tableColorRemove"), '<span class="fr-sr-only">')
                                                    .concat(C.language.translate("Clear Formatting"), "</span></span>"));
                                    return (e += "</div>");
                                })(),
                                custom_color: t,
                            },
                                n = C.popups.create("table.colors", a);
                            return (
                                C.events.$on(C.$wp, "scroll.table-colors", function () {
                                ...
                                (function i(h) {
                                    C.events.on(
                                        ...
                                        function (e) {
                                            ...
                                            if (Be.KEYCODE.TAB == a) {
                                                var r = h.find(".fr-buttons");
                                                n = !C.accessibility.focusToolbar(r, !!e.shiftKey);
                                            } else if (Be.KEYCODE.ARROW_UP == a || Be.KEYCODE.ARROW_DOWN == a || Be.KEYCODE.ARROW_LEFT == a || Be.KEYCODE.ARROW_RIGHT == a) {
                                                var i = t.parent().find("span.fr-command"),
                                                    o = i.index(t),
                                                    s = C.opts.colorsStep,
                                                    l = Math.floor(i.length / s),
                                                    c = o % s,
                                                ...
                                                Be.KEYCODE.ARROW_UP == a
                                                    ...
                                                    : Be.KEYCODE.ARROW_DOWN == a
                                                        ...
                                                        : Be.KEYCODE.ARROW_LEFT == a
                                                            ...
                                                            : Be.KEYCODE.ARROW_RIGHT == a && (f = (f + 1) % p);
                                                var u = L(i.get(f));
                                                C.events.disableBlur(), u.focus(), (n = !1);
                                            } else Be.KEYCODE.ENTER == a && (C.button.exec(t), (n = !1));
                                            return !1 === n && (e.preventDefault(), e.stopPropagation()), n;
                                        },
                                        !0
                                    );
                    ...
                    !(function i() {
                        var e = C.popups.get("table.colors"),
                            ...
                            a = C.helpers.RGBToHex(t.css("background-color")),
                            n = e.find(".fr-table-colors-hex-layer input");
                        e.find(".fr-selected-color").removeClass("fr-selected-color fr-active-item"), e.find('span[data-param1="'.concat(a, '"]')).addClass("fr-selected-color fr-active-item"), n.val(a).trigger("change");
                    })(),
                        C.popups.show("table.colors", n, r, a.bottom - a.top, !0);
                }
            }
            function l() {
                0 === J().length && C.toolbar.enable();
            }
            function d(e) {
                if (e)
                    return (
                ...
                var a = {
                    ...
                    rows_columns: (function i() {
                        for (var e = '<div class="fr-table-size"><div class="fr-table-size-info">1 &times; 1</div><div class="fr-select-table-size">', t = 1; t <= C.opts.tableInsertMaxSize; t++) {
                            for (var a = 1; a <= C.opts.tableInsertMaxSize; a++) {
                                var n = "inline-block";
                                2 < t && !C.helpers.isMobile() && (n = "none");
                                var r = "fr-table-cell ";
                                1 == t && 1 == a && (r += " hover"),
                                    (e += '<span class="fr-command '
                                        .concat(r, '" tabIndex="-1" data-cmd="tableInsert" data-row="')
                                        .concat(t, '" data-col="')
                                        .concat(a, '" data-param1="')
                                        .concat(t, '" data-param2="')
                                        .concat(a, '" style="display: ')
                                        .concat(n, ';" role="button"><span></span><span class="fr-sr-only">')
                                        .concat(t, " &times; ")
                                        .concat(a, "&nbsp;&nbsp;&nbsp;</span></span>"));
                            }
                    ...
                    n = C.popups.create("table.insert", a);
                return (
                    C.events.$on(
                        n,
                        "mouseover",
                        ...
                        C.events.$on(e, "focus", "[tabIndex]", function (e) {
                            ...
                            C.events.on(
                                ...
                                function (e) {
                                    ...
                                    var a,
                                        n = e.which;
                                    if (Be.KEYCODE.ARROW_UP == n || Be.KEYCODE.ARROW_DOWN == n || Be.KEYCODE.ARROW_LEFT == n || Be.KEYCODE.ARROW_RIGHT == n) {
                                        if (t.is("span.fr-table-cell")) {
                                            var r = t.parent().find("span.fr-table-cell"),
                                                i = r.index(t),
                                                o = C.opts.tableInsertMaxSize,
                                                s = i % o,
                                                l = Math.floor(i / o);
                                            Be.KEYCODE.ARROW_UP == n
                                                ? (l = Math.max(0, l - 1))
                                                : Be.KEYCODE.ARROW_DOWN == n
                                                    ? (l = Math.min(C.opts.tableInsertMaxSize - 1, l + 1))
                                                    : Be.KEYCODE.ARROW_LEFT == n
                                                        ? (s = Math.max(0, s - 1))
                                                        : Be.KEYCODE.ARROW_RIGHT == n && (s = Math.min(C.opts.tableInsertMaxSize - 1, s + 1));
                                            var c = l * o + s,
                                                d = L(r.get(c));
                                            f(d), C.events.disableBlur(), d.focus(), (a = !1);
                                        }
                                    } else Be.KEYCODE.ENTER == n && (C.button.exec(t), (a = !1));
                                    return !1 === a && (e.preventDefault(), e.stopPropagation()), a;
                                },
                                !0
                            );
            ...
            function f(e) {
                ...
                null !== a && (a = parseInt(a));
                var n = e.parent();
                n.siblings(".fr-table-size-info").html("".concat(t, " &times; ").concat(a)), n.find("> span").removeClass("hover fr-active-item");
                for (var r = 1; r <= C.opts.tableInsertMaxSize; r++)
                    for (var i = 0; i <= C.opts.tableInsertMaxSize; i++) {
                        var o = n.find('> span[data-row="'.concat(r, '"][data-col="').concat(i, '"]'));
                        r <= t && i <= a ? o.addClass("hover") : r <= t + 1 || (r <= 2 && !C.helpers.isMobile()) ? o.css("display", "inline-block") : 2 < r && !C.helpers.isMobile() && o.css("display", "none");
                    }
            ...
            function p(e) {
                ...
                if (0 < C.opts.tableEditButtons.length) {
                    var t = { buttons: '<div class="fr-buttons">'.concat(C.button.buildList(C.opts.tableEditButtons), "</div>") },
                        a = C.popups.create("table.edit", t);
                    return (
            ...
            function g(e) {
                ...
                if (0 < t.length) {
                    ...
                    var a,
                        ...
                        o = O(i);
                    if (null == o) return;
                    n = "above" == e ? o.min_i : o.max_i;
                    var s = "<tr>";
                    for (a = 0; a < i[n].length; a++) {
                        if (("below" == e && n < i.length - 1 && i[n][a] == i[n + 1][a]) || ("above" == e && 0 < n && i[n][a] == i[n - 1][a])) {
                            if (0 === a || (0 < a && i[n][a] != i[n][a - 1])) {
                                var l = L(i[n][a]);
                                l.attr("rowspan", parseInt(l.attr("rowspan"), 10) + 1);
                            }
                        } else s += '<td style="' + L(i[n][a]).attr("style") + '" ><br></td>';
                    }
                    (s += "</tr>"),
                        (r = 0 < C.$el.find("th.fr-selected-cell").length && "below" == e ? L(t.find("tbody").not(t.find("> table tbody"))) : L(t.find("tr").not(t.find("> table tr")).get(n))),
                        "below" == e ? ("TBODY" == r.attr("tagName") ? r.prepend(s) : r[0].parentNode && r[0].insertAdjacentHTML("afterend", s)) : "above" == e && (r.before(s), C.popups.isVisible("table.edit") && u());
                }
            }
            function m(e, t, a) {
                var n,
                ...
                if (e < (t = Math.min(t, c[0].length - 1)))
                    for (r = e; r <= t; r++)
                        if (!(e < r && c[0][r] == c[0][r - 1]) && 1 < (o = Math.min(parseInt(c[0][r].getAttribute("colspan"), 10) || 1, t - e + 1)) && c[0][r] == c[0][r + 1])
                            for (l = o - 1, n = 1; n < c.length; n++)
                                if (c[n][r] != c[n - 1][r]) {
                                    for (i = r; i < r + o; i++)
                                        if (1 < (s = parseInt(c[n][i].getAttribute("colspan"), 10) || 1) && c[n][i] == c[n][i + 1]) i += l = Math.min(l, s - 1);
            ...
            function v(e, t, a) {
                ...
                if (e < (t = Math.min(t, c.length - 1)))
                    for (n = e; n <= t; n++)
                        if (!(e < n && c[n][0] == c[n - 1][0]) && 1 < (o = Math.min(parseInt(c[n][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && c[n][0] == c[n + 1][0])
                            for (l = o - 1, r = 1; r < c[0].length; r++)
                                if (c[n][r] != c[n][r - 1]) {
                                    for (i = n; i < n + o; i++)
                                        if (1 < (s = parseInt(c[i][r].getAttribute("rowspan"), 10) || 1) && c[i][r] == c[i + 1][r]) i += l = Math.min(l, s - 1);
                                        else if (!(l = Math.max(0, l - 1))) break;
                                    if (!l) break;
                                }
                l && b(c, l, "rowspan", e, t, 0, c[0].length - 1);
            }
            function b(e, t, a, n, r, i, o) {
                var s, l, c;
                for (s = n; s <= r; s++)
                    for (l = i; l <= o; l++)
                        (n < s && e[s][l] == e[s - 1][l]) || (i < l && e[s][l] == e[s][l - 1]) || (1 < (c = parseInt(e[s][l].getAttribute(a), 10) || 1) && (1 < c - t ? e[s][l].setAttribute(a, c - t) : e[s][l].removeAttribute(a)));
            }
                    ...
                    e
                        ...
                        .each(function (s, e) {
                            ...
                            t.find("> th, > td").each(function (e, t) {
                                for (var a = L(t), n = parseInt(a.attr("colspan"), 10) || 1, r = parseInt(a.attr("rowspan"), 10) || 1, i = s; i < s + r; i++)
                                    for (var o = l; o < l + n; o++) c[i] || (c[i] = []), c[i][o] ? l++ : (c[i][o] = t);
                                l += n;
                            });
                        }),
                    c
            ...
            function y(e, t) {
                for (var a = 0; a < t.length; a++) for (var n = 0; n < t[a].length; n++) if (t[a][n] == e) return { row: a, col: n };
            }
            function w(e, t, a) {
                for (var n = e + 1, r = t + 1; n < a.length;) {
                    if (a[n][t] != a[e][t]) {
                        n--;
                        break;
                    }
                ...
                return r == a[e].length && r--, { row: n, col: r };
            }
            function A() {
                C.el.querySelector(".fr-cell-fixed") && C.el.querySelector(".fr-cell-fixed").classList.remove("fr-cell-fixed"),
                    C.el.querySelector(".fr-cell-handler") && C.el.querySelector(".fr-cell-handler").classList.remove("fr-cell-handler");
            }
            function T() {
            ...
            function O(e) {
                ...
                if (0 < t.length) {
                    ...
                    for (a = 0; a < t.length; a++) {
                        var s = y(t[a], e),
                            l = w(s.row, s.col, e);
                        (n = Math.min(s.row, n)), (r = Math.max(l.row, r)), (i = Math.min(s.col, i)), (o = Math.max(l.col, o));
                    }
                    return { min_i: n, max_i: r, min_j: i, max_j: o };
                }
                return null;
            }
            function x(e) {
                var t = O(e);
                if (null != t) {
                    var a = L(e[t.min_i][t.min_j]),
                        n = L(e[t.min_i][t.max_j]),
                        r = L(e[t.max_i][t.min_j]);
                    return { left: a.length && a.offset().left, right: n.length && n.offset().left + n.outerWidth(), top: a.length && a.offset().top, bottom: r.length && r.offset().top + r.outerHeight() };
                }
            }
            function F(e, t) {
                if (L(e).is(t)) T(), L(e).addClass("fr-selected-cell");
                else {
                    I(), C.edit.off();
                    var a = _(),
                        n = y(e, a),
                        r = y(t, a),
                        i = (function u(e, t, a, n, r) {
                            var i,
                                o,
                                s,
                                l,
                                ...
                                p = n;
                            for (i = c; i <= d; i++)
                                (1 < (parseInt(L(r[i][f]).attr("rowspan"), 10) || 1) || 1 < (parseInt(L(r[i][f]).attr("colspan"), 10) || 1)) &&
                                    ((l = w((s = y(r[i][f], r)).row, s.col, r)), (c = Math.min(s.row, c)), (d = Math.max(l.row, d)), (f = Math.min(s.col, f)), (p = Math.max(l.col, p))),
                                    (1 < (parseInt(L(r[i][p]).attr("rowspan"), 10) || 1) || 1 < (parseInt(L(r[i][p]).attr("colspan"), 10) || 1)) &&
                                    ((l = w((s = y(r[i][p], r)).row, s.col, r)), (c = Math.min(s.row, c)), (d = Math.max(l.row, d)), (f = Math.min(s.col, f)), (p = Math.max(l.col, p)));
                            for (o = f; o <= p; o++)
                                (1 < (parseInt(L(r[c][o]).attr("rowspan"), 10) || 1) || 1 < (parseInt(L(r[c][o]).attr("colspan"), 10) || 1)) &&
                                    ((l = w((s = y(r[c][o], r)).row, s.col, r)), (c = Math.min(s.row, c)), (d = Math.max(l.row, d)), (f = Math.min(s.col, f)), (p = Math.max(l.col, p))),
                                    (1 < (parseInt(L(r[d][o]).attr("rowspan"), 10) || 1) || 1 < (parseInt(L(r[d][o]).attr("colspan"), 10) || 1)) &&
                                    ((l = w((s = y(r[d][o], r)).row, s.col, r)), (c = Math.min(s.row, c)), (d = Math.max(l.row, d)), (f = Math.min(s.col, f)), (p = Math.max(l.col, p)));
                            return c == e && d == t && f == a && p == n ? { min_i: e, max_i: t, min_j: a, max_j: n } : u(c, d, f, p, r);
                        })(Math.min(n.row, r.row), Math.max(n.row, r.row), Math.min(n.col, r.col), Math.max(n.col, r.col), a);
                    T(), e.classList.add("fr-cell-fixed"), t.classList.add("fr-cell-handler");
                    for (var o = i.min_i; o <= i.max_i; o++) for (var s = i.min_j; s <= i.max_j; s++) L(a[o][s]).addClass("fr-selected-cell");
                }
            }
            function k(e) {
                var t = null,
                ...
                return (
                    "TD" == e.target.tagName || "TH" == e.target.tagName
                        ? (t = e.target)
                        : 0 < a.closest("th", a.closest("thead")[0]).length
                            ? (t = a.closest("th", a.closest("thead")[0]).get(0))
                            : 0 < a.closest("td", a.closest("tr")[0]).length && (t = a.closest("td", a.closest("tr")[0]).get(0)),
                    -1 === C.$el.html.toString().search(t) ? null : t
                );
            }
            function N() {
                T(), C.popups.hide("table.edit");
            }
            function e(e) {
                var t = k(e);
                if ("false" == L(t).parents("[contenteditable]").not(".fr-element").not(".fr-img-caption").not("body").first().attr("contenteditable")) return !0;
                if ((0 < J().length && !t && N(), !C.edit.isDisabled() || C.popups.isVisible("table.edit")))
                    if (1 != e.which || (1 == e.which && C.helpers.isMac() && e.ctrlKey)) (3 == e.which || (1 == e.which && C.helpers.isMac() && e.ctrlKey)) && t && N();
                    else if (((i = !0), t)) {
                        0 < J().length && !e.shiftKey && N(), e.stopPropagation(), C.events.trigger("image.hideResizer"), C.events.trigger("video.hideResizer"), (r = !0);
                        var a = t.tagName.toLowerCase();
                        e.shiftKey && 0 < C.$el.find("".concat(a, ".fr-selected-cell")).length
                            ? L(C.$el.find("".concat(a, ".fr-selected-cell")).closest("table")).is(L(t).closest("table"))
                                ? F(n, t)
                                : I()
                            : ((C.keys.ctrlKey(e) || e.shiftKey) && (1 < J().length || (0 === L(t).find(C.selection.element()).length && !L(t).is(C.selection.element()))) && I(), (n = t), 0 < C.opts.tableEditButtons.length && F(n, n));
                    }
            }
            function a(e) {
                if (!C.edit.isDisabled() && C.popups.areVisible()) return !0;
                if ((r || C.$tb.is(e.target) || C.$tb.is(L(e.target).closest(".fr-toolbar")) || (0 < J().length && C.toolbar.enable(), T()), !(1 != e.which || (1 == e.which && C.helpers.isMac() && e.ctrlKey)))) {
                    if (((i = !1), r)) (r = !1), k(e) || 1 != J().length ? 0 < J().length && (C.selection.isCollapsed() ? u() : (T(), C.edit.on())) : T();
                    if (S) {
                        (S = !1), R.removeClass("fr-moving"), C.$el.removeClass("fr-no-selection"), C.edit.on();
                        var t = parseFloat(R.css("left")) + C.opts.tableResizerOffset + C.$wp.offset().left;
                        C.opts.iframe && (t -= C.$iframe.offset().left),
                            R.data("release-position", t),
                            R.removeData("max-left"),
                            R.removeData("max-right"),
                            (function A() {
                                var e = R.data("origin"),
                                ...
                                if (e !== t) {
                                    var a = R.data("first"),
                                        ...
                                        r = R.data("table"),
                                        i = r.outerWidth();
                                    if ((C.undo.canDo() || C.undo.saveStep(), null != a && null != n)) {
                                        var o,
                                            s,
                                            l,
                                            c = _(r),
                                            ...
                                            p = [],
                                            u = [];
                                        for (o = 0; o < c.length; o++) (s = L(c[o][a])), (l = L(c[o][n])), (d[o] = s.outerWidth()), (p[o] = l.outerWidth()), (f[o] = (d[o] / i) * 100), (u[o] = (p[o] / i) * 100);
                                        for (o = 0; o < c.length; o++)
                                            if (((s = L(c[o][a])), (l = L(c[o][n])), c[o][a] != c[o][n])) {
                                                var h = ((f[o] * (d[o] + t - e)) / d[o]).toFixed(4);
                                        ...
                                        ("rtl" == C.opts.direction && 0 === n) || ("rtl" != C.opts.direction && 0 !== n)
                                            ? ((g = ((i + t - e) / i) * v), r.css("margin-right", "calc(100% - ".concat(Math.round(g).toFixed(4), "% - ").concat(Math.round(b).toFixed(4), "%)")))
                                            : (("rtl" == C.opts.direction && 0 !== n) || ("rtl" != C.opts.direction && 0 === n)) &&
                                            ((g = ((i - t + e) / i) * v), r.css("margin-left", "calc(100% - ".concat(Math.round(g).toFixed(4), "% - ").concat(Math.round(E).toFixed(4), "%)"))),
                                            r.css("width", "".concat(Math.round(g).toFixed(4), "%"));
                                    }
            ...
            function D(e) {
                if ((C.events.$on(L("input"), "click", ee), !0 === r && 0 < C.opts.tableEditButtons.length)) {
                    if (L(e.currentTarget).closest("table").is(Z())) {
                        if ("TD" == e.currentTarget.tagName && 0 === C.$el.find("th.fr-selected-cell").length) return void F(n, e.currentTarget);
                        if ("TH" == e.currentTarget.tagName && 0 === C.$el.find("td.fr-selected-cell").length) return void F(n, e.currentTarget);
                    }
                    I();
                }
            }
            function M(e, t, a, n) {
                for (var r, i = t; i != C.el && "TD" != i.tagName && "TH" != i.tagName && ("up" == n ? (r = i.previousElementSibling) : "down" == n && (r = i.nextElementSibling), !r);) i = i.parentNode;
                "TD" == i.tagName || "TH" == i.tagName
                    ? (function o(e, t) {
                        for (var a = e; a && "TABLE" != a.tagName && a.parentNode != C.el;) a = a.parentNode;
                        if (a && "TABLE" == a.tagName) {
                            var n = _(L(a));
                            "up" == t ? B(y(e, n), a, n) : "down" == t && P(y(e, n), a, n);
                        }
                    })(i, n)
                    : r && ("up" == n && C.selection.setAtEnd(r), "down" == n && C.selection.setAtStart(r));
            }
            function B(e, t, a) {
                0 < e.row ? C.selection.setAtEnd(a[e.row - 1][e.col]) : M(0, t, 0, "up");
            }
            function P(e, t, a) {
                var n = parseInt(a[e.row][e.col].getAttribute("rowspan"), 10) || 1;
                e.row < a.length - n ? C.selection.setAtStart(a[e.row + n][e.col]) : M(0, t, 0, "down");
            }
            function U() {
            ...
            function K(e, t) {
                var a = L(t),
                    n = a.closest("table"),
                    r = n.parent();
                if ((t && "TD" != t.tagName && "TH" != t.tagName && (0 < a.closest("td").length ? (t = a.closest("td")) : 0 < a.closest("th").length && (t = a.closest("th"))), !t || ("TD" != t.tagName && "TH" != t.tagName)))
                    R && a.get(0) != R.get(0) && a.parent().get(0) != R.get(0) && C.core.sameInstance(R) && U();
                else {
                    if (((a = L(t)), 0 === C.$el.find(a).length)) return !1;
                    var i = a.offset().left - 1,
                        o = i + a.outerWidth();
                    if (Math.abs(e.pageX - i) <= C.opts.tableResizerOffset || Math.abs(o - e.pageX) <= C.opts.tableResizerOffset) {
                        var s,
                            l,
                            c,
                            d,
                        ...
                        "rtl" != C.opts.direction
                            ? e.pageX - i <= C.opts.tableResizerOffset
                                ? ((c = i),
                                    0 < u.col
                                        ? ((d = i - V(u.col - 1, p) + C.opts.tableResizingLimit), (f = i + V(u.col, p) - C.opts.tableResizingLimit), (s = u.col - 1), (l = u.col))
                                        : ((s = null), (l = 0), (d = n.offset().left - 1 - parseInt(n.css("margin-left"), 10)), (f = n.offset().left - 1 + n.width() - p[0].length * C.opts.tableResizingLimit)))
                                : o - e.pageX <= C.opts.tableResizerOffset &&
                                ((c = o),
                                    h.col < p[h.row].length && p[h.row][h.col + 1]
                                        ? ((d = o - V(h.col, p) + C.opts.tableResizingLimit), (f = o + V(h.col + 1, p) - C.opts.tableResizingLimit), (s = h.col), (l = h.col + 1))
                                        : ((s = h.col), (l = null), (d = n.offset().left - 1 + p[0].length * C.opts.tableResizingLimit), (f = r.offset().left - 1 + r.width() + parseFloat(r.css("padding-left")))))
                            : o - e.pageX <= C.opts.tableResizerOffset
                                ? ((c = o),
                                    0 < u.col
                                        ? ((d = o - V(u.col, p) + C.opts.tableResizingLimit), (f = o + V(u.col - 1, p) - C.opts.tableResizingLimit), (s = u.col), (l = u.col - 1))
                                        : ((s = null), (l = 0), (d = n.offset().left + p[0].length * C.opts.tableResizingLimit), (f = r.offset().left - 1 + r.width() + parseFloat(r.css("padding-left")))))
                                : e.pageX - i <= C.opts.tableResizerOffset &&
                                ((c = i),
                                    h.col < p[h.row].length && p[h.row][h.col + 1]
                                        ? ((d = i - V(h.col + 1, p) + C.opts.tableResizingLimit), (f = i + V(h.col, p) - C.opts.tableResizingLimit), (s = h.col + 1), (l = h.col))
                                        : ((s = h.col), (l = null), (d = r.offset().left + parseFloat(r.css("padding-left"))), (f = n.offset().left - 1 + n.width() - p[0].length * C.opts.tableResizingLimit))),
                            R ||
                            (function T() {
                                C.shared.$table_resizer || (C.shared.$table_resizer = L(document.createElement("div")).attr("class", "fr-table-resizer").html("<div></div>")),
                                    (R = C.shared.$table_resizer),
                                    C.events.$on(R, "mousedown", function (e) {
                                        return !C.core.sameInstance(R) || (0 < J().length && N(), 1 == e.which ? (C.selection.save(), (S = !0), R.addClass("fr-moving"), I(), C.edit.off(), R.find("div").css("opacity", 1), !1) : void 0);
                                    }),
                                    C.events.$on(R, "mousemove", function (e) {
                                        if (!C.core.sameInstance(R)) return !0;
                                        S && (C.opts.iframe && (e.pageX -= C.$iframe.offset().left), j(e));
                                    }),
                                    C.events.on(
                                        "shared.destroy",
                                        function () {
                                    ...
                                    C.events.on(
                                        "destroy",
                                        function () {
                                            C.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"), L("body").first().append(R.hide());
                                        },
                                        !0
                                    );
                            })(),
                        ...
                        if (C.opts.iframe) {
                            var E = C.helpers.getPX(C.$wp.find(".fr-iframe").css("padding-top")),
                                A = C.helpers.getPX(C.$wp.find(".fr-iframe").css("padding-left"));
                            (v += C.$iframe.offset().left + A), (b += C.$iframe.offset().top + E), (d += C.$iframe.offset().left), (f += C.$iframe.offset().left);
                        }
                        R.data("max-left", d),
                            R.data("max-right", f),
                            R.data("origin", c - C.win.pageXOffset),
                            R.css("top", b),
                            R.css("left", v),
                            R.css("height", m),
                            R.find("div").css("height", m),
                            R.css("padding-left", C.opts.tableResizerOffset),
                            R.css("padding-right", C.opts.tableResizerOffset),
                            R.show();
                    } else C.core.sameInstance(R) && U();
                }
            }
            function H(e, t) {
                ...
                if (C.opts.iframe) {
                    ...
                    (i += C.$iframe.offset().left - C.helpers.scrollLeft() + l), (o += C.$iframe.offset().top - C.helpers.scrollTop() + s);
                }
                n.find("th, td").each(function () {
                    var e = L(this);
                    return e.offset().left <= r && r < e.offset().left + e.outerWidth() / 2
                        ? ((a = parseInt(c.find("a").css("width"), 10)),
                            c.css("top", o + e.offset().top - C.$box.offset().top - a - 5),
                            c.css("left", i + e.offset().left - C.$box.offset().left - a / 2),
                            c.data("selected-cell", e),
                            c.data("position", "before"),
                            c.addClass("fr-visible"),
                            !1)
                        : e.offset().left + e.outerWidth() / 2 <= r && r < e.offset().left + e.outerWidth()
                            ? ((a = parseInt(c.find("a").css("width"), 10)),
                                c.css("top", o + e.offset().top - C.$box.offset().top - a - 5),
                                c.css("left", i + e.offset().left - C.$box.offset().left + e.outerWidth() - a / 2),
                                c.data("selected-cell", e),
            ...
            function $(e, t) {
                ...
                n.find("tr").each(function () {
                    var e = L(this);
                    return e.offset().top <= r && r < e.offset().top + e.outerHeight() / 2
                        ? ((a = parseInt(c.find("a").css("width"), 10)),
                            c.css("top", o + e.offset().top - C.$box.offset().top - a / 2),
                            c.css("left", i + e.offset().left - C.$box.offset().left - a - 5),
                            c.data("selected-cell", e.find("td").first()),
                            c.data("position", "above"),
                            c.addClass("fr-visible"),
                            !1)
                        : e.offset().top + e.outerHeight() / 2 <= r && r < e.offset().top + e.outerHeight()
                            ? ((a = parseInt(c.find("a").css("width"), 10)),
                                c.css("top", o + e.offset().top - C.$box.offset().top + e.outerHeight() - a / 2),
                                c.css("left", i + e.offset().left - C.$box.offset().left - a - 5),
                                c.data("selected-cell", e.find("td").first()),
            ...
            function G(e) {
                ...
                C.opts.tableResizer && (!C.popups.areVisible() || (C.popups.areVisible() && C.popups.isVisible("table.edit"))) && K(e, t),
                    ...
                    (function i(e, t) {
                        if (0 === J().length) {
                            ...
                            if (t && ("HTML" == t.tagName || "BODY" == t.tagName || C.node.isElement(t)))
                                for (a = 1; a <= C.opts.tableInsertHelperOffset; a++) {
                                    if (((n = C.doc.elementFromPoint(e.pageX - C.win.pageXOffset, e.pageY - C.win.pageYOffset + a)), L(n).hasClass("fr-tooltip"))) return !0;
                                    if (n && ("TH" == n.tagName || "TD" == n.tagName || "TABLE" == n.tagName) && (L(n).parents(".fr-wrapper").length || C.opts.iframe) && "false" != L(n).closest("table").attr("contenteditable"))
                                        return H(e, L(n).closest("table")), !0;
                                    if (((r = C.doc.elementFromPoint(e.pageX - C.win.pageXOffset + a, e.pageY - C.win.pageYOffset)), L(r).hasClass("fr-tooltip"))) return !0;
                                    if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (L(r).parents(".fr-wrapper").length || C.opts.iframe) && "false" != L(r).closest("table").attr("contenteditable"))
                                        return $(e, L(r).closest("table")), !0;
                                }
                            C.core.sameInstance(c) && W();
                        }
                    })(e, t);
            }
            function Y() {
                if (S) {
                    var e = R.data("table").offset().top - C.win.pageYOffset;
                    if (C.opts.iframe) {
            ...
            function V(e, t) {
                var a,
                    n = L(t[0][e]).outerWidth();
                for (a = 1; a < t.length; a++) n = Math.min(n, L(t[a][e]).outerWidth());
                return n;
            }
            function z(e, t, a) {
                var n,
                    r = 0;
                for (n = e; n <= t; n++) r += V(n, a);
                return r;
            }
            function j(e) {
                if ((1 < J().length && i && I(), !1 === i && !1 === r && !1 === S)) o && clearTimeout(o), (C.edit.isDisabled() && !C.popups.isVisible("table.edit")) || (o = setTimeout(G, 30, e));
                else if (S) {
                    ...
                    var a = R.data("max-left"),
                        n = R.data("max-right");
                    a <= t && t <= n
                        ? R.css("left", t - C.opts.tableResizerOffset - C.$wp.offset().left)
                        : t < a && parseFloat(R.css("left"), 10) > a - C.opts.tableResizerOffset
                            ? R.css("left", a - C.opts.tableResizerOffset - C.$wp.offset().left)
                            : n < t && parseFloat(R.css("left"), 10) < n - C.opts.tableResizerOffset && R.css("left", n - C.opts.tableResizerOffset - C.$wp.offset().left);
                } else i && W();
            }
            function q(e) {
                C.node.isEmpty(e.get(0)) ? e.prepend(Be.MARKERS) : e.prepend(Be.START_MARKER).append(Be.END_MARKER);
            }
            function X() {
                C.shared.$ti_helper ||
                    ((C.shared.$ti_helper = L(document.createElement("div"))
                        ...
                        C.events.bindClick(C.shared.$ti_helper, "a", function () {
                            var e = c.data("selected-cell"),
                                ...
                                a = c.data("instance") || C;
                            "before" == t
                                ? (C.undo.saveStep(), e.addClass("fr-selected-cell"), a.table.insertColumn(t), e.removeClass("fr-selected-cell"), C.undo.saveStep())
                                : "after" == t
                                    ? (C.undo.saveStep(), e.addClass("fr-selected-cell"), a.table.insertColumn(t), e.removeClass("fr-selected-cell"), C.undo.saveStep())
                                    : "above" == t
                                        ? (C.undo.saveStep(), e.addClass("fr-selected-cell"), a.table.insertRow(t), e.removeClass("fr-selected-cell"), C.undo.saveStep())
                                        : "below" == t && (C.undo.saveStep(), e.addClass("fr-selected-cell"), a.table.insertRow(t), e.removeClass("fr-selected-cell"), C.undo.saveStep()),
                                W();
                        }),
                        C.events.on(
                            "shared.destroy",
            ...
            function Z() {
                ...
                if (e.length) {
                    ...
                    return t && "TABLE" == t.tagName ? L(t) : L([]);
                }
                return L([]);
            }
            function ee(e) {
            ...
            return {
                    ...
                    if (!C.helpers.isMobile()) {
                        (S = r = i = !1),
                            ...
                            C.events.on("commands.mousedown", function (e) {
                                0 < e.parents(".fr-toolbar").length && T();
                            }),
                            C.events.$on(C.$el, "mouseover", "th, td", D),
                            C.events.$on(C.$win, "mouseup", a),
                            C.opts.iframe && C.events.$on(L(C.o_win), "mouseup", a),
                            C.events.$on(C.$win, "mousemove", j),
                            C.events.$on(L(C.o_win), "scroll", Y),
                            C.events.on("contentChanged", function () {
                                0 < J().length &&
                                    (u(),
                                        C.$el.find("img").on("load.selected-cells", function () {
                                            L(this).off("load.selected-cells"), 0 < J().length && u();
                                        }));
                            }),
                            C.events.$on(L(C.o_win), "resize", function () {
                                T();
                            }),
                            C.events.on(
                                "toolbar.esc",
                                function () {
                                    if (0 < J().length) return C.events.disableBlur(), C.events.focus(), !1;
                                },
                                !0
                            ),
                            C.events.$on(L(C.o_win), "keydown", function () {
                                i && r && ((r = i = !1), C.$el.removeClass("fr-no-selection"), C.edit.on(), C.selection.setAtEnd(C.$el.find(".fr-selected-cell").last().get(0)), C.selection.restore(), T());
                            }),
                                ...
                                e.shiftKey
                                    ...
                                    (function o(e) {
                                        ...
                                        if (null != t && 0 < t.length) {
                                            var a,
                                                n = _(),
                                                r = e.which,
                                                i = y(1 == t.length ? (a = t[0]) : ((a = C.el.querySelector(".fr-cell-fixed")), C.el.querySelector(".fr-cell-handler")), n);
                                            if (Be.KEYCODE.ARROW_RIGHT == r) {
                                                if (i.col < n[0].length - 1) return F(a, n[i.row][i.col + 1]), !1;
                                            } else if (Be.KEYCODE.ARROW_DOWN == r) {
                                                if (i.row < n.length - 1) return F(a, n[i.row + 1][i.col]), !1;
                                            } else if (Be.KEYCODE.ARROW_LEFT == r) {
                                                if (0 < i.col) return F(a, n[i.row][i.col - 1]), !1;
                                            } else if (Be.KEYCODE.ARROW_UP == r && 0 < i.row) return F(a, n[i.row - 1][i.col]), !1;
                                        }
                                    })(e) &&
                                    setTimeout(function () {
                                        u();
                                    ...
                                    : (function s(e) {
                                        ...
                                        if (a.length && ("TD" == (a = a[0]).tagName || "TH" == a.tagName)) {
                                            for (var n = a; n && "TABLE" != n.tagName && n.parentNode != C.el;) n = n.parentNode;
                                            if (
                                                n &&
                                                "TABLE" == n.tagName &&
                                                (Be.KEYCODE.ARROW_LEFT == t || Be.KEYCODE.ARROW_UP == t || Be.KEYCODE.ARROW_RIGHT == t || Be.KEYCODE.ARROW_DOWN == t) &&
                                                (0 < J().length && N(), C.browser.webkit && (Be.KEYCODE.ARROW_UP == t || Be.KEYCODE.ARROW_DOWN == t))
                                            ) {
                                                var r = C.selection.ranges(0).startContainer;
                                                if (
                                                    r.nodeType == Node.TEXT_NODE &&
                                                    ((Be.KEYCODE.ARROW_UP == t &&
                                                        ((r.previousSibling && "BR" !== r.previousSibling.tagName) || (r.previousSibling && "BR" === r.previousSibling.tagName && r.previousSibling.previousSibling))) ||
                                                        (Be.KEYCODE.ARROW_DOWN == t && ((r.nextSibling && "BR" !== r.nextSibling.tagName) || (r.nextSibling && "BR" === r.nextSibling.tagName && r.nextSibling.nextSibling))))
                                                )
                                                    return;
                                                e.preventDefault(), e.stopPropagation();
                                                var i = _(L(n)),
                                                    o = y(a, i);
                                                return Be.KEYCODE.ARROW_UP == t ? B(o, n, i) : Be.KEYCODE.ARROW_DOWN == t && P(o, n, i), C.selection.restore(), !1;
                                            }
                                        }
                                    })(e);
                            }),
                                ...
                                function (e) {
                                    if (
                                        ...
                                        (function n(e) {
                                            if (e.which == Be.KEYCODE.TAB) {
                                                var t;
                                                if (0 < J().length) t = C.$el.find(".fr-selected-cell").last();
                                                else {
                                                    var a = C.selection.element();
                                                    "TD" == a.tagName || "TH" == a.tagName
                                                        ? (t = L(a))
                                                        : a != C.el && (0 < L(a).parentsUntil(C.$el, "td").length ? (t = L(a).parents("td").first()) : 0 < L(a).parentsUntil(C.$el, "th").length && (t = L(a).parents("th").first()));
                                                }
                                                if (t)
                                                    return (
                                                        e.preventDefault(),
                                                        !!(
                                                            0 === C.selection.get().focusOffset &&
                                                            0 < L(C.selection.element()).parentsUntil(C.$el, "ol, ul").length &&
                                                            (0 < L(C.selection.element()).closest("li").prev().length || (L(C.selection.element()).is("li") && 0 < L(C.selection.element()).prev().length))
                                                        ) ||
                                                        (N(),
                                                            e.shiftKey
                                                                ? 0 < t.prev().length
                                                                    ...
                                                                    : 0 < t.closest("tr").length && 0 < t.closest("tr").prev().length
                                                                        ? q(t.closest("tr").prev().find("td").last())
                                                                        : 0 < t.closest("tbody").length && 0 < t.closest("table").find("thead tr").length && q(t.closest("table").find("thead tr th").last())
                                                                : 0 < t.next().length
                                                                    ? q(t.next())
                                                                    : 0 < t.closest("tr").length && 0 < t.closest("tr").next().length
                                                                        ? q(t.closest("tr").next().find("td").first())
                                                                        : 0 < t.closest("thead").length && 0 < t.closest("table").find("tbody tr").length
                                                                            ? q(t.closest("table").find("tbody tr td").first())
                                                                            : (t.addClass("fr-selected-cell"), g("below"), T(), q(t.closest("tr").next().find("td").first())),
                                                            C.selection.restore(),
                                                            !1)
                                                    );
                                            }
                                    ...
                                    var t = J();
                                    if (0 < t.length) {
                                        if (0 < t.length && C.keys.ctrlKey(e) && e.which == Be.KEYCODE.A) return T(), C.popups.isVisible("table.edit") && C.popups.hide("table.edit"), (t = []), !0;
                                        if (e.which == Be.KEYCODE.ESC && C.popups.isVisible("table.edit")) return T(), C.popups.hide("table.edit"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), !(t = []);
                                        if (1 < t.length && (e.which == Be.KEYCODE.BACKSPACE || e.which == Be.KEYCODE.DELETE)) {
                                            C.undo.saveStep();
                                            for (var a = 0; a < t.length; a++) L(t[a]).html("<br>"), a == t.length - 1 && L(t[a]).prepend(Be.MARKERS);
                                            return C.selection.restore(), C.undo.saveStep(), !(t = []);
                                        }
                                        if (1 < t.length && e.which != Be.KEYCODE.F10 && !C.keys.isBrowserAction(e)) return e.preventDefault(), !(t = []);
                                    } else if (
                                        !(t = []) ===
                                        (function r(e) {
                                            if (e.altKey && e.which == Be.KEYCODE.SPACE) {
                                                var t,
                                                    a = C.selection.element();
                                                if (("TD" == a.tagName || "TH" == a.tagName ? (t = a) : 0 < L(a).closest("td").length ? (t = L(a).closest("td").get(0)) : 0 < L(a).closest("th").length && (t = L(a).closest("th").get(0)), t))
                                                    return e.preventDefault(), F(t, t), u(), !1;
                                            }
                                        })(e)
                                    )
                                        return !1;
                ...
                insert: function ae(e, t) {
                    var a,
                        ...
                        i = 100 / t;
                    for (a = 0; a < e; a++) {
                        for (r += "<tr>", n = 0; n < t; n++) (r += "<td" + (C.opts.tableDefaultWidth ? ' style="width: ' + i.toFixed(4) + '%;"' : "") + ">"), 0 === a && 0 === n && (r += Be.MARKERS), (r += "<br></td>");
                        r += "</tr>";
                    }
                    (r += "</tbody></table>"), C.html.insert(r), C.selection.restore();
                    var o = C.$el.find(".fr-inserted-table");
                    o.removeClass("fr-inserted-table"), C.events.trigger("table.inserted", [o.get(0)]);
                },
                remove: h,
                insertRow: g,
                deleteRow: function ne() {
                    ...
                    if (0 < e.length) {
                        var t,
                            ...
                            i = O(r);
                        if (null == i) return;
                        if (0 === i.min_i && i.max_i == r.length - 1) h();
                        else {
                            for (t = i.max_i; t >= i.min_i; t--) {
                                for (n = L(e.find("tr").not(e.find("> table tr")).get(t)), a = 0; a < r[t].length; a++)
                                    if (0 === a || r[t][a] != r[t][a - 1]) {
                                        ...
                                        if (t < r.length - 1 && r[t][a] == r[t + 1][a] && (0 === t || r[t][a] != r[t - 1][a])) {
                                            for (var l = r[t][a], c = a; 0 < c && r[t][c] == r[t][c - 1];) c--;
                                            0 === c
                                                ? L(
                                                    e
                                                        .find("tr")
                                                ...
                                                : L(r[t + 1][c - 1])[0].parentNode && L(r[t + 1][c - 1])[0].insertAdjacentElement("afterend", l);
                                        }
                                    }
                                var d = n.parent();
                                n.remove(), 0 === d.find("tr").length && d.remove(), (r = _(e));
                            }
                            E(0, r.length - 1, 0, r[0].length - 1, e), 0 < i.min_i ? C.selection.setAtEnd(r[i.min_i - 1][0]) : C.selection.setAtEnd(r[0][0]), C.selection.restore(), C.popups.hide("table.edit");
                        }
                    }
                },
                insertColumn: function re(l) {
                    ...
                    if (0 < e.length) {
                        ...
                        e.find("th, td").each(function () {
                            (a = L(this)).data("old-width", (a.outerWidth() / e.outerWidth()) * 100);
                        }),
                            e
                                .find("tr")
                                .not(e.find("> table tr"))
                                .each(function (e) {
                                    for (var t, a = L(this), n = 0, r = 0; n - 1 < c;) {
                                        if (!(t = a.find("> th, > td").get(r))) {
                                            t = null;
                                            break;
                                        }
                                        t == d[e][n] ? ((n += parseInt(L(t).attr("colspan"), 10) || 1), r++) : ((n += parseInt(L(d[e][n]).attr("colspan"), 10) || 1), "after" == l && (t = 0 === r ? -1 : a.find("> th, > td").get(r - 1)));
                                    }
                                    var i,
                                        o = L(t);
                                    if (("after" == l && c < n - 1) || ("before" == l && 0 < c && d[e][c] == d[e][c - 1])) {
                                    ...
                                    } else (i = 0 < a.find("th").length ? '<th style="width: '.concat(p.toFixed(4), '%;"><br></th>') : '<td style="width: '.concat(p.toFixed(4), '%;"><br></td>')), -1 == t ? a.prepend(i) : null == t ? a.append(i) : "before" == l ? o.before(i) : "after" == l && o[0].parentNode && o[0].insertAdjacentHTML("afterend", i);
                                }),
                            e.find("th, td").each(function () {
                                (a = L(this)).data("old-width") && (a.css("width", ((a.data("old-width") * p) / f).toFixed(4) + "%"), a.removeData("old-width"));
                            }),
                            C.popups.isVisible("table.edit") && u();
                    }
                },
                deleteColumn: function ie() {
                    var e = Z();
                    if (0 < e.length) {
                        var t,
                            a,
                            ...
                            i = O(r);
                        if (null == i) return;
                        if (0 === i.min_j && i.max_j == r[0].length - 1) h();
                        else {
                            var o = 0;
                            for (t = 0; t < r.length; t++)
                                for (a = 0; a < r[0].length; a++)
                                    (n = L(r[t][a])).hasClass("fr-selected-cell") || (n.data("old-width", (n.outerWidth() / e.outerWidth()) * 100), (a < i.min_j || a > i.max_j) && (o += (n.outerWidth() / e.outerWidth()) * 100));
                            for (o /= r.length, a = i.max_j; a >= i.min_j; a--)
                                for (t = 0; t < r.length; t++)
                                    if (0 === t || r[t][a] != r[t - 1][a])
                                        if (((n = L(r[t][a])), 1 < (parseInt(n.attr("colspan"), 10) || 1))) {
                                            var s = parseInt(n.attr("colspan"), 10) - 1;
                                            1 == s ? n.removeAttr("colspan") : n.attr("colspan", s), n.css("width", ((100 * (n.data("old-width") - V(a, r))) / o).toFixed(4) + "%"), n.removeData("old-width");
                                        } else {
                                            var l = L(n.parent().get(0));
                                            n.remove(),
                                                0 === l.find("> th, > td").length &&
                                                (0 === l.prev().length || 0 === l.next().length || l.prev().find("> th[rowspan], > td[rowspan]").length < l.prev().find("> th, > td").length) &&
                                                l.remove();
                                        }
                            E(0, r.length - 1, 0, r[0].length - 1, e),
                                0 < i.min_j ? C.selection.setAtEnd(r[i.min_i][i.min_j - 1]) : C.selection.setAtEnd(r[i.min_i][0]),
                                C.selection.restore(),
                                C.popups.hide("table.edit"),
                                e.find("th, td").each(function () {
                                    (n = L(this)).data("old-width") && (n.css("width", ((100 * n.data("old-width")) / o).toFixed(4) + "%"), n.removeData("old-width"));
                                });
                        }
                    }
                },
                mergeCells: function oe() {
                    if (1 < J().length && (0 === C.$el.find("th.fr-selected-cell").length || 0 === C.$el.find("td.fr-selected-cell").length)) {
                        A();
                        var e,
                            t,
                            a = O(_());
                        if (null == a) return;
                        var n = C.$el.find(".fr-selected-cell"),
                            r = L(n[0]),
                            i = r.parent().find(".fr-selected-cell"),
                            o = r.closest("table"),
                            s = r.html(),
                            l = 0;
                        for (e = 0; e < i.length; e++) l += L(i[e]).outerWidth();
                        for (
                            r.css("width", Math.min(100, (l / o.outerWidth()) * 100).toFixed(4) + "%"), a.min_j < a.max_j && r.attr("colspan", a.max_j - a.min_j + 1), a.min_i < a.max_i && r.attr("rowspan", a.max_i - a.min_i + 1), e = 1;
                            e < n.length;
                            e++
                        )
                            "<br>" != (t = L(n[e])).html() && "" !== t.html() && (s += "<br>".concat(t.html())), t.remove();
                        r.html(s), C.selection.setAtEnd(r.get(0)), C.selection.restore(), C.toolbar.enable(), v(a.min_i, a.max_i, o);
                        var c = o.find("tr:empty");
                        for (e = c.length - 1; 0 <= e; e--) L(c[e]).remove();
                        m(a.min_j, a.max_j, o), u();
                    }
                },
                splitCellVertically: function se() {
                    if (1 == J().length) {
                        ...
                        if (1 < t) {
                            var s = Math.ceil(t / 2);
                            n = (z(o.col, o.col + s - 1, i) / a) * 100;
                            var l = (z(o.col + s, o.col + t - 1, i) / a) * 100;
                            1 < s ? e.attr("colspan", s) : e.removeAttr("colspan"), 1 < t - s ? r.attr("colspan", t - s) : r.removeAttr("colspan"), e.css("width", n.toFixed(4) + "%"), r.css("width", l.toFixed(4) + "%");
                        } else {
                            var c;
                            for (c = 0; c < i.length; c++)
                                if (0 === c || i[c][o.col] != i[c - 1][o.col]) {
                                    var d = L(i[c][o.col]);
                                    if (!d.is(e)) {
                            ...
                            (n = ((n / a) * 100) / 2), e.css("width", "".concat(n.toFixed(4), "%")), r.css("width", "".concat(n.toFixed(4), "%"));
                        }
                        e[0].parentNode && e[0].insertAdjacentElement("afterend", r[0]), T(), C.popups.hide("table.edit");
                    }
                },
                splitCellHorizontally: function le() {
                    if (1 == J().length) {
                        ...
                        if (1 < n) {
                            var s = Math.ceil(n / 2);
                            1 < s ? e.attr("rowspan", s) : e.removeAttr("rowspan"), 1 < n - s ? o.attr("rowspan", n - s) : o.removeAttr("rowspan");
                            for (var l = i.row + s, c = 0 === i.col ? i.col : i.col - 1; 0 <= c && (r[l][c] == r[l][c - 1] || (0 < l && r[l][c] == r[l - 1][c]));) c--;
                            -1 == c ? L(a.find("tr").not(a.find("> table tr")).get(l)).prepend(o) : L(r[l][c])[0].parentNode && L(r[l][c])[0].insertAdjacentElement("afterend", o[0]);
                        } else {
                            var d,
                                f = L(document.createElement("tr")).append(o);
                            for (d = 0; d < r[0].length; d++)
                                if (0 === d || r[i.row][d] != r[i.row][d - 1]) {
                                    var p = L(r[i.row][d]);
                ...
                removeHeader: function de() {
                    ...
                    if (0 < t.length)
                        ...
                        else if ((t.remove(), 0 < J().length)) u();
                        else {
                            C.popups.hide("table.edit");
                            var a = e.find("tbody tr").first().find("td").first().get(0);
                            a && (C.selection.setAtEnd(a), C.selection.restore());
                        }
                },
                setBackground: t,
                showInsertPopup: function fe() {
                    ...
                    if ((t || (t = d()), !t.hasClass("fr-active"))) {
                        ...
                        var a = C.button.getPosition(e),
                            n = a.left,
                            r = a.top;
                        C.popups.show("table.insert", n, r, e.outerHeight());
                    }
                },
                showEditPopup: u,
                showColorsPopup: s,
                back: function pe() {
                    0 < J().length ? u() : (C.popups.hide("table.insert"), C.toolbar.showInline());
                },
                ...
                applyStyle: function ge(e, t, a, n) {
                    if (0 < t.length) {
                        if (!a) {
                            var r = Object.keys(n);
        ...
        Be.DefineIcon("insertTable", { NAME: "table", SVG_KEY: "insertTable" }),
        Be.RegisterCommand("insertTable", {
            title: "Insert Table",
            undo: !1,
            focus: !0,
            refreshOnCallback: !1,
        ...
        Be.RegisterCommand("tableInsert", {
            callback: function (e, t, a) {
                this.table.insert(t, a), this.popups.hide("table.insert");
            },
        }),
        Be.DefineIcon("tableHeader", { NAME: "header", FA5NAME: "heading", SVG_KEY: "tableHeader" }),
        Be.RegisterCommand("tableHeader", {
            title: "Table Header",
            focus: !1,
            toggle: !0,
            callback: function () {
        ...
        Be.DefineIcon("tableRows", { NAME: "bars", SVG_KEY: "row" }),
        Be.RegisterCommand("tableRows", {
            type: "dropdown",
            focus: !1,
            title: "Row",
            ...
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.tableRows.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e +=
        ...
        Be.DefineIcon("tableColumns", { NAME: "bars fa-rotate-90", SVG_KEY: "columns" }),
        Be.RegisterCommand("tableColumns", {
            type: "dropdown",
            focus: !1,
            title: "Column",
            ...
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.tableColumns.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="tableColumns" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
        ...
        Be.DefineIcon("tableCells", { NAME: "square-o", FA5NAME: "square", SVG_KEY: "cellOptions" }),
        Be.RegisterCommand("tableCells", {
            type: "dropdown",
            focus: !1,
            title: "Cell",
            ...
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.tableCells.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="tableCells" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
        ...
        Be.DefineIcon("tableRemove", { NAME: "trash", SVG_KEY: "removeTable" }),
        ...
        Be.DefineIcon("tableStyle", { NAME: "paint-brush", SVG_KEY: "tableStyle" }),
        Be.RegisterCommand("tableStyle", {
            title: "Table Style",
            type: "dropdown",
            focus: !1,
            html: function () {
                ...
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="tableStyle" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
            ...
            refreshOnShow: function (e, t) {
                var a = this.$,
                    n = this.$el.find(".fr-selected-cell").closest("table");
                n &&
                    t.find(".fr-command").each(function () {
                        var e = a(this).data("param1"),
                            t = n.hasClass(e);
        ...
        Be.DefineIcon("tableCellBackground", { NAME: "tint", SVG_KEY: "cellBackground" }),
        Be.RegisterCommand("tableCellBackground", {
        ...
        Be.RegisterCommand("tableCellBackgroundColor", {
            undo: !0,
            focus: !1,
            callback: function (e, t) {
        ...
        Be.DefineIcon("tableBack", { NAME: "arrow-left", SVG_KEY: "back" }),
        Be.RegisterCommand("tableBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        Be.DefineIcon("tableCellVerticalAlign", { NAME: "arrows-v", FA5NAME: "arrows-alt-v", SVG_KEY: "verticalAlignMiddle" }),
        Be.RegisterCommand("tableCellVerticalAlign", {
            type: "dropdown",
            focus: !1,
            ...
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.tableCellVerticalAlign.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="tableCellVerticalAlign" data-param1="'
                            .concat(a.toLowerCase(), '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(a), "</a></li>"));
                return (e += "</ul>");
            },
        ...
        Be.DefineIcon("tableCellHorizontalAlign", { NAME: "align-left", SVG_KEY: "alignLeft" }),
        Be.DefineIcon("align-left", { NAME: "align-left", SVG_KEY: "alignLeft" }),
        Be.DefineIcon("align-right", { NAME: "align-right", SVG_KEY: "alignRight" }),
        Be.DefineIcon("align-center", { NAME: "align-center", SVG_KEY: "alignCenter" }),
        Be.DefineIcon("align-justify", { NAME: "align-justify", SVG_KEY: "alignJustify" }),
        Be.RegisterCommand("tableCellHorizontalAlign", {
            type: "dropdown",
            focus: !1,
            ...
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.tableCellHorizontalAlign.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command fr-title" tabIndex="-1" role="option" data-cmd="tableCellHorizontalAlign" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.icon.create("align-".concat(a)), '<span class="fr-sr-only">')
                            .concat(this.language.translate(t[a]), "</span></a></li>"));
            ...
            refresh: function (e) {
                ...
                t.length &&
                    e
                        .find("> *")
                        .first()
                        .replaceWith(this.icon.create("align-".concat(this.helpers.getAlignment(a(t[0])))));
            },
            refreshOnShow: function (e, t) {
        ...
        Be.DefineIcon("tableCellStyle", { NAME: "magic", SVG_KEY: "cellStyle" }),
        Be.RegisterCommand("tableCellStyle", {
            title: "Cell Style",
            type: "dropdown",
            focus: !1,
            html: function () {
                ...
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="tableCellStyle" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.language.translate(t[a]), "</a></li>"));
                return (e += "</ul>");
            ...
            refreshOnShow: function (e, t) {
                var a = this.$,
                    n = this.$el.find(".fr-selected-cell").first();
                n &&
                    t.find(".fr-command").each(function () {
                        var e = a(this).data("param1"),
                            t = n.hasClass(e);
        ...
        Be.RegisterCommand("tableCellBackgroundCustomColor", {
            title: "OK",
            undo: !0,
            callback: function () {
        ...
        Be.DefineIcon("tableColorRemove", { NAME: "eraser", SVG_KEY: "remove" }),
        (Be.URLRegEx = "(^| |\\u00A0)(".concat(Be.LinkRegEx, "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$")),
        (Be.PLUGINS.url = function (i) {
            var o = i.$,
                s = null;
            function t(e, t, a) {
                for (var n = ""; a.length && "." == a[a.length - 1];) (n += "."), (a = a.substring(0, a.length - 1));
                var r = a;
                if (i.opts.linkConvertEmailAddress) i.helpers.isEmail(r) && !/^mailto:.*/i.test(r) && (r = "mailto:".concat(r));
                else if (i.helpers.isEmail(r)) return t + a;
                return (
                    /^((http|https|ftp|ftps|mailto|tel|sms|notes|data)\:)/i.test(r) || (r = "//".concat(r)),
                    (t || "") +
                    "<a"
                        .concat(i.opts.linkAlwaysBlank ? ' target="_blank"' : "")
                        .concat(s ? ' rel="'.concat(s, '"') : "", ' data-fr-linked="true" href="')
                        .concat(r, '">')
                        .concat(a.replace(/&amp;/g, "&").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "</a>")
                        .concat(n)
                );
            }
            var l = function l() {
                return new RegExp(Be.URLRegEx, "gi");
            };
            function c(e) {
                return (
                    i.opts.linkAlwaysNoFollow && (s = "nofollow"),
                    i.opts.linkAlwaysBlank && (i.opts.linkNoOpener && (s ? (s += " noopener") : (s = "noopener")), i.opts.linkNoReferrer && (s ? (s += " noreferrer") : (s = "noreferrer"))),
                    e.replace(l(), t)
                );
            }
            function d(e) {
            ...
            function a() {
                var e = i.selection.ranges(0),
                    t = e.startContainer;
                if (!t || t.nodeType !== Node.TEXT_NODE || e.startOffset !== (t.textContent || "").length) return !1;
                if (
                    (function r(e) {
                        return !!e && ("A" === e.tagName || (!(!e.parentNode || e.parentNode == i.el) && r(e.parentNode)));
                    })(t)
                )
                    return !1;
                if (l().test(d(t.textContent))) {
                    o(t).before(c(t.textContent));
                    var a = o(t.parentNode).find("a[data-fr-linked]");
                    a.removeAttr("data-fr-linked"), t.parentNode.removeChild(t), i.events.trigger("url.linked", [a.get(0)]);
                } else if (t.textContent.split(" ").length <= 2 && t.previousSibling && "A" === t.previousSibling.tagName) {
                    var n = t.previousSibling.innerText + t.textContent;
                    l().test(d(n)) && (o(t.previousSibling).replaceWith(c(n)), t.parentNode.removeChild(t));
                }
            }
            return {
                _init: function e() {
                    i.events.on(
                        "keypress",
                        function (e) {
                            !i.selection.isCollapsed() || ("." != e.key && ")" != e.key && "(" != e.key) || a();
                        },
                        !0
                    ),
                        i.events.on(
                            ...
                            function (e) {
                                var t = e.which;
                                !i.selection.isCollapsed() || (t != Be.KEYCODE.ENTER && t != Be.KEYCODE.SPACE) || a();
                            },
                            !0
                        ),
                        i.events.on("paste.beforeCleanup", function (e) {
                            if (i.helpers.isURL(e)) {
                                var t = null;
                                return (
                                    i.opts.linkAlwaysBlank && (i.opts.linkNoOpener && (t ? (t += " noopener") : (t = "noopener")), i.opts.linkNoReferrer && (t ? (t += " noreferrer") : (t = "noreferrer"))),
                                    "<a"
                                        .concat(i.opts.linkAlwaysBlank ? ' target="_blank"' : "")
                                        .concat(t ? ' rel="'.concat(t, '"') : "", ' href="')
                                        .concat(e, '" >')
                                        .concat(e, "</a>")
                                );
                            }
        ...
        Object.assign(Be.POPUP_TEMPLATES, { "video.insert": "[_BUTTONS_][_BY_URL_LAYER_][_EMBED_LAYER_][_UPLOAD_LAYER_][_PROGRESS_BAR_]", "video.edit": "[_BUTTONS_]", "video.size": "[_BUTTONS_][_SIZE_LAYER_]" }),
        Object.assign(Be.DEFAULTS, {
        ...
        (Be.PLUGINS.video = function (u) {
            ...
            function i() {
                ...
                if (
                        ...
                        (e = (function r() {
                            ...
                            if (0 < u.opts.videoEditButtons.length) {
                                u.opts.videoResponsive &&
                                    (-1 < u.opts.videoEditButtons.indexOf("videoSize") && u.opts.videoEditButtons.splice(u.opts.videoEditButtons.indexOf("videoSize"), 1),
                                        -1 < u.opts.videoEditButtons.indexOf("videoDisplay") && u.opts.videoEditButtons.splice(u.opts.videoEditButtons.indexOf("videoDisplay"), 1),
                                        -1 < u.opts.videoEditButtons.indexOf("videoAlign") && u.opts.videoEditButtons.splice(u.opts.videoEditButtons.indexOf("videoAlign"), 1));
                                var t = { buttons: (e += '<div class="fr-buttons"> \n      '.concat(u.button.buildList(u.opts.videoEditButtons), " \n      </div>")) },
                                    a = u.popups.create("video.edit", t);
                                return (
                                    u.events.$on(u.$wp, "scroll.video-edit", function () {
                                        p && u.popups.isVisible("video.edit") && (u.events.disableBlur(), y(p));
                                    }),
                                    a
                                );
                            }
                    ...
                    var t = p.find("iframe, embed, video"),
                        ...
                        n = t.offset().top + t.outerHeight();
                    u.popups.show("video.edit", a, n, t.outerHeight(), !0);
                }
            }
            function o(e) {
                ...
                var a = u.button.buildList(u.opts.videoInsertButtons);
                "" !== a && (t = '<div class="fr-buttons">' + a + "</div>");
                var n,
                    r = "",
                    i = u.opts.videoInsertButtons.indexOf("videoUpload"),
                    o = u.opts.videoInsertButtons.indexOf("videoByURL"),
                    s = u.opts.videoInsertButtons.indexOf("videoEmbed");
                0 <= o &&
                    ((n = " fr-active"),
                        ((i < o && 0 <= i) || (s < o && 0 <= s)) && (n = ""),
                        (r = '<div class="fr-video-by-url-layer fr-layer'
                            .concat(n, '" id="fr-video-by-url-layer-')
                            .concat(u.id, '"><div class="fr-input-line"><input id="fr-video-by-url-layer-text-')
                            .concat(u.id, '" type="text" placeholder="')
                            .concat(
                ...
                0 <= s &&
                    ((n = " fr-active"),
                        ((i < s && 0 <= i) || (o < s && 0 <= o)) && (n = ""),
                        (l = '<div class="fr-video-embed-layer fr-layer'
                            .concat(n, '" id="fr-video-embed-layer-')
                            .concat(u.id, '"><div class="fr-input-line"><textarea id="fr-video-embed-layer-text')
                            .concat(u.id, '" type="text" placeholder="')
                            .concat(
                ...
                0 <= i &&
                    ((n = " fr-active"),
                        ((s < i && 0 <= s) || (o < i && 0 <= o)) && (n = ""),
                        (c = '<div class="fr-video-upload-layer fr-layer'
                            .concat(n, '" id="fr-video-upload-layer-')
                            .concat(u.id, '"><strong>')
                            .concat(u.language.translate("Drop video"), "</strong><br>(")
                            .concat(u.language.translate("or click"), ')<div class="fr-form"><input type="file" accept="video/')
                            .concat(u.opts.videoAllowedTypes.join(", video/").toLowerCase(), '" tabIndex="-1" aria-labelledby="fr-video-upload-layer-')
                            .concat(u.id, '" role="button"></div></div>')));
                var d = {
                    buttons: t,
                    by_url_layer: r,
                    embed_layer: l,
                ...
                return (
                    (function p(n) {
                        u.events.$on(
                            ...
                            u.events.$on(
                                ...
                                function (e) {
                                    ...
                                    var t = e.originalEvent.dataTransfer;
                                    if (t && t.files) {
                                        var a = n.data("instance") || u;
                                        a.events.disableBlur(), a.video.upload(t.files), a.events.enableBlur();
                                    }
                                },
                                !0
                            ),
                        ...
                        u.events.$on(
                            ...
                            function () {
                                if (this.files) {
                                    var e = n.data("instance") || u;
                                    e.events.disableBlur(), n.find("input:focus").blur(), e.events.enableBlur(), e.video.upload(this.files);
                                }
                                h(this).val("");
                            },
                            !0
            ...
            function A(e) {
                ...
                var a = u.$el.find(".fr-jiv");
                a.removeClass("fr-jiv"),
                    a.toggleClass("fr-rv", u.opts.videoResponsive),
                    Q(a, u.opts.videoDefaultDisplay, u.opts.videoDefaultAlign),
                    a.toggleClass("fr-draggable", u.opts.videoMove),
                    u.events.trigger(t ? "video.replaced" : "video.inserted", [a]);
            }
            function T() {
                var e = h(this);
                u.popups.hide("video.insert"), e.removeClass("fr-uploading"), e.parent().next().is("br") && e.parent().next().remove(), y(e.parent()), u.events.trigger("video.loaded", [e.parent()]);
            }
            function C(s, e, c, d, f) {
                u.edit.off(), L("Loading video"), e && (s = u.helpers.sanitizeURL(s));
                var p = function p() {
                    var e, t;
                    if (d) {
                        u.undo.canDo() || d.find("video").hasClass("fr-uploading") || u.undo.saveStep();
                        var a = d.find("video").data("fr-old-src"),
                            n = d.data("fr-replaced");
                        d.data("fr-replaced", !1),
                            u.$wp ? ((e = d.clone(!0)).find("video").removeData("fr-old-src").removeClass("fr-uploading"), e.find("video").off("canplay"), a && d.find("video").attr("src", a), d.replaceWith(e)) : (e = d);
                        for (var r = e.find("video").get(0).attributes, i = 0; i < r.length; i++) {
                            var o = r[i];
                            0 === o.nodeName.indexOf("data-") && e.find("video").removeAttr(o.nodeName);
                        }
                        if (void 0 !== c) for (t in c) c.hasOwnProperty(t) && "link" != t && e.find("video").attr("data-".concat(t), c[t]);
                        e.find("video").on("canplay", T), e.find("video").attr("src", s), u.edit.on(), B(), u.undo.saveStep(), u.$el.blur(), u.events.trigger(n ? "video.replaced" : "video.inserted", [e, f]);
                    } else
                        (e = (function l(e, t, a) {
                            var n,
                                r = "";
                            if (t && void 0 !== t) for (n in t) t.hasOwnProperty(n) && "link" != n && (r += " data-".concat(n, '="').concat(t[n], '"'));
                            var i = u.opts.videoDefaultWidth;
                            i && "auto" != i && (i = "".concat(i, "px"));
                            var o = h(document.createElement("span"))
                                .attr("contenteditable", "false")
                                .attr("draggable", "true")
                                .attr("class", "fr-video fr-dv" + u.opts.videoDefaultDisplay[0] + ("center" != u.opts.videoDefaultAlign ? " fr-fv" + u.opts.videoDefaultAlign[0] : ""))
                                .html('<video src="' + e + '" ' + r + (i ? ' style="width: ' + i + ';" ' : "") + " controls>" + u.language.translate("Your browser does not support HTML5 video.") + "</video>");
                            o.toggleClass("fr-draggable", u.opts.videoMove), u.edit.on(), u.events.focus(!0), u.selection.restore(), u.undo.saveStep(), u.opts.videoSplitHTML ? u.markers.split() : u.markers.insert();
                            u.html.wrap();
                            var s = u.$el.find(".fr-marker");
                            u.node.isLastSibling(s) && s.parent().hasClass("fr-deletable") && s.insertAfter(s.parent());
                            s.replaceWith(o),
                                u.selection.clear(),
                                o.find("video").get(0).readyState > o.find("video").get(0).HAVE_FUTURE_DATA || u.helpers.isIOS() ? a.call(o.find("video").get(0)) : o.find("video").on("canplaythrough load", a);
                            return o;
                        })(s, c, T)),
                            B(),
                            u.undo.saveStep(),
            ...
            function R(e) {
                ...
                if ((t || (t = o()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-video-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), p)) {
                    var a = p.find("video");
                    u.popups.setContainer("video.insert", u.$sc);
                    var n = a.offset().left,
                        r = a.offset().top + a.height();
                    u.popups.show("video.insert", n, r, a.outerHeight());
                }
                void 0 === e && L(u.language.translate("Uploading"), 0);
            }
            function S(e) {
                var t = u.popups.get("video.insert");
                if (
                    t &&
                    (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-video-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || u.$el.find("video.fr-error").length)
                ) {
                    if ((u.events.focus(), u.$el.find("video.fr-error").length && (u.$el.find("video.fr-error").parent().remove(), u.undo.saveStep(), u.undo.run(), u.undo.dropRedo()), !u.$wp && p)) {
                        var a = p;
                        U(!0), u.selection.setAfter(a.find("video").get(0)), u.selection.restore();
                    }
            ...
            function L(e, t) {
                ...
                if (a) {
                    var n = a.find(".fr-video-progress-bar-layer");
                    n.find("h3").text(e + (t ? " ".concat(t, "%") : "")),
                        n.removeClass("fr-error"),
                        t ? (n.find("div").removeClass("fr-indeterminate"), n.find("div > span").css("width", "".concat(t, "%"))) : n.find("div").addClass("fr-indeterminate");
                }
            ...
            function _(e) {
                ...
                t.addClass("fr-error");
                var a = t.find("h3");
                a.text(e), u.events.disableBlur(), a.focus();
            }
            function y(e) {
                t.call(e.get(0));
            }
                    ...
                    if (u.opts.videoUploadToS3)
                            ...
                            var i = (function s(e) {
                                try {
                                    var t = h(e).find("Location").text(),
                                        a = h(e).find("Key").text();
                                    return !1 === u.events.trigger("video.uploadedToS3", [t, a, e], !0) ? (u.edit.on(), !1) : t;
                                } catch (n) {
                                    return G(v, e), !1;
                                }
                            })(n);
                        ...
                        var o = (function l(e) {
                            try {
                                ...
                                var t = JSON.parse(e);
                                return t.link ? t : (G(g, e), !1);
                            } catch (a) {
                                return G(v, e), !1;
                            }
                        })(r);
                        o && C(o.link, !1, o, e, a || r);
                    } else G(m, a || r);
                } catch (c) {
                    G(v, a || r);
                }
            ...
            function I() {
                G(v, this.response || this.responseText || this.responseXML);
            }
            function O(e) {
                if (e.lengthComputable) {
                    var t = ((e.loaded / e.total) * 100) | 0;
                    L(u.language.translate("Uploading"), t);
                }
            }
            function x() {
                u.edit.on(), S(!0);
            ...
            function F(e) {
                ...
                var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null),
                    a = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
                if (!t || !a) return !1;
                if ("mousedown" == e.type) {
                    var n = u.$oel.get(0).ownerDocument,
                        r = n.defaultView || n.parentWindow,
                        i = !1;
                    try {
                        i = r.location != r.parent.location && !(r.$ && r.$.FE);
                    } catch (o) { }
                    i && r.frameElement && ((t += u.helpers.getPX(h(r.frameElement).offset().left) + r.frameElement.clientLeft), (a = e.clientY + u.helpers.getPX(h(r.frameElement).offset().top) + r.frameElement.clientTop));
                }
                u.undo.canDo() || u.undo.saveStep(), (d = h(this)).data("start-x", t), d.data("start-y", a), s.show(), u.popups.hideAll(), K();
            }
            function k(e) {
                if (!u.core.sameInstance(f)) return !0;
                if (d) {
                    ...
                    var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null),
                        a = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
                    if (!t || !a) return !1;
                    var n = d.data("start-x"),
                        r = d.data("start-y");
                    d.data("start-x", t), d.data("start-y", a);
                    var i = t - n,
                        o = a - r,
                        s = p.find("iframe, embed, video"),
                        l = s.width(),
                        c = s.height();
                    (d.hasClass("fr-hnw") || d.hasClass("fr-hsw")) && (i = 0 - i),
                        (d.hasClass("fr-hnw") || d.hasClass("fr-hne")) && (o = 0 - o),
                        s.css("width", l + i),
                        s.css("height", c + o),
                        s.removeAttr("width"),
                        s.removeAttr("height"),
            ...
            function N(e) {
                if (!u.core.sameInstance(f)) return !0;
                d && p && (e && e.stopPropagation(), (d = null), s.hide(), P(), i(), u.undo.saveStep());
            }
            function D(e) {
                return '<div class="fr-handler fr-h'.concat(e, '"></div>');
            }
            function M(e, t, a, n) {
                return (e.pageX = t), (e.pageY = t), F.call(this, e), (e.pageX = e.pageX + a * Math.floor(Math.pow(1.1, n))), (e.pageY = e.pageY + a * Math.floor(Math.pow(1.1, n))), k.call(this, e), N.call(this, e), ++n;
            }
            function B() {
                var e,
                    t = Array.prototype.slice.call(u.el.querySelectorAll("video, .fr-video > *")),
                    a = [];
                for (e = 0; e < t.length; e++)
                    a.push(t[e].getAttribute("src")),
                ...
                if (n) for (e = 0; e < n.length; e++) a.indexOf(n[e].getAttribute("src")) < 0 && u.events.trigger("video.removed", [h(n[e])]);
                n = t;
            }
            function P() {
                f ||
                    (function o() {
                        ...
                        if (
                            (u.shared.$video_resizer
                                ...
                                : ((u.shared.$video_resizer = h(document.createElement("div")).attr("class", "fr-video-resizer")),
                                    (f = u.shared.$video_resizer),
                                    u.events.$on(
                                        f,
                                        "mousedown",
                                    ...
                                    u.opts.videoResize &&
                                    (f.append(D("nw") + D("ne") + D("sw") + D("se")),
                                        (u.shared.$vid_overlay = h(document.createElement("div")).attr("class", "fr-video-overlay")),
                                        (s = u.shared.$vid_overlay),
                                        (e = f.get(0).ownerDocument),
                                        h(e).find("body").first().append(s))),
                                u.events.on(
                                    "shared.destroy",
                                    function () {
                                ...
                                u.helpers.isMobile() ||
                                u.events.$on(h(u.o_win), "resize.video", function () {
                                    U(!0);
                                }),
                                u.opts.videoResize)
                        ) {
                            (e = f.get(0).ownerDocument),
                                u.events.$on(f, u._mousedown, ".fr-handler", F),
                                u.events.$on(h(e), u._mousemove, k),
                                u.events.$on(h(e.defaultView || e.parentWindow), u._mouseup, N),
                                u.events.$on(s, "mouseleave", N);
                            var n = 1,
                                r = null,
                                i = 0;
                            u.events.on("keydown", function (e) {
                                if (p) {
                                    var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                        a = e.which;
                                    (a !== r || 200 < e.timeStamp - i) && (n = 1),
                                        (a == Be.KEYCODE.EQUALS || (u.browser.mozilla && a == Be.KEYCODE.FF_EQUALS)) && t && !e.altKey
                                            ? (n = M.call(this, e, 1, 1, n))
                                            : (a == Be.KEYCODE.HYPHEN || (u.browser.mozilla && a == Be.KEYCODE.FF_HYPHEN)) && t && !e.altKey && (n = M.call(this, e, 2, -1, n)),
                                        (r = a),
                                        (i = e.timeStamp);
                                }
                            }),
                ...
                var e = p.find("iframe, embed, video"),
                    t = 0,
                    a = 0;
                u.opts.iframe && ((a = u.helpers.getPX(u.$wp.find(".fr-iframe").css("padding-top"))), (t = u.helpers.getPX(u.$wp.find(".fr-iframe").css("padding-left")))),
                    f
                        .css("top", (u.opts.iframe ? e.offset().top + a - 1 : e.offset().top - u.$wp.offset().top - 1) + u.$wp.scrollTop())
                        .css("left", (u.opts.iframe ? e.offset().left + t - 1 : e.offset().left - u.$wp.offset().left - 1) + u.$wp.scrollLeft())
            ...
            function t(e) {
                ...
                for (var t = 0; t < Be.INSTANCES.length; t++) Be.INSTANCES[t] != u && Be.INSTANCES[t].events.trigger("video.hideResizer");
                u.toolbar.disable(),
                    u.helpers.isMobile() && (u.events.disableBlur(), u.$el.blur(), u.events.enableBlur()),
            ...
            function U(e) {
                p &&
                    ((function t() {
                        ...
                        !0 === e) &&
                    (f.removeClass("fr-active"), u.toolbar.enable(), p.removeClass("fr-active"), (p = null), K());
            }
            function W() {
            ...
            function H(e) {
                ...
                if (t && t.files && t.files.length) {
                    ...
                    if (a && a.type && -1 !== a.type.indexOf("video")) {
                        ...
                        u.markers.remove(), u.markers.insertAtPoint(e.originalEvent), u.$el.find(".fr-marker").replaceWith(Be.MARKERS), u.popups.hideAll();
                        var n = u.popups.get("video.insert");
                        return (
                            n || (n = o()),
                            u.popups.setContainer("video.insert", u.$sc),
                            u.popups.show("video.insert", e.originalEvent.pageX, e.originalEvent.pageY),
                            R(),
                            0 <= u.opts.videoAllowedTypes.indexOf(a.type.replace(/video\//g, "")) ? $(t.files) : G(b),
                            e.preventDefault(),
                            e.stopPropagation(),
                            !1
                        );
            ...
            function $(e) {
                if (void 0 !== e && 0 < e.length) {
                    ...
                    var t,
                        a = e[0];
                    if ((null === u.opts.videoUploadURL || u.opts.videoUploadURL == l) && !u.opts.videoUploadToS3)
                        return (
                            (function s(n) {
                                ...
                                (r.onload = function () {
                                    r.result;
                                    for (var e = atob(r.result.split(",")[1]), t = [], a = 0; a < e.length; a++) t.push(e.charCodeAt(a));
                                    C(window.URL.createObjectURL(new Blob([new Uint8Array(t)], { type: n.type })), !1, null, p);
                                }),
                                    R(),
                                    r.readAsDataURL(n);
                            })(a),
                    ...
                    if (a.size > u.opts.videoMaxSize) return G(c), !1;
                    if (u.opts.videoAllowedTypes.indexOf(a.type.replace(/video\//g, "")) < 0) return G(b), !1;
                    if ((u.drag_support.formdata && (t = u.drag_support.formdata ? new FormData() : null), t)) {
                        var n;
                        if (!1 !== u.opts.videoUploadToS3)
                            for (n in (t.append("key", u.opts.videoUploadToS3.keyStart + new Date().getTime() + "-" + (a.name || "untitled")),
                                t.append("success_action_status", "201"),
                                t.append("X-Requested-With", "xhr"),
                                t.append("Content-Type", a.type),
                                u.opts.videoUploadToS3.params))
                                u.opts.videoUploadToS3.params.hasOwnProperty(n) && t.append(n, u.opts.videoUploadToS3.params[n]);
                        for (n in u.opts.videoUploadParams) u.opts.videoUploadParams.hasOwnProperty(n) && t.append(n, u.opts.videoUploadParams[n]);
                        t.append(u.opts.videoUploadParam, a);
                        ...
                        var i = u.core.getXHR(r, u.opts.videoUploadMethod);
                        (i.onload = function () {
                            w.call(i, p);
                        }),
                            (i.onerror = I),
                            ...
                            u.edit.off(),
                            u.events.enableBlur();
                        var o = u.popups.get("video.insert");
                        o &&
                            h(o.off("abortUpload")).on("abortUpload", function () {
                                4 != i.readyState && i.abort();
                            }),
                            i.send(t);
                    }
            ...
            function G(e, t) {
                u.edit.on(), p && p.find("video").addClass("fr-error"), _(u.language.translate("Something went wrong. Please try again.")), u.events.trigger("video.error", [{ code: e, message: r[e] }, t]);
            }
            function Y() {
                if (p) {
            ...
            function V(e) {
                if (e) return u.popups.onRefresh("video.size", Y), !0;
                var t = {
                    ...
                    size_layer: '<div class="fr-video-size-layer fr-layer fr-active" id="fr-video-size-layer-'
                        .concat(u.id, '"><div class="fr-video-group"><div class="fr-input-line"><input id="fr-video-size-layer-width-')
                        .concat(u.id, '" type="text" name="width" placeholder="')
                        .concat(u.language.translate("Width"), '" tabIndex="1"></div><div class="fr-input-line"><input id="fr-video-size-layer-height-')
                        .concat(u.id, '" type="text" name="height" placeholder="')
                        .concat(u.language.translate("Height"), '" tabIndex="1"></div></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="videoSetSize" tabIndex="2" role="button">')
                        .concat(u.language.translate("Update"), "</button></div></div>"),
                },
                    a = u.popups.create("video.size", t);
                return (
                    u.events.$on(u.$wp, "scroll", function () {
                        p && u.popups.isVisible("video.size") && (u.events.disableBlur(), y(p));
                    }),
                    a
                );
            }
            ...
            function q() {
                if (p && !1 !== u.events.trigger("video.beforeRemove", [p])) {
                    var e = p;
                    u.popups.hideAll(), U(!0), u.selection.setBefore(e.get(0)) || u.selection.setAfter(e.get(0)), e.remove(), u.selection.restore(), u.html.fillEmptyBlocks();
                }
            }
            function X() {
                S();
            ...
            function Q(e, t, a) {
                !u.opts.htmlUntouched && u.opts.useClasses
                    ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv".concat(a[0], " fr-dv").concat(t[0])))
                    : "inline" == t
                        ? (e.css({ display: "inline-block" }), "center" == a ? e.css({ float: "none" }) : "left" == a ? e.css({ float: "left" }) : e.css({ float: "right" }))
                        : (e.css({ display: "block", clear: "both" }), "left" == a ? e.css({ textAlign: "left" }) : "right" == a ? e.css({ textAlign: "right" }) : e.css({ textAlign: "center" }));
            }
            function J() {
                ...
                if (0 != e.length) {
                    e.wrap(h(document.createElement("span")).attr("class", "fr-video fr-deletable").attr("contenteditable", "false")),
                        u.$el
                            .find("embed, iframe")
                            .filter(function () {
                                if ((u.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < h(this).parents("span.fr-video").length)) return !1;
                                for (var e = h(this).attr("src"), t = 0; t < Be.VIDEO_PROVIDERS.length; t++) {
                                    var a = Be.VIDEO_PROVIDERS[t];
                                    if (a.test_regex.test(e) && new RegExp(u.opts.videoAllowedProviders.join("|")).test(a.provider)) return !0;
                                }
                                return !1;
                            })
                            .map(function () {
                    ...
                    for (var t, a, n, r, i = u.$el.find("span.fr-video, video"), o = 0; o < i.length; o++) {
                        var s = h(i[o]);
                        !u.opts.htmlUntouched && u.opts.useClasses
                            ? ((r = s).hasClass("fr-dvi") || r.hasClass("fr-dvb") || (r.addClass("fr-fv".concat(z(r)[0])), r.addClass("fr-dv".concat(j(r)[0]))), u.opts.videoTextNear || s.removeClass("fr-dvi").addClass("fr-dvb"))
                            : u.opts.htmlUntouched ||
                            u.opts.useClasses ||
                            (void 0,
                                (a = (t = s).hasClass("fr-dvb") ? "block" : t.hasClass("fr-dvi") ? "inline" : null),
                                (n = t.hasClass("fr-fvl") ? "left" : t.hasClass("fr-fvr") ? "right" : z(t)),
                                Q(t, a, n),
            ...
            return (
                ...
                (r[g] = "No link in upload response."),
                (r[m] = "Error during file upload."),
                (r[v] = "Parsing response failed."),
                (r[c] = "File is too large."),
                (r[b] = "Video file type is invalid."),
                (r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9."),
                (u.shared.vid_exit_flag = !1),
                {
                    _init: function ee() {
                        u.opts.videoResponsive && (u.opts.videoResize = !1),
                            (function e() {
                                u.events.on("drop", H, !0),
                                    u.events.on("mousedown window.mousedown", W),
                                    u.events.on("window.touchmove", K),
                                    u.events.on("mouseup window.mouseup", U),
                                    u.events.on("commands.mousedown", function (e) {
                            ...
                            u.helpers.isMobile() &&
                            (u.events.$on(u.$el, "touchstart", "span.fr-video", function () {
                                a = !1;
                            }),
                                u.events.$on(u.$el, "touchmove", function () {
                                    a = !0;
                                })),
                            u.events.on("html.set", J),
                            J(),
                            u.events.$on(u.$el, "mousedown", "span.fr-video", function (e) {
                            ...
                            u.events.on(
                                ...
                                function (e) {
                                    var t = e.which;
                                    return !p || (t != Be.KEYCODE.BACKSPACE && t != Be.KEYCODE.DELETE)
                                        ? p && t == Be.KEYCODE.ESC
                                            ? (U(!0), e.preventDefault(), !1)
                                            : p && t != Be.KEYCODE.F10 && !u.keys.isBrowserAction(e)
                                                ? (e.preventDefault(), !1)
                                                : void 0
                                        : (e.preventDefault(), q(), u.undo.saveStep(), !1);
                                },
                                !0
                            ),
                            u.events.on(
                            ...
                            u.$wp && (B(), u.events.on("contentChanged", B)),
                            o(!0),
                            V(!0);
                    },
                        ...
                        if ((t || (t = o()), S(), !t.hasClass("fr-active")))
                            if ((u.popups.refresh("video.insert"), u.popups.setContainer("video.insert", u.$tb), e.isVisible())) {
                                var a = u.button.getPosition(e),
                                    n = a.left,
                                    r = a.top;
                                u.popups.show("video.insert", n, r, e.outerHeight());
                            } else u.position.forSelection(t), u.popups.show("video.insert");
                    },
                    showLayer: function ae(e) {
                        var t,
                            a,
                            n = u.popups.get("video.insert");
                        if (!p && !u.opts.toolbarInline) {
                            var r = u.$tb.find('.fr-command[data-cmd="insertVideo"]');
                            (t = r.offset().left), (a = r.offset().top + (u.opts.toolbarBottom ? 10 : r.outerHeight() - 10));
                        }
                        u.opts.toolbarInline && ((a = n.offset().top - u.helpers.getPX(n.css("margin-top"))), n.hasClass("fr-above") && (a += n.outerHeight())),
                            n.find(".fr-layer").removeClass("fr-active"),
                            n.find(".fr-".concat(e, "-layer")).addClass("fr-active"),
                            u.popups.show("video.insert", t, a, 0),
                            u.accessibility.focusPopup(n);
                    },
                    refreshByURLButton: function ne(e) {
                        var t = u.popups.get("video.insert");
                    ...
                    insertByURL: function oe(e) {
                        ...
                        if ((/^http/.test(e) || (e = "https://".concat(e)), u.helpers.isURL(e)))
                            for (var a = 0; a < Be.VIDEO_PROVIDERS.length; a++) {
                                var n = Be.VIDEO_PROVIDERS[a];
                                if (n.test_regex.test(e) && new RegExp(u.opts.videoAllowedProviders.join("|")).test(n.provider)) {
                                    (t = e.replace(n.url_regex, n.url_text)), (t = n.html.replace(/\{url\}/, t));
                                    break;
                                }
                            }
                        t ? A(t) : (_(u.language.translate("Something went wrong. Please try again.")), u.events.trigger("video.linkError", [e]));
                    },
                    insertEmbed: function se(e) {
                        void 0 === e && (e = u.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""),
                            0 !== e.length && Be.VIDEO_EMBED_REGEX.test(e) ? A(e) : (_(u.language.translate("Something went wrong. Please try again.")), u.events.trigger("video.codeError", [e]));
                    },
                    insert: A,
                    align: function le(e) {
                        p.removeClass("fr-fvr fr-fvl"), !u.opts.htmlUntouched && u.opts.useClasses ? ("left" == e ? p.addClass("fr-fvl") : "right" == e && p.addClass("fr-fvr")) : Q(p, j(), e), Z(), P(), i(), u.selection.clear();
                    },
                    refreshAlign: function ce(e) {
                        if (!p) return !1;
                        e.find(">*")
                            .first()
                            .replaceWith(u.icon.create("video-align-".concat(z())));
                    },
                    refreshAlignOnShow: function de(e, t) {
                        p && t.find('.fr-command[data-param1="'.concat(z(), '"]')).addClass("fr-active").attr("aria-selected", !0);
                    },
                    display: function fe(e) {
                        p.removeClass("fr-dvi fr-dvb"), !u.opts.htmlUntouched && u.opts.useClasses ? ("inline" == e ? p.addClass("fr-dvi") : "block" == e && p.addClass("fr-dvb")) : Q(p, e, z()), Z(), P(), i(), u.selection.clear();
                    },
                    ...
                    showSizePopup: function ue() {
                        var e = u.popups.get("video.size");
                        e || (e = V()), S(), u.popups.refresh("video.size"), u.popups.setContainer("video.size", u.$sc);
                        var t = p.find("iframe, embed, video"),
                            a = t.offset().left + t.outerWidth() / 2,
                            n = t.offset().top + t.height();
                        u.popups.show("video.size", a, n, t.height(), !0);
                    },
                    replace: function he() {
                        var e = u.popups.get("video.insert");
                        e || (e = o()), u.popups.isVisible("video.insert") || (S(), u.popups.refresh("video.insert"), u.popups.setContainer("video.insert", u.$sc));
                        var t = p.offset().left + p.outerWidth() / 2,
                            a = p.offset().top + p.height();
                        u.popups.show("video.insert", t, a, p.outerHeight(), !0);
                    },
                    back: function e() {
                    ...
                    setSize: function ge(e, t) {
                        if (p) {
                            var a = u.popups.get("video.size"),
                                n = p.find("iframe, embed, video");
                            n.css("width", e || a.find('input[name="width"]').val()),
                                n.css("height", t || a.find('input[name="height"]').val()),
                                n.get(0).style.width && n.removeAttr("width"),
                                n.get(0).style.height && n.removeAttr("height"),
        ...
        Be.RegisterCommand("insertVideo", {
            title: "Insert Video",
            undo: !1,
            focus: !0,
            refreshAfterCallback: !1,
        ...
        Be.DefineIcon("insertVideo", { NAME: "video-camera", FA5NAME: "camera", SVG_KEY: "insertVideo" }),
        Be.DefineIcon("videoByURL", { NAME: "link", SVG_KEY: "insertLink" }),
        Be.RegisterCommand("videoByURL", {
            title: "By URL",
            undo: !1,
            focus: !1,
            toggle: !0,
        ...
        Be.DefineIcon("videoEmbed", { NAME: "code", SVG_KEY: "codeView" }),
        Be.RegisterCommand("videoEmbed", {
            title: "Embedded Code",
            undo: !1,
            focus: !1,
            toggle: !0,
        ...
        Be.DefineIcon("videoUpload", { NAME: "upload", SVG_KEY: "upload" }),
        Be.RegisterCommand("videoUpload", {
            title: "Upload Video",
            undo: !1,
            focus: !1,
            toggle: !0,
        ...
        Be.RegisterCommand("videoInsertByURL", {
            undo: !0,
            focus: !0,
            callback: function () {
        ...
        Be.RegisterCommand("videoInsertEmbed", {
            undo: !0,
            focus: !0,
            callback: function () {
        ...
        Be.DefineIcon("videoDisplay", { NAME: "star", SVG_KEY: "star" }),
        Be.RegisterCommand("videoDisplay", {
            title: "Display",
            type: "dropdown",
            options: { inline: "Inline", block: "Break Text" },
            callback: function (e, t) {
        ...
        Be.DefineIcon("video-align", { NAME: "align-left", SVG_KEY: "align Left" }),
        Be.DefineIcon("video-align-left", { NAME: "align-left", SVG_KEY: "alignLeft" }),
        Be.DefineIcon("video-align-right", { NAME: "align-right", SVG_KEY: "alignRight" }),
        Be.DefineIcon("video-align-center", { NAME: "align-justify", SVG_KEY: "alignJustify" }),
        Be.DefineIcon("videoAlign", { NAME: "align-center", SVG_KEY: "alignCenter" }),
        Be.RegisterCommand("videoAlign", {
            type: "dropdown",
            title: "Align",
            options: { left: "Align Left", center: "None", right: "Align Right" },
            html: function () {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Be.COMMANDS.videoAlign.options;
                for (var a in t)
                    t.hasOwnProperty(a) &&
                        (e += '<li role="presentation"><a class="fr-command fr-title" tabIndex="-1" role="option" data-cmd="videoAlign" data-param1="'
                            .concat(a, '" title="')
                            .concat(this.language.translate(t[a]), '">')
                            .concat(this.icon.create("video-align-".concat(a)), '<span class="fr-sr-only">')
                            .concat(this.language.translate(t[a]), "</span></a></li>"));
                return (e += "</ul>");
            },
            callback: function (e, t) {
        ...
        Be.DefineIcon("videoReplace", { NAME: "exchange", FA5NAME: "exchange-alt", SVG_KEY: "replaceImage" }),
        Be.RegisterCommand("videoReplace", {
            title: "Replace",
            undo: !1,
            focus: !1,
            popup: !0,
        ...
        Be.DefineIcon("videoRemove", { NAME: "trash", SVG_KEY: "remove" }),
        Be.RegisterCommand("videoRemove", {
            title: "Remove",
            callback: function () {
                this.video.remove();
            },
        }),
        Be.DefineIcon("videoSize", { NAME: "arrows-alt", SVG_KEY: "imageSize" }),
        Be.RegisterCommand("videoSize", {
            undo: !1,
            focus: !1,
            popup: !0,
            title: "Change Size",
        ...
        Be.DefineIcon("videoBack", { NAME: "arrow-left", SVG_KEY: "back" }),
        Be.RegisterCommand("videoBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        Be.RegisterCommand("videoDismissError", {
            title: "OK",
            undo: !1,
            callback: function () {
        ...
        Be.RegisterCommand("videoSetSize", {
            undo: !0,
            focus: !1,
            title: "Update",
            refreshAfterCallback: !1,
        ...
        (Be.PLUGINS.wordPaste = function (T) {
            var o,
                r,
                c = T.$,
                s = "word_paste",
                ...
                e || (T.opts.wordAllowedStyleProps = []),
                    ...
                    (r = i(
                        (r = r.replace(/<span[\n\r ]*style='mso-spacerun:yes'>([\r\n\u00a0 ]*)<\/span>/g, function (e, t) {
                            for (var a = "", n = 0; n++ < t.length;) a += "&nbsp;";
                            return a;
                        })),
                        T.paste.getRtfClipboard()
                    ));
                var a = T.doc.createElement("DIV");
                (a.innerHTML = r),
                    T.html.cleanBlankSpaces(a),
                    (r = a.innerHTML),
            ...
            function u(e, t) {
                if (t(e))
                    for (var a = e.firstChild; a;) {
                        ...
                        (a = a.nextSibling),
                            u(n, t),
                            n.previousSibling || n.nextSibling || n.parentNode || !a || r === a.previousSibling || !a.parentNode
                                ? n.previousSibling ||
                                n.nextSibling ||
                                n.parentNode ||
                                !a ||
                                ...
                                a.nextSibling ||
                                a.parentNode ||
                                (r ? (a = r.nextSibling ? r.nextSibling.nextSibling : null) : e.firstChild && (a = e.firstChild.nextSibling))
                                : (a = r ? r.nextSibling : e.firstChild);
                    }
            }
            function O(e) {
            ...
            function F(e, n) {
                ...
                if (-1 !== ["H1", "H2", "H3", "H4", "H5", "H6"].indexOf(e.tagName)) {
                    var a = document.createElement(e.tagName.toLowerCase());
                    a.setAttribute("style", e.getAttribute("style")), (a.innerHTML = t.innerHTML), (t.innerHTML = a.outerHTML);
                }
                u(t, function (e) {
                    if (e.nodeType == Node.COMMENT_NODE && (T.browser.msie || T.browser.safari || T.browser.edge))
                        try {
                    ...
                    return (
                        ...
                        ("mso-list:\nIgnore" === e.getAttribute("style") && e.setAttribute("style", "mso-list:Ignore"),
                            "mso-list:Ignore" === e.getAttribute("style") && e.parentNode.removeChild(e),
                            e.setAttribute(
                                "style",
                                (function r(e) {
                                    var a = "",
            ...
            function E(e, t) {
                for (var a = document.createElement(t), n = 0; n < e.attributes.length; n++) {
                    var r = e.attributes[n].name;
                    a.setAttribute(r, e.getAttribute(r));
                }
                return (a.innerHTML = e.innerHTML), e.parentNode.replaceChild(a, e), a;
            }
            function R(e) {
            ...
            function L(e, t, a) {
                if (t) {
                    ...
                    n && ";" !== n.slice(-1) && (n += ";"), t && ";" !== t.slice(-1) && (t += ";"), (t = t.replace(/\n/gi, ""));
                    var r = null;
                    (r = a ? (n || "") + t : t + (n || "")), e.setAttribute("style", r);
                }
            }
            var h = null;
            function d(e, t, a) {
                for (var n = e.split(a), r = 1; r < n.length; r++) {
                    var i = n[r];
                    if (1 < (i = i.split("shplid")).length) {
                        i = i[1];
                        for (var o = "", s = 0; s < i.length && "\\" !== i[s] && "{" !== i[s] && " " !== i[s] && "\r" !== i[s] && "\n" !== i[s];) (o += i[s]), s++;
                        var l = i.split("bliptag");
                        ...
                        var p = f.join("");
                        h[t + o] = { image_hex: p, image_type: c };
                    }
                }
            }
            function g(e, t) {
                if (t) {
                    ...
                    if ("IMG" === e.tagName) {
                        ...
                        if (!n || -1 === n.indexOf("file://")) return;
                        if (0 === n.indexOf("file://") && T.helpers.isURL(e.getAttribute("alt"))) return void e.setAttribute("src", e.getAttribute("alt"));
                        (a = p[e.getAttribute("v:shapes")]) || ((a = e.getAttribute("v:shapes")), e.parentNode && e.parentNode.parentNode && 0 <= e.parentNode.parentNode.innerHTML.indexOf("msEquation") && (a = null));
                    } else a = e.parentNode.getAttribute("o:spid");
                    if ((e.removeAttribute("height"), a)) {
                        !(function s(e) {
                            (h = {}), d(e, "i", "\\shppict"), d(e, "s", "\\shp{");
                        })(t);
                        var r = h[a.substring(7)];
                        if (r) {
                            var i = (function l(e) {
                                for (var t = e.match(/[0-9a-f]{2}/gi), a = [], n = 0; n < t.length; n++) a.push(String.fromCharCode(parseInt(t[n], 16)));
                                var r = a.join("");
                                return btoa(r);
                            })(r.image_hex),
                                o = "data:" + r.image_type + ";base64," + i;
                            "IMG" === e.tagName
                                ? ((e.src = o), e.setAttribute("data-fr-image-pasted", !0))
                                : c(e.parentNode)
                                    .before('<img data-fr-image-pasted="true" src="' + o + '" style="' + e.parentNode.getAttribute("style") + '">')
                                    .remove();
                        }
                    }
                }
            ...
            function m(e, t) {
                ...
                if (-1 !== ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"].indexOf(a)) return C(e), !1;
                for (var r = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"], i = 0; i < r.length; i++) if (-1 !== a.indexOf(r[i])) return e.innerHTML && (e.outerHTML = e.innerHTML), C(e), !1;
                if ("TD" !== a) {
                    var o = e.getAttribute("class") || "MsoNormal";
                    if (t && o) {
                        for (var s = (o = S(o)).split(" "), l = 0; l < s.length; l++) {
                            var c = [],
                                d = "." + s[l];
                            c.push(d), (d = n + d), c.push(d);
                            for (var f = 0; f < c.length; f++) t[c[f]] && L(e, t[c[f]]);
                        }
                        e.removeAttribute("class");
                    }
                    t && t[n] && L(e, t[n]);
                }
                if (-1 !== ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(a)) {
                    var p = e.getAttribute("class");
                    if (p && (t && t[a.toLowerCase() + "." + p] && L(e, t[a.toLowerCase() + "." + p]), -1 !== p.toLowerCase().indexOf("mso"))) {
                        var u = S(p);
                ...
                if (
                    ("TR" === a &&
                        (function A(e, t) {
                            ...
                            for (var a = e.firstElementChild, n = 0, r = !1, i = null; a;) {
                                a.firstElementChild && -1 !== a.firstElementChild.tagName.indexOf("W:") && (a.innerHTML = a.firstElementChild.innerHTML),
                                    (i = a.getAttribute("width")) || r || (r = !0),
                                    (n += parseInt(i, 10)),
                                    (!a.firstChild || (a.firstChild && a.firstChild.data === Be.UNICODE_NBSP)) && (a.firstChild && C(a.firstChild), (a.innerHTML = "<br>"));
                                for (var o = a.firstElementChild, s = 1 === a.children.length; o;) "P" !== o.tagName || O(o) || (s && R(o)), (o = o.nextElementSibling);
                                if (t) {
                                    var l = a.getAttribute("class");
                                    if (l) {
                                        var c = (l = S(l)).match(/xl[0-9]+/gi);
                                        if (c) {
                                            var d = "." + c[0];
                                            t[d] && L(a, t[d]);
                                        }
                                ...
                                var f = a.getAttribute("style");
                                f && (f = S(f)) && ";" !== f.slice(-1) && (f += ";");
                                var p = a.getAttribute("valign");
                                if (!p && f) {
                                ...
                                var b = a.getAttribute("colspan"),
                                    E = a.getAttribute("rowspan");
                                b && a.setAttribute("colspan", b),
                                    E && a.setAttribute("rowspan", E),
                                    p && (a.style["vertical-align"] = p),
                                    h && (a.style["text-align"] = h),
                                    m && (a.style["background-color"] = m),
                                    i && a.setAttribute("width", i),
                                    (a = a.nextElementSibling);
                            }
                            for (a = e.firstElementChild; a;) (i = a.getAttribute("width")), r ? a.removeAttribute("width") : a.setAttribute("width", (100 * parseInt(i, 10)) / n + "%"), (a = a.nextElementSibling);
                        })(e, t),
                        "A" !== a || e.attributes.getNamedItem("href") || e.attributes.getNamedItem("name") || !e.innerHTML || (e.outerHTML = e.innerHTML),
                        "A" == a && e.getAttribute("href") && e.querySelector("img"))
                )
                    for (var m = e.querySelectorAll("span"), v = 0; v < m.length; v++) m[v].innerText || (m[v].outerHTML = m[v].innerHTML);
                if (
                    (("TD" !== a && "TH" !== a) || e.innerHTML || (e.innerHTML = "<br>"),
                        "TABLE" === a && (e.style.width = e.style.width),
                        e.getAttribute("lang") && e.removeAttribute("lang"),
                        e.getAttribute("style") && -1 !== e.getAttribute("style").toLowerCase().indexOf("mso"))
                ) {
                    var b = S(e.getAttribute("style"));
            ...
            function i(e, t) {
                0 <= e.indexOf("<html") && (e = e.replace(/[.\s\S\w\W<>]*(<html[^>]*>[.\s\S\w\W<>]*<\/html>)[.\s\S\w\W<>]*/i, "$1")),
                    (function d(e) {
                        for (var t = e.split("v:shape"), a = 1; a < t.length; a++) {
                            var n = t[a],
                                r = n.split(' id="')[1];
                            if (r && 1 < r.length) {
                                r = r.split('"')[0];
                                var i = n.split(' o:spid="')[1];
                                i && 1 < i.length && ((i = i.split('"')[0]), (p[r] = i));
                            }
                        }
                    })(e);
                var a = new DOMParser().parseFromString(e, "text/html"),
                    ...
                    s = (function f(e) {
                        var t = {},
                            a = e.getElementsByTagName("style");
                        if (a.length) {
                            var n = a[0].innerHTML.match(/[\S ]+\s+{[\s\S]+?}/gi);
                            if (n)
                                for (var r = 0; r < n.length; r++) {
                                    var i = n[r],
                                        o = i.replace(/([\S ]+\s+){[\s\S]+?}/gi, "$1"),
                                        s = i.replace(/[\S ]+\s+{([\s\S]+?)}/gi, "$1");
                                    (o = o.replace(/^[\s]|[\s]$/gm, "")), (s = s.replace(/^[\s]|[\s]$/gm, "")), (o = o.replace(/\n|\r|\n\r/g, "")), (s = s.replace(/\n|\r|\n\r/g, ""));
                                    for (var l = o.split(", "), c = 0; c < l.length; c++) t[l[c]] = s;
                                }
                        }
                        return t;
                    })(n);
                u(r, function (e) {
                    if (e.nodeType === Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                        if (!/\S| /.test(e.data) && !/[\u00a0]+/.test(e.data)) return e.data === Be.UNICODE_NBSP ? ((e.data = "\u200b"), !0) : 1 === e.data.length && 10 === e.data.charCodeAt(0) ? ((e.data = " "), !0) : (C(e), !1);
                ...
                for (var i = r.querySelectorAll("ul > ul, ul > ol, ol > ul, ol > ol"), o = i.length - 1; 0 <= o; o--)
                    i[o].previousElementSibling && "LI" === i[o].previousElementSibling.tagName && i[o].previousElementSibling.appendChild(i[o]);
                u(r, function (e) {
                            ...
                            var t = e.parentNode,
                                ...
                                n = (function I(e, t, a, n) {
                                    ...
                                    var c,
                                        ...
                                        f,
                                        p,
                                        u = e.querySelector('span[style="mso-list:Ignore"]');
                                    null == u && "safari" == l && (u = e.querySelector('span[lang="PT-BR"]'));
                                    var h;
                                    u && (s = s || o.test(u.textContent)),
                                        null !== u && (h = u.textContent.trim().split(".")[0]),
                                        (f =
                                            1 == s
                                                ? ("1" == (h = u.textContent.trim().split(".")[0])
                                                    ? (p = "decimal;")
                                                    : "i" == h
                                                        ? (p = "lower-roman;")
                                                        : "I" == h
                                                    ...
                                                    (p = "list-style-type: " + p),
                                                    "ol")
                                                : (null != u && (h = u.textContent.trim().split(".")[0]), "\xa7" == h ? (p = "square;") : "\xb7" == h && (p = "disc;"), (p = "list-style-type: " + p), "ul"));
                                    var g,
                                        m = "";
                                    ...
                                    if ((E.includes("in") ? ((v = "in"), (E = parseFloat(E) - 0.5)) : E.includes("pt") && ((v = "px"), (E = parseFloat(E) - 10)), 1 == b))
                                        ...
                                        var R = h.charCodeAt(0) - 96;
                                        g = p ? "<" + f + m + ' style = "' + p + ' start="' + R + '">' : "<" + f + ">";
                                    ...
                                    for (var S = !1; e;) {
                                        ...
                                        var L = x(e);
                                        if ((a = a || L) < L) (g += (d = I(e, t, L, e.style.marginLeft)).el.outerHTML), (e = d.currentNode);
                                        else {
                                            if (L < a) break;
                                            e.firstElementChild && e.firstElementChild.firstElementChild && e.firstElementChild.firstElementChild.firstChild && (o.lastIndex = 0),
                                                i &&
                                                i.firstElementChild &&
                                                i.firstElementChild.firstElementChild &&
                                                i.firstElementChild.firstElementChild.firstChild &&
                                                ((o.lastIndex = 0),
                                                    (r = o.test(
                                                        i.firstElementChild.firstElementChild.firstChild.data ||
                                                        (i.firstElementChild.firstElementChild.firstChild.firstChild && i.firstElementChild.firstElementChild.firstChild.firstChild.data) ||
                                                        ""
                                                    )));
                                            var _ = !1;
                                            ((!n && !e.style.marginLeft) || (n && e.style.marginLeft && n === e.style.marginLeft)) && (_ = !0),
                                                (n = e.style.marginLeft),
                                                _ || r === undefined
                                                    ? ((c = F(e, t)),
                                                        e.nextSibling.innerText == undefined ||
                                                        e.nextSibling.innerText == undefined ||
                                                        g.includes('class="decimal_type"') ||
                                                        isNaN(parseInt(e.nextSibling.innerText.trim().split(".")[1], 10)) ||
                                                        (g = g.substring(3, 0) + ' class="decimal_type"' + g.substring(3, g.length)),
                                                        (g += "<li>" + c + "</li>"))
                                                    : (1 == L && ((g += "</" + f + ">"), (S = !0), (i = null)), (g += (d = I(e, t, L, e.style.marginLeft)).el.outerHTML), (e = d.currentNode));
                                            var y = e && e.nextElementSibling;
                                            if ((y && (i = y.previousElementSibling), e && !O(e))) {
                                                if (e.outerHTML && 0 < e.outerHTML.indexOf("mso-bookmark") && 0 == (e.textContent || "").length) {
                                                    e = e.nextElementSibling;
                                                    continue;
                                                }
                                            ...
                                            e && e.parentNode && e.parentNode.removeChild(e), (e = y);
                                        }
                                    }
                                    S || (g += "</" + f + ">");
                                    var w = document.createElement("div");
                                    return (w.innerHTML = g), { el: w, currentNode: e };
                                })(e, s).el,
                                r = null;
                            return (r = a ? a.nextSibling : t.firstChild) ? t.insertBefore(n, r) : t.appendChild(n), !1;
                        }
                        return "FONT" === e.tagName && s["." + e.getAttribute("class")] && (e = E(e, "span")), m(e, s);
                    }
                    if (e.nodeType !== Node.COMMENT_NODE) return !0;
                    if (-1 < e.data.indexOf("[if !supportLineBreakNewLine]")) for (var i = e.nextSibling; i;) (i = e.nextSibling) && C(i), i.data && -1 < i.data.indexOf("[endif]") && (i = null);
                    if (-1 < e.data.indexOf("[if supportFields]") && -1 < e.data.indexOf("FORMCHECKBOX")) {
                        var o = document.createElement("input");
                        (o.type = "checkbox"), e.parentNode.insertBefore(o, e.nextSibling);
                    }
                    return C(e), !1;
                }),
                    u(r, function (e) {
                        if (e.nodeType === Node.ELEMENT_NODE) {
                            ...
                            if (!e.innerHTML && -1 === ["BR", "IMG", "INPUT"].indexOf(t)) {
                                for (var a = e.parentNode; a && (C(e), !(e = a).innerHTML);) a = e.parentNode;
                                return !1;
                            }
                            !(function d(e) {
                                ...
                                if (t) {
                                    (t = S(t)) && ";" !== t.slice(-1) && (t += ";");
                                    var a = t.match(/(^|\S+?):.+?;{1,1}/gi);
                                    if (a) {
                                        for (var n = {}, r = 0; r < a.length; r++) {
                                            var i = a[r].split(":");
                                            2 === i.length && (("text-align" === i[0] && "SPAN" === e.tagName) || (n[i[0]] = i[1]));
                                        }
                                        var o = "";
                                        for (var s in n)
                                            if (n.hasOwnProperty(s)) {
                                                if ("font-size" === s && "pt;" === n[s].slice(-3)) {
                                                    var l = null;
                                                    try {
                                                        l = parseFloat(n[s].slice(0, -3), 10);
                                                    } catch (c) {
                                                        l = null;
                                                    }
                                                    l && ((l = Math.round(1.33 * l)), (n[s] = l + "px;"));
                                                }
                                                o += s + ":" + n[s];
                                            }
                ...
                var l = r.outerHTML,
                    c = T.opts.htmlAllowedStyleProps;
                return (T.opts.htmlAllowedStyleProps = T.opts.wordAllowedStyleProps), (l = T.clean.html(l, T.opts.wordDeniedTags, T.opts.wordDeniedAttrs, !1)), (T.opts.htmlAllowedStyleProps = c), l;
            }
            return {
                _init: function e() {
                                    ...
                                    if (!o) {
                                        var e =
                                            ...
                                            t = (function r() {
                                                ...
                                                return (
                                                    (e += '<p style="text-align: left;">' + T.language.translate("The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?") + "</p>"),
                                                    (e +=
                                                        '<div style="text-align: right; margin-top: 50px;"><button class="fr-remove-word fr-command">' +
                                                        T.language.translate("Clean") +
                                                        '</button> <button class="fr-keep-word fr-command">' +
                                                        T.language.translate("Keep") +
                                                        "</button></div>"),
                                                    (e += "</div>")
                                                );
                                            })(),
                                            a = T.modals.create(s, e, t),
                                            n = a.$body;
                                        (o = a.$modal),
                                            a.$modal.addClass("fr-middle"),
                                            T.events.bindClick(n, "button.fr-remove-word", function () {
                                                var e = o.data("instance") || T;
                                                e.wordPaste.clean();
                                            }),
                                            T.events.bindClick(n, "button.fr-keep-word", function () {
                                                var e = o.data("instance") || T;
                                                e.wordPaste.clean(!0);
                                            }),
                                            T.events.$on(c(T.o_win), "resize", function () {
                                                T.modals.resize(s);
                                            });
                                    }
                                    T.modals.show(s), T.modals.resize(s);
                                })()
                                : t(T.opts.wordPasteKeepFormatting),
                            !1
                        );
                    });
                },
