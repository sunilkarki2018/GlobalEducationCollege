...
!(function (e, t) {
    ...
    (V.RegisterPlugins = function (e) {
        ...
        Object.assign(V, { DEFAULTS: { initOnClick: !1, pluginsEnabled: null }, MODULES: {}, PLUGINS: {}, VERSION: "3.1.1", INSTANCES: [], OPTS_MAPPING: {}, SHARED: {}, ID: 0 }),
                ...
                !(function c(a) {
                    ...
                    if (
                        ("PRE" === a.tagName &&
                            ...
                            (a.getAttribute("data-fr-src") && 0 !== a.getAttribute("data-fr-src").indexOf("blob:") && a.setAttribute("data-fr-src", f.helpers.sanitizeURL(E(a.getAttribute("data-fr-src")))),
    ...
    (V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}")),
            ...
            var i = {
                ...
                insertHR: function () {
                    ...
                    n.prev().is("hr") ? (t = a.selection.setAfter(n.get(0), !1)) : n.next().is("hr") ? (t = a.selection.setBefore(n.get(0), !1)) : a.selection.setAfter(n.get(0), !1) || a.selection.setBefore(n.get(0), !1),
                        t || void 0 === t || ((e = o((e = "".concat(V.MARKERS, "<br>")))), n.after(e)),
                        a.selection.restore();
                },
                ...
                !(function n(e) {
                    ...
                    a.$tb.find(".fr-open").not(e).removeClass("fr-open"),
                        ...
                        a.$tb.find(".fr-expanded").not(t).length
                            ? (a.$tb.find(".fr-expanded").toggleClass("fr-expanded"), t.toggleClass("fr-expanded"))
                            : (t.toggleClass("fr-expanded"), a.$box.toggleClass("fr-toolbar-open"), a.$tb.toggleClass("fr-toolbar-open"));
                    ...
                    if (g.node.isEmpty(n, !0) && r) {
                        ...
                        for (
                            ...
                            l.parentNode && "LI" === l.parentNode.tagName
                                ...
                                : i
                                    ? "".concat(s, "<").concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">").concat(a)
                        ...
                        (t = b(n)).parentNode && "LI" === t.parentNode.tagName
                            ? r
                                ? m(t.parentNode).before("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>"))
                                : m(t.parentNode).after("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>"))
                            : i
                                ? m(t).before("<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">"))
                    ...
                    if (r) {
                        ...
                        if (((s = s.nextSibling), g.node.isBlock(s)))
                            V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 &&
                                (m(e).replaceWith(V.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove());
                        else
                            for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(e).replaceWith(V.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;)
        ...
        (V.MODULES.cursor = function (u) {
            ...
            function m(e, t) {
                return (
                    ...
                    (e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE && 0 === e.nextSibling.textContent.replace(/\u200b/g, "").length
                        ? m(e.nextSibling, t)
                        : !(e.nextSibling && (!e.previousSibling || "BR" !== e.nextSibling.tagName || e.nextSibling.nextSibling)) && (e.parentNode === t || m(e.parentNode, t)))
                );
            }
            function c(e) {
                ...
                if (((n = n.previousSibling), !u.node.isBlock(n) && u.node.isEditable(n))) {
                    ...
                    if (n.nodeType === Node.TEXT_NODE) {
                        ...
                        if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
                            0 ===
                                r
                                    ...
                                    .replace(/ /g, "")
                                    .replace(new RegExp(V.UNICODE_NBSP, "g"), "").length && (o = r.length - u.opts.tabSpaces + 1);
                        ...
                        u.node.isDeletable(n)
                            ? (h(n).after(V.MARKERS), h(n).remove())
                            : e.nextSibling && "BR" === e.nextSibling.tagName && u.node.isVoid(n) && "BR" !== n.tagName
                                ? (h(e.nextSibling).remove(), h(e).replaceWith(V.MARKERS))
                                : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).after(V.MARKERS), h(n).remove());
                    ...
                    if (u.node.isDeletable(n)) h(e).replaceWith(V.MARKERS), h(n).remove();
                        ...
                        for (
                            u.node.isList(n) && (n = h(n).find("li").last().get(0)), (t = u.node.contents(n)) && "BR" === t[t.length - 1].tagName && h(t[t.length - 1]).remove(), t = u.node.contents(n);
            ...
            function n(e) {
                ...
                if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                    ...
                    n.nodeType === Node.TEXT_NODE
                        ? (h(n).before(V.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length)))
                        : u.node.isDeletable(n)
                            ? (h(n).before(V.MARKERS), h(n).remove())
                            : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).before(V.MARKERS), h(n).remove()),
                        h(e).remove();
                } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                    if (u.node.isDeletable(n)) h(e).replaceWith(V.MARKERS), h(n).remove();
            ...
            function l(e, t, n) {
                ...
                if (o && "BLOCKQUOTE" === o.tagName)
                    return (
                        m(e, o)
                            ? ((r = u.html.defaultTag()), t ? h(e).replaceWith("<br>" + V.MARKERS) : r ? h(o).after("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : h(o).after("".concat(V.MARKERS, "<br>")), h(e).remove())
                            : v(e, t, n),
                        !1
                    );
                if (null === o)
                    (r = u.html.defaultTag()) && u.node.isElement(e.parentNode)
                        ? h(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">"))
                        : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling
                            ? h(e).replaceWith("<br>".concat(V.MARKERS))
                            : h(e).replaceWith("<br>".concat(V.MARKERS, "<br>"));
                else {
                    var i = e,
                        a = "";
                    ...
                    (a = l + a + c + (e.parentNode === o && u.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) + V.MARKERS),
            ...
            function v(e, t, n) {
                ...
                if (null === r)
                    u.html.defaultTag() && e.parentNode === u.el
                        ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(u.html.defaultTag(), ">"))
                        : ((e.nextSibling && !u.node.isBlock(e.nextSibling)) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(V.MARKERS)));
                    ...
                    if ("BLOCKQUOTE" === r.tagName)
                        if (
                            (e.previousSibling &&
                                ...
                                (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()),
                                t)
                        )
                            i = a + i + V.MARKERS + s;
                        else {
            ...
            return {
                ...
                backspace: function E() {
                    ...
                    return (
                        i(t)
                            ? c(t) && g(t, h(t).parents("li").first().get(0))
                            ...
                            : a(t)
                                ? c(t) && g(t, h(t).parents("li").first().get(0))
                                    ...
                                    : (function l(e) {
                                        for (
                                            var t = 0 < h(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n;
                                            n && !n.previousSibling && "BLOCKQUOTE" !== n.tagName && n.parentElement !== u.el && !u.node.hasClass(n.parentElement, "fr-inner") && V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;
                                                    ...
                                                    if (u.node.isDeletable(a)) h(a).remove(), h(e).replaceWith(V.MARKERS);
                                                        ...
                                                        if (u.node.isBlock(a))
                                                            if (u.node.isEmpty(a) && !u.node.isList(a)) h(a).remove(), h(e).after(u.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "");
                                                                ...
                                                                if (
                                                                    (u.node.isList(a) && (a = h(a).find("li").last().get(0)),
                                                            ...
                                                            h(e).replaceWith(V.MARKERS),
                                                                "BLOCKQUOTE" === n.tagName && a.nodeType === Node.ELEMENT_NODE
                                                                    ? h(a).remove()
                                                                    : (h(a).after(u.node.isEmpty(n) ? "" : h(n).html()), h(n).remove(), "BR" === a.tagName && h(a).remove());
                                                } else
                                                    a ||
                                                        (n &&
                                                            ...
                                                            h(n)
                                                                ...
                                                                .replace(/\u200B/g, "").length
                                                            ? h(n).remove()
                                                            : u.node.isEmpty(n) && n.parentNode && u.node.isEditable(n.parentNode) && n.parentNode != u.el && h(n.parentNode).remove());
                                        }
                                    })(t)
                                : (e = f(t)),
                        h(t).remove(),
                ...
                _init: function x() {
                    ...
                    for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                        ...
                        if (c === M(p(M("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(A, c.length - A.length) || m(A) || v()) {
                            if (
                                (null !== (n = l[1]) && !(0 == n.indexOf("TRIAL") ? ((n = new Date(n.replace(/TRIAL/, ""))), new Date(n) < new Date() && ((T = y), 1)) : new Date(n) < new Date(M(C)))) ||
                                !(0 < (A || "").length) ||
                                m(A) ||
                                v()
                            ) {
        ...
        (V.MODULES.format = function (b) {
            ...
            function m(e, t, n) {
                if (e) {
                    ...
                    if (e) {
                        ...
                        if (o) {
                            if (E(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) m(o.firstChild, t, n);
                            else if (b.browser.mozilla && b.node.hasClass(o, "fr-marker")) {
                                var a,
                                    s = b.selection.blocks(),
                                    l = s.length;
            ...
            function n(e, t) {
                ...
                if ((void 0 === t && (t = {}), t.style && delete t.style, b.selection.isCollapsed())) {
                    b.markers.insert(),
                        b.$el.find(".fr-marker").replaceWith(
                            f(e, t) +
                            V.INVISIBLE_SPACE +
                            V.MARKERS +
                            (function a(e) {
            ...
            function y(e, t, n, r) {
                if (!r) {
                    var o = !1;
                    if (!0 === e.data("type")) for (; b.node.isFirstSibling(e.get(0)) && !e.parent().is(b.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), (o = !0);
                    else if (!1 === e.data("type")) for (; b.node.isLastSibling(e.get(0)) && !e.parent().is(b.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), (o = !0);
                    if (o) return !0;
                }
            ...
            function r(e, t) {
                ...
                for (var r = !0; r;) {
                    ...
                    for (var o = b.$el.find(".fr-marker"), i = 0; i < o.length; i++) {
                        ...
                        if (
                            (a.attr("data-cloned") ||
                                n ||
                                ((s = a.clone().removeClass("fr-marker").addClass("fr-clone")), a.data("type") && "true" === a.data("type").toString() ? a.attr("data-cloned", !0).after(s) : a.attr("data-cloned", !0).before(s)),
                                y(a, e, t, n))
                        ) {
                            r = !0;
                            break;
                ...
                !(function m(e, t, n, r) {
                    for (var o = b.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                        var a = o[i];
                        if ((a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && (a.outerHTML = a.innerHTML), b.node.hasClass(a, "fr-marker"))) t = (t + 1) % 2;
                        else if (t)
                            if (0 < E(a).find(".fr-marker").length) t = m(E(a), t, n, r);
                            else {
                                for (var s = E(a).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                                    var c = s[l];
                                    b.node.isBlock(c) || b.node.isVoid(c) || (void 0 !== n && !T(c, S(n, r)))
                                        ? b.node.isBlock(c) && void 0 === n && "TABLE" !== a.tagName && b.node.clearAttributes(c)
                                        : b.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML);
                                }
                                (void 0 === n && a.nodeType === Node.ELEMENT_NODE && !b.node.isVoid(a)) || T(a, S(n, r))
                                    ? b.node.isBlock(a) || b.node.hasClass(a, "fr-clone") || (a.outerHTML = a.innerHTML)
                                    : void 0 === n && a.nodeType === Node.ELEMENT_NODE && b.node.isBlock(a) && "TABLE" !== a.tagName && b.node.clearAttributes(a);
                            }
                        else 0 < E(a).find(".fr-marker").length && (t = m(E(a), t, n, r));
                    }
                    return t;
                })(b.$el, 0, e, t),
                    n || (b.$el.find(".fr-marker").remove(), b.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
                ...
                if (l) {
                    var c = b.node.blockParent(l),
                        ...
                        p = f.startOffset,
                        u = f.endOffset;
                    b.selection.text().replace(/\u200B/g, "").length ||
                        (function v(e, t) {
                            if (e && t) {
            ...
            function t(e, t) {
                ...
                if (b.selection.isCollapsed()) {
                    ...
                    if (b.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                        if (b.node.isEmpty(l.get(0))) (s = E(b.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), l.replaceWith(s);
                        else {
                            var c = {};
                            (c["style*"] = "".concat(e, ":")),
                                y(r, "span", c, !0),
                                ...
                                t
                                    ? ((s = E(b.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), r.replaceWith(s))
                                    : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS);
                        }
                        b.html.cleanEmptyTags();
                    } else
                        b.node.isEmpty(l.get(0)) && l.is("span")
                            ? (r.replaceWith(V.MARKERS), l.css(e, t))
                            : ((s = E('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>"))), r.replaceWith(s));
                    s && v(s, e, t);
                } else {
                    if ((b.selection.save(), null === t || ("color" === e && 0 < b.$el.find(".fr-marker").parents("u, a").length))) {
                        ...
                        for (n = 0; n < d.length; n++)
                            if (!0 === (r = E(d[n])).data("type") || "true" === r.data("type"))
                                for (; b.node.isFirstSibling(r.get(0)) && !r.parent().is(b.$el) && !b.node.isElement(r.parent().get(0)) && !b.node.isBlock(r.parent().get(0));) r.parent().before(r);
                            else for (; b.node.isLastSibling(r.get(0)) && !r.parent().is(b.$el) && !b.node.isElement(r.parent().get(0)) && !b.node.isBlock(r.parent().get(0));) r.parent().after(r);
                    }
                    ...
                    for (
                        ...
                        (t || "").match(/\dem$/) && b.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
            ...
            function v(e, t, n) {
                var r,
                    o,
                    i,
                    a = e.parentsUntil(b.$el, "span[style]"),
                    s = [];
                for (r = a.length - 1; 0 <= r; r--)
                    (o = a[r]), (i = t), 0 === E(o).attr("style").indexOf("".concat(i, ":")) || 0 <= E(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= E(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
                if ((a = a.not(s)).length) {
                    for (
                        ...
                        a.get(0) !== p && ((d += b.node.closeTagString(p)), (f = b.node.openTagString(E(p).clone().addClass("fr-split").get(0)) + f)),
                        a.get(0) !== p;
                ...
                if (!c.html.isPreformatted(i)) {
                    ...
                    for (var s = "", l = 0; l < o.length; l++)
                        32 != o.charCodeAt(l) ||
                            ...
                            (((c.opts.enter !== V.ENTER_BR && c.opts.enter !== V.ENTER_DIV) || !((n && "BR" === n.tagName) || (r && "BR" === r.tagName))) && ((n && r && c.node.isVoid(n)) || (n && r && c.node.isVoid(r))))
                            ? (s += o[l])
                            : (s += V.UNICODE_NBSP);
        ...
        (V.MODULES.selection = function (T) {
                ...
                if (T.$wp) {
                    ...
                    for (t = 0; t < n.length; t++)
                        if (n[t].startContainer !== T.doc || T.browser.msie) {
                            ...
                            if (((void 0 !== i && i) || !o || (y(".fr-marker").remove(), T.selection.setAtEnd(T.el)), T.el.normalize(), T.browser.safari && !o))
                                try {
                        ...
                        try {
                            ...
                            if (o.nextSibling === a || a.nextSibling === o) {
                                ...
                                if ((h && (T.node.isVoid(h) || T.node.isBlock(h)) && (h = null), g && (T.node.isVoid(g) || T.node.isBlock(g)) && (g = null), h && g && h.nodeType === Node.TEXT_NODE && g.nodeType === Node.TEXT_NODE)) {
                                    ...
                                    !h && g && g.nodeType === Node.TEXT_NODE
                                        ? (y(o).remove(), y(a).remove(), T.opts.htmlUntouched || T.spaces.normalize(g), (s = y(T.doc.createTextNode("\u200b")).get(0)), y(g).before(s), i.setStart(g, 0), i.setEnd(g, 0), (l = !0))
                                        : !g &&
                                        h &&
                            ...
                            if (!l) {
                                var v = void 0,
                                    b = void 0;
                                (b =
                                    (T.browser.chrome || T.browser.edge) && o.nextSibling === a
                                        ? ((v = M(a, i, !0) || i.setStartAfter(a)), M(o, i, !1) || i.setEndBefore(o))
                                        : (o.previousSibling === a && (a = (o = a).nextSibling),
                                            (a.nextSibling && "BR" === a.nextSibling.tagName) ||
                                            (!a.nextSibling && T.node.isBlock(o.previousSibling)) ||
                                            (o.previousSibling && "BR" === o.previousSibling.tagName) ||
                                            ((o.style.display = "inline"), (a.style.display = "inline"), (s = y(T.doc.createTextNode("\u200b")).get(0))),
            ...
            function o(e) {
                ...
                if (T.win.getSelection) {
                    ...
                    T.doc.selection &&
                        "Control" !== T.doc.selection.type &&
                        ((n = (t = T.doc.selection.createRange()).duplicate()).moveToElementText(e), n.setEndPoint("EndToStart", t), (r = a(n)), n.moveToElementText(e), n.setEndPoint("StartToEnd", t), (o = a(n)));
                    ...
                    if (
                        ...
                        !(function S(e, t) {
                            ...
                            0 <= ["TD", "TH"].indexOf(e.get(0).tagName) &&
                                ...
                                (T.node.hasClass(n[0], "fr-marker") || ("BR" == n[0].tagName && T.node.hasClass(n[0].nextElementSibling, "fr-marker"))) &&
                                e.attr("data-del-cell", !0);
                            for (var r = 0; r < n.length; r++) {
                                var o = n[r];
                                T.node.hasClass(o, "fr-marker")
                                    ? (t = (t + 1) % 2)
                                    : t
                                        ? 0 < y(o).find(".fr-marker").length
                                            ? (t = S(y(o), t))
                                            : ["TD", "TH"].indexOf(o.tagName) < 0 && !T.node.hasClass(o, "fr-inner")
                                                ? !T.opts.keepFormatOnDelete || 0 < T.$el.find("[data-first]").length || T.node.isVoid(o)
                                                    ? y(o).remove()
                                                    : x(o)
                                                : T.node.hasClass(o, "fr-inner")
                                                    ? 0 === y(o).find(".fr-inner").length
                                                        ? y(o).html("<br>")
                                                        : y(o).find(".fr-inner").filter(w).html("<br>")
                                                    : (y(o).empty(), y(o).attr("data-del-cell", !0))
                                        : 0 < y(o).find(".fr-marker").length && (t = S(y(o), t));
                            }
                            return t;
                        })(T.$el, 0);
                        var s = T.$el.find('[data-first="true"]');
                        if (s.length) T.$el.find(".fr-marker").remove(), s.append(V.INVISIBLE_SPACE + V.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html());
                        else
                            for (
                                T.$el
                                    .find("table")
                                        ...
                                        if ((f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (u = !(f = null)), p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), y(l).after(d), f !== p))
                                            if (null !== f || u)
                                                if (null !== p || h || 0 !== y(f).parentsUntil(T.$el, "table").length)
                                                    f &&
                                                        p &&
                                                        0 === y(f).parentsUntil(T.$el, "table").length &&
                                                        0 === y(p).parentsUntil(T.$el, "table").length &&
                                                        !y(f).contains(p) &&
                                                        !y(p).contains(f) &&
                    ...
                    if (p() && r.rangeCount) {
                        ...
                        for (e = 0; e < o.length; e++) {
                            ...
                            for (var l = [], c = a; c !== s && c !== T.el;)
                                l.indexOf(c) < 0 && c.children && c.children.length ? (l.push(c), (c = c.children[0])) : c.nextSibling ? (c = c.nextSibling) : c.parentNode && ((c = c.parentNode), l.push(c)),
        ...
        (V.MODULES.html = function (w) {
            ...
            return {
                ...
                fillEmptyBlocks: function y(e) {
                    ...
                    for (var n = 0; n < t.length; n++) {
                        ...
                        "false" === r.getAttribute("contenteditable") ||
                            ...
                            w.node.isVoid(r) ||
                            ("TABLE" !== r.tagName && "TBODY" !== r.tagName && "TR" !== r.tagName && "UL" !== r.tagName && "OL" !== r.tagName && r.appendChild(w.doc.createElement("br")));
                    }
                ...
                get: function _(e, t) {
                                ...
                                for (var f = 0, p = c.length; f < p; f++)
                                    if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                                        ...
                                        for (o = 0; o < h.length; o++) {
                                            !h[o].getAttribute("fr-original-style") && h[o].getAttribute("style")
                                                ? (h[o].setAttribute("fr-original-style", h[o].getAttribute("style")), i.push(h[o]))
                                                : h[o].getAttribute("fr-original-style") || (h[o].setAttribute("fr-original-style", ""), i.push(h[o])),
                                                a[h[o]] || (a[h[o]] = {});
                                            for (var g = 1e3 * d + L(c[f].selectorText), m = c[f].style.cssText.split(";"), v = 0; v < m.length; v++) {
                                                ...
                                                if (
                                                    b &&
                                                    !b.match(l) &&
                                                    (a[h[o]][b] || ((a[h[o]][b] = 0) <= (h[o].getAttribute("fr-original-style") || "").indexOf("".concat(b, ":")) && (a[h[o]][b] = 1e4)),
                                                        g >= a[h[o]][b] && ((a[h[o]][b] = g), m[v].trim().length))
                                                ) {
                    ...
                    if (w.node.isEmpty(w.el)) w.opts.fullPage && ((n = $(w.iframe_document)), (n += "<html".concat(w.node.attributes(w.$html.get(0)), ">").concat(w.$html.find("head").get(0).outerHTML, "<body></body></html>")));
                ...
                getSelected: function A() {
                    function e(e, t) {
                        for (; t && (t.nodeType === Node.TEXT_NODE || !w.node.isBlock(t)) && !w.node.isElement(t) && !w.node.hasClass(t, "fr-inner");)
                            t && t.nodeType !== Node.TEXT_NODE && p(e).wrapInner(w.node.openTagString(t) + w.node.closeTagString(t)), (t = t.parentNode);
                            ...
                            a.appendChild(o[i].cloneContents()),
                                e(
                                    ...
                                    ((n = t = void 0),
                                        (n = null),
                                        w.win.getSelection
                                            ? (t = w.win.getSelection()) && t.rangeCount && (n = t.getRangeAt(0).commonAncestorContainer).nodeType !== Node.ELEMENT_NODE && (n = n.parentNode)
                                            : (t = w.doc.selection) && "Control" !== t.type && (n = t.createRange().parentElement()),
                ...
                unwrap: function O() {
                    w.$el.find("div.fr-temp-div").each(function () {
                        this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && p(this).before("<br>"),
                            p(this).attr("data-empty") || !this.nextSibling || (w.node.isBlock(this.nextSibling) && !p(this.nextSibling).hasClass("fr-temp-div"))
                                ? p(this).replaceWith(p(this).html())
                                : p(this).replaceWith("".concat(p(this).html(), "<br>"));
                    }),
                        w.$el
                            .find(".fr-temp-div")
        ...
        (V.MODULES.keys = function (d) {
            ...
            function m(e, t) {
                if (
                    (-1 < e.innerHTML.indexOf("<span") || -1 < e.parentElement.innerHTML.indexOf("<span") || -1 < e.parentElement.parentElement.innerHTML.indexOf("<span")) &&
                    (e.classList.contains("fr-img-space-wrap") || e.parentElement.classList.contains("fr-img-space-wrap") || e.parentElement.parentElement.classList.contains("fr-img-space-wrap"))
                ) {
            ...
            function s(e) {
                ...
                if (n === V.KEYCODE.ENTER)
                    e.shiftKey || t.classList.contains("fr-inner") || t.parentElement.classList.contains("fr-inner")
                        ? (function i(e) {
                    ...
                    if (n !== V.KEYCODE.DELETE || v(e) || e.altKey || e.shiftKey)
                        n === V.KEYCODE.SPACE
                            ...
                            : n === V.KEYCODE.TAB
                                ...
                                : v(e) || !E(e.which) || d.selection.isCollapsed() || e.ctrlKey || e.altKey || d.selection.remove();
                    else {
            ...
            function l() {
                ...
                d.opts.height || d.opts.heightMax
                    ? ((e = d.position.getBoundingRect().top),
                        ...
                        e > d.$wp.offset().top - d.helpers.scrollTop() + d.$wp.height() - 20 && d.$wp.scrollTop(e + d.$wp.scrollTop() - (d.$wp.height() + d.$wp.offset().top) + d.helpers.scrollTop() + 20))
                    : ((e = d.position.getBoundingRect().top),
        ...
        (V.MODULES.paste = function (M) {
            ...
            function t(e) {
                ...
                if (e && e.clipboardData && e.clipboardData.getData) {
                    ...
                    if (M.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += "".concat(n[r], ";");
                    else t = n;
                    if (
                        ((a = ""),
                            /text\/rtf/.test(t) && (s = e.clipboardData.getData("text/rtf")),
                            /text\/html/.test(t) && !M.browser.safari
                                ? (a = e.clipboardData.getData("text/html"))
                                : /text\/rtf/.test(t) && M.browser.safari
                                    ? (a = s)
                                    : /public.rtf/.test(t) && M.browser.safari && (a = e.clipboardData.getData("text/rtf")),
                            "" !== a)
                    )
                        return d(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                    a = null;
                }
                return (
                    (function o() {
                        M.selection.save(),
                            ...
                            (a = null),
                            i
                                ? (i.html(""), M.browser.edge && M.opts.iframe && M.$el.append(i))
                                : ((i = x(
                                    ...
                                    M.browser.webkit || M.browser.mozilla ? (i.css("top", M.$sc.scrollTop()), M.$el.after(i)) : M.browser.edge && M.opts.iframe ? M.$el.append(i) : M.$box.after(i),
                    ...
                    if (
                        ((a = ""),
                            ...
                            /text\/html/.test(t)
                                ...
                                : /text\/rtf/.test(t) && M.browser.safari
                                    ? (a = s)
                                    : /text\/plain/.test(t) && !this.browser.mozilla && (a = M.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")),
                            "" !== a)
                    ) {
                        ...
                        if (
                            (M.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"),
            ...
            function d() {
                M.opts.iframe && M.$el.attr("contenteditable", "true"),
                    ...
                    O || (M.keys.forceUndo(), (O = M.snapshot.get())),
                    a || ((a = i.get(0).innerHTML), M.selection.restore(), M.events.enableBlur());
            ...
            function o(e, t, n) {
                ...
                if (0 <= e.toLowerCase().indexOf("<body")) {
                    ...
                    0 <= e.indexOf("<style") && (a = e.replace(/[.\s\S\w\W<>]*(<style[^>]*>[\s]*[.\s\S\w\W<>]*[\s]*<\/style>)[.\s\S\w\W<>]*/gi, "$1")),
                        (e = (e = a + e.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1"))
                            .replace(/ \n/g, " ")
                            .replace(/\n /g, " ")
                            .replace(/([^>])\n([^<])/g, "$1 $2"));
                }
                ...
                if (("string" == typeof d && (e = d), "" !== e)) {
                    ...
                    else if (M.opts.enter === V.ENTER_DIV) for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = "<div>".concat(i.innerHTML, "</div>"));
                    else M.opts.enter === V.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
                    (e = f.innerHTML),
                        l &&
                        (e = (function N(e) {
                            var t,
                                n = M.o_doc.createElement("div");
                            n.innerHTML = e;
            ...
            return {
                _init: function u() {
                    M.el.addEventListener("copy", e),
                        ...
                        M.el.addEventListener("paste", t, { capture: !0 }),
                        M.events.on("drop", r),
                        M.browser.msie &&
        ...
        (V.MODULES.size = function (e) {
            ...
            function n() {
                e.opts.heightMin ? e.$el.css("minHeight", e.opts.heightMin) : e.$el.css("minHeight", ""),
                    ...
                    e.opts.height
                        ? (e.$wp.css("height", e.opts.height), e.$wp.css("overflow", "auto"), e.$el.css("minHeight", e.opts.height - e.helpers.getPX(e.$el.css("padding-top")) - e.helpers.getPX(e.$el.css("padding-bottom"))))
                ...
                return {
                    ...
                    _editorKeydown: function (e) {
                        ...
                        t.keys.ctrlKey(e) ||
                            ...
                            (g(r) && o.findVisible(".fr-back").length ? t.button.exec(o.findVisible(".fr-back").first()) : e.which !== V.KEYCODE.ALT && t.popups.hide(r));
                    },
                            ...
                            if (t.popups.isVisible(r) && t.opts.toolbarInline)
                                return (
                                    ...
                                    (o.findVisible(".fr-back").length
                                        ? (t.button.exec(o.findVisible(".fr-back").first()), t.accessibility.focusPopupButton(o))
                ...
                (f.shared.exit_flag = !1),
                {
                    ...
                    show: function y(e, t, n, r, o) {
                        ...
                        s.is(f.$tb) ? f.$tb.css("zIndex", (f.opts.zIndex || 1) + 4) : u[e].css("zIndex", (f.opts.zIndex || 1) + 4),
                            f.opts.toolbarBottom && s && f.$tb && s.get(0) === f.$tb.get(0) && (u[e].addClass("fr-above"), n && (n -= u[e].outerHeight())),
                            o && (t -= u[e].width() / 2),
                                            ...
                                            return V.KEYCODE.ESC === n
                                                ? (e.preventDefault(),
                                                    ...
                                                    t.popups.isVisible(c) && d.findVisible(".fr-back").length
                                                        ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()), t.button.exec(d.findVisible(".fr-back").first()), T(d))
                                                        : t.popups.isVisible(c) && d.findVisible(".fr-dismiss").length
                                                            ? t.button.exec(d.findVisible(".fr-dismiss").first())
                                                            : (t.popups.hide(c), t.opts.toolbarInline && t.toolbar.showInline(null, !0), T(d)),
                                                    !1)
                                                                        ...
                                                                        : e.parent().findVisible(".fr-back").length
                                                                            ...
                                                                            (e.parent().is(".fr-popup")
                                                                                ? (f.accessibility.restoreSelection(),
                                                                                    (f.shared.$f_el = null),
                                                                                    !1 !== f.events.trigger("toolbar.esc") && (f.popups.hide(e.parent()), f.opts.toolbarInline && f.toolbar.showInline(null, !0), T(e.parent())))
                                                                                : S()),
                                                                    !1
                                                                );
                                                            }
                ...
                if (!i.helpers.isMobile() && (e.data("title") || e.data("title", e.attr("title")), e.data("title"))) {
                        ...
                        (function o() {
                            i.opts.tooltips &&
                                ...
                                (i.shared.$tooltip
                                    ...
                                    : ((i.shared.$tooltip = a(i.doc.createElement("DIV")).addClass("fr-tooltip")),
                                        (i.$tooltip = i.shared.$tooltip),
                    ...
                    i.$tooltip.css("position", ""),
                        ...
                        "static" !== a(i.o_doc).find("body").first().css("position")
                            ? (i.$tooltip.css("margin-left", -a(i.o_doc).find("body").first().offset().left), i.$tooltip.css("margin-top", -a(i.o_doc).find("body").first().offset().top))
                            : (i.$tooltip.css("margin-left", ""), i.$tooltip.css("margin-top", ""));
                }
            }
            return {
                hide: r,
        ...
        (V.MODULES.button = function (g) {
            ...
            function t(e) {
                ...
                if (
                    (0 === e.parents(".fr-popup").length && e.data("popup") && !e.hasClass("fr-btn-active-popup") && e.addClass("fr-btn-active-popup"),
            ...
            function v(e) {
                ...
                return t.hasOptions && t.hasOptions.apply(g) && (f = '<div class="fr-btn-wrap">'.concat(f, " ").concat(v(e + "Options", Object.assign({}, t, { type: "options", hasOptions: !1 }), n), "  </div>")), f;
            }
            function e(o) {
            ...
            return {
                _init: function E() {
                    g.opts.toolbarInline
                        ...
                        : (g.events.on("mouseup", b), g.events.on("keyup", b), g.events.on("blur", b), g.events.on("focus", b), g.events.on("contentChanged", b), g.helpers.isMobile() && g.events.$on(g.$doc, "selectionchange", n)),
                ...
                buildList: function S(e, t) {
                    for (var n = "", r = 0; r < e.length; r++) {
                        ...
                        (i && "undefined" != typeof i.plugin && g.opts.pluginsEnabled.indexOf(i.plugin) < 0) ||
                            (i
                                ? (n += v(o, i, void 0 === t || 0 <= t.indexOf(o)))
                                : "|" === o
                        ...
                        if (o.buttons) {
                            for (var i = "", a = "", s = 0, l = "left", c = V.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < o.buttons.length; d++) {
                                ...
                                p ||
                                    ...
                                    (e[r].align !== undefined && (l = e[r].align), e[r].buttonsVisible !== undefined && (c = e[r].buttonsVisible), e.showMoreButtons && c <= s ? (a += v(f, p, !0)) : (i += v(f, p, !0)), s++);
                            }
                ...
                if (e.offsetWidth) {
                    ...
                    if ((t.data("sticky-offset") ? S.$box.find(".fr-sticky-dummy").css("height", "".concat(n, "px")) : (t.data("sticky-offset", !0), t.after('<div class="fr-sticky-dummy" style="height: '.concat(n, 'px;"></div>'))), !r)) {
                        ...
                        p || t.css("position", "fixed"),
                            (r = { top: S.node.hasClass(t.get(0), "fr-top"), bottom: S.node.hasClass(t.get(0), "fr-bottom") }),
                            p || t.css("position", ""),
                    ...
                    if (g || m) {
                        ...
                        S.node.hasClass(t.get(0), "fr-sticky-off") ||
                            (t.css("width", ""),
                    ...
                    !(function e() {
                        (S._stickyElements = []),
                            S.helpers.isIOS()
                                ...
                                : ("body" !== S.opts.scrollableContainer && S.events.$on(T(S.opts.scrollableContainer), "scroll", a, !0),
        ...
        (V.MODULES.toolbar = function (m) {
            ...
            function r() {
                if (v !== m.helpers.screenSize()) {
                        ...
                        if (o.buttons) {
                            ...
                            for (var c = 0; c < o.buttons.length; c++) {
                                ...
                                m.node.hasClass(d.next().get(0), "fr-dropdown-menu") && (f = d.next()),
                                    m.node.hasClass(d.next().get(0), "fr-options") && (d.removeClass("fr-hidden"), d.next().removeClass("fr-hidden"), (d = d.parent())),
                                    d.removeClass("fr-hidden"),
                                    e.showMoreButtons && s <= a ? (i.append(d), f && i.append(f)) : (l.append(d), f && l.append(f)),
                                    a++;
                            }
                    ...
                    m.opts.toolbarBottom
                        ? (m.$tb.append(n), m.$tb.find(".fr-newline").remove(), m.$tb.append('<div class="fr-newline"></div>'), m.$tb.append(t))
                        : (m.$tb.append(t), m.$tb.find(".fr-newline").remove(), m.$tb.append('<div class="fr-newline"></div>'), m.$tb.append(n)),
            ...
            function n(e, t) {
                setTimeout(function () {
                    if (
                        ...
                        m.core.hasFocus() &&
                        !m.popups.areVisible() &&
                        "false" != b(m.selection.blocks()[0]).closest("table").attr("contenteditable") &&
                        (m.opts.toolbarVisibleWithoutSelection || (!m.selection.isCollapsed() && !m.keys.isIME()) || t)
                    ) {
            ...
            function s() {
                m.events.on("window.mousedown", o),
                    ...
                    m.helpers.isMobile() ? m.helpers.isIOS() || (m.events.on("window.touchend", n), m.browser.mozilla && setInterval(n, 200)) : m.events.on("window.keyup", a),
                    ...
                    m.helpers.isMobile() && (m.events.$on(m.$doc, "selectionchange", a), m.events.$on(m.$doc, "orientationchange", n));
            }
            function l() {
            ...
            function d() {
                m.opts.theme && m.$tb.addClass("".concat(m.opts.theme, "-theme")),
                    ...
                    m.opts.toolbarContainer
                        ? (m.opts.toolbarInline && (s(), o()), m.opts.toolbarBottom ? m.$tb.addClass("fr-bottom") : m.$tb.addClass("fr-top"))
                        : (function e() {
                            m.opts.toolbarInline
                                ? (m.$sc.append(m.$tb), m.$tb.data("container", m.$sc), m.$tb.addClass("fr-inline"), s(), (m.opts.toolbarBottom = !1))
                                : (m.opts.toolbarBottom && !m.helpers.isIOS()
                                    ? (m.$box.append(m.$tb), m.$tb.addClass("fr-bottom"), m.$box.addClass("fr-bottom"))
                                    : ((m.opts.toolbarBottom = !1), m.$box.prepend(m.$tb), m.$tb.addClass("fr-top"), m.$box.addClass("fr-top")),
                                    m.$tb.addClass("fr-basic"),
                                    m.opts.toolbarSticky &&
                                    (m.opts.toolbarStickyOffset && (m.opts.toolbarBottom ? m.$tb.css("bottom", m.opts.toolbarStickyOffset) : m.$tb.css("top", m.opts.toolbarStickyOffset)), m.position.addSticky(m.$tb)));
                        })(),
                    (function t() {
            ...
            return {
                _init: function p() {
                    ...
                    m.opts.toolbarInline ||
                        m.opts.toolbarBottom ||
                        ((m.$second_tb = b(m.doc.createElement("div")).attr("class", "second-toolbar")), m.$box.append(m.$second_tb), (!1 !== m.ul || m.opts.attribution) && m.$second_tb.prepend(V.POWERED_BY)),
                        m.opts.toolbarContainer
                            ? (m.shared.$tb
                                ? ((m.$tb = m.shared.$tb), m.opts.toolbarInline && s())
                                : ((m.shared.$tb = b(m.doc.createElement("DIV"))), m.shared.$tb.addClass("fr-toolbar"), (m.$tb = m.shared.$tb), b(m.opts.toolbarContainer).append(m.$tb), d(), m.$tb.data("instance", m)),
                            ...
                            : m.opts.toolbarInline
                                ? (m.$box.addClass("fr-inline"), m.shared.$tb ? ((m.$tb = m.shared.$tb), s()) : ((m.shared.$tb = b(m.doc.createElement("DIV"))), m.shared.$tb.addClass("fr-toolbar"), (m.$tb = m.shared.$tb), d()))
                                : (m.$box.addClass("fr-basic"), (m.$tb = b(m.doc.createElement("DIV"))), m.$tb.addClass("fr-toolbar"), d(), m.$tb.data("instance", m)),
                        ...
                        (function e() {
                            m.events.on("shortcut", function (e, t, n) {
                                var r;
                                if (
                                    (t && !n ? (r = m.$tb.find('.fr-command[data-cmd="'.concat(t, '"]'))) : t && n && (r = m.$tb.find('.fr-command[data-cmd="'.concat(t, '"][data-param1="').concat(n, '"]'))),
                                        r.length && (e.preventDefault(), e.stopPropagation(), r.parents(".fr-toolbar").data("instance", m), "keydown" === e.type))
                                )
    ...
    var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"],
        ...
        u = function u(n, r) {
            return function (e) {
                var t = e.target;
                if (r) for (r = g(r); t && t !== this;) t.matches && t.matches(g(r)) && n.call(t, l(e, t)), (t = t.parentNode);
    ...
    (h.fn = h.prototype = {
        ...
        not: function (e) {
            if ("string" == typeof e) for (var t = this.length - 1; 0 <= t; t--) this[t].matches(e) && this.splice(t, 1);
        ...
        after: function e(t) {
            if (t)
                if ("string" == typeof t)
                    ...
                    var o = this[0];
                    if (o.nextSibling)
                        if (t instanceof h) for (var i = 0; i < t.length; i++) o.nextSibling.parentNode.insertBefore(t[i], o.nextSibling);
        ...
        before: function e(t) {
            ...
            if (t)
                if ("string" == typeof t)
                    ...
                    var i = this[0];
                    if (i.parentNode)
                        if (t instanceof h) for (var a = 0; a < t.length; a++) i.parentNode.insertBefore(t[a], i);
        ...
        append: function (e) {
            ...
            else if (e instanceof h || Array.isArray(e)) for (var o = 0; o < e.length; o++) this.append(e[o]);
        ...
        prepend: function (e) {
            ...
            else if (e instanceof h) for (var o = 0; o < e.length; o++) this.prepend(e[o]);
            else {
                var i = this[0];
    ...
    function S() {
        (this.doc = this.$el.get(0).ownerDocument),
            ...
            this.opts.initOnClick
                ...
                : (this.load(E.MODULES), this.load(E.PLUGINS), h(this.o_win).scrollTop(this.c_scroll), "undefined" == typeof this.ul && this.destroy(), (this.ready = !0), this.events.trigger("initialized"));
    }
    return (
        ...
        (E.Bootstrap.prototype._init = function () {
            ...
            var t = function () {
                "TEXTAREA" !== e && (this._original_html = this._original_html || this.$oel.html()),
                    ...
                    this.opts.iframe
                        ? ((this.$iframe = h('<iframe src="about:blank" frameBorder="0">')),
                            (this.$wp = h("<div></div>")),
                        ...
                        : ((this.$el = h(this.o_doc.createElement("DIV"))), (this.el = this.$el.get(0)), (this.$wp = h(this.o_doc.createElement("DIV")).append(this.$el)), this.$box.html(this.$wp)),
