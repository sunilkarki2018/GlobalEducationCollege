...
namespace GlobalCollege.Frontend.Areas.PageManagement.Controllers
{
    public class PageSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await PageSetupAPIHelper.GetPageSetupPageAsync("PageManagement", "PageSetup", "Index");
            return View(frontendPageInformation);
        }

        public async Task<IActionResult> Details(Guid Id,string Parameters)
        {
            FrontendPageInformation frontendPageInformation = await PageSetupAPIHelper.GetPageSetupPageAsync("PageManagement", "PageSetup", "Details");
