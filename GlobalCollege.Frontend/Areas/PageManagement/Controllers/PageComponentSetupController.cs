...
namespace GlobalCollege.Frontend.Areas.PageManagement.Controllers
{
    public class PageComponentSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await PageComponentSetupAPIHelper.GetPageComponentSetupPageAsync("PageManagement", "PageComponentSetup", "Index");
            return View(frontendPageInformation);
        }

        public async Task<IActionResult> Details(Guid Id,string Parameters)
        {
            FrontendPageInformation frontendPageInformation = await PageComponentSetupAPIHelper.GetPageComponentSetupPageAsync("PageManagement", "PageComponentSetup", "Details");
