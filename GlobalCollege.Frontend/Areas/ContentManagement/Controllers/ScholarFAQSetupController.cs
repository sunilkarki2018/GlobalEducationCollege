...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ScholarFAQSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarFAQSetupAPIHelper.GetScholarFAQSetupPageAsync("ContentManagement", "ScholarFAQSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarFAQSetupAPIHelper.GetScholarFAQSetupPageAsync("ContentManagement", "ScholarFAQSetup", "Details");
