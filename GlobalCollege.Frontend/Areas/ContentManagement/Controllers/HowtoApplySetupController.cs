...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class HowtoApplySetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await HowtoApplySetupAPIHelper.GetHowtoApplySetupPageAsync("ContentManagement", "HowtoApplySetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await HowtoApplySetupAPIHelper.GetHowtoApplySetupPageAsync("ContentManagement", "HowtoApplySetup", "Details");
