...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class NewsSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await NewsSetupAPIHelper.GetNewsSetupPageAsync("ContentManagement", "NewsSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await NewsSetupAPIHelper.GetNewsSetupPageAsync("ContentManagement", "NewsSetup", "Details");
