...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class AboutUsSetupController : Controller
    {
        [ResponseCache(Duration = 1200, VaryByQueryKeys = new[] { "*" })]
        public async Task<IActionResult> Index(string Parameters)
        {
            FrontendPageInformation frontendPageInformation = await AboutUsSetupAPIHelper.GetAboutUsSetupPageAsync("ContentManagement", "AboutUsSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await AboutUsSetupAPIHelper.GetAboutUsSetupPageAsync("ContentManagement", "AboutUsSetup", "Details");
