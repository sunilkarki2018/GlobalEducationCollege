...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class InstutionAddressSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstutionAddressSetupAPIHelper.GetInstutionAddressSetupPageAsync("ContentManagement", "InstutionAddressSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstutionAddressSetupAPIHelper.GetInstutionAddressSetupPageAsync("ContentManagement", "InstutionAddressSetup", "Details");
