...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class LifeAtInstitutionSetupController : Controller
    {
        [ResponseCache(Duration = 1200, VaryByQueryKeys = new[] { "*" })]
        public async Task<IActionResult> Index(string Parameters)
        {
            FrontendPageInformation frontendPageInformation = await LifeAtInstitutionSetupAPIHelper.GetLifeAtInstitutionSetupPageAsync("ContentManagement", "LifeAtInstitutionSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await LifeAtInstitutionSetupAPIHelper.GetLifeAtInstitutionSetupPageAsync("ContentManagement", "LifeAtInstitutionSetup", "Details");
