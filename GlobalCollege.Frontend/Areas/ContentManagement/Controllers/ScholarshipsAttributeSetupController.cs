...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ScholarshipsAttributeSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarshipsAttributeSetupAPIHelper.GetScholarshipsAttributeSetupPageAsync("ContentManagement", "ScholarshipsAttributeSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarshipsAttributeSetupAPIHelper.GetScholarshipsAttributeSetupPageAsync("ContentManagement", "ScholarshipsAttributeSetup", "Details");
