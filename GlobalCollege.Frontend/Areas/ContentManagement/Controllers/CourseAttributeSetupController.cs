...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class CourseAttributeSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await CourseAttributeSetupAPIHelper.GetCourseAttributeSetupPageAsync("ContentManagement", "CourseAttributeSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await CourseAttributeSetupAPIHelper.GetCourseAttributeSetupPageAsync("ContentManagement", "CourseAttributeSetup", "Details");
