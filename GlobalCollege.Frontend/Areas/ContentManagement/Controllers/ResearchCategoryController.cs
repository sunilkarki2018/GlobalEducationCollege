...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ResearchCategoryController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ResearchCategoryAPIHelper.GetResearchCategoryPageAsync("ContentManagement", "ResearchCategory", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ResearchCategoryAPIHelper.GetResearchCategoryPageAsync("ContentManagement", "ResearchCategory", "Details");
