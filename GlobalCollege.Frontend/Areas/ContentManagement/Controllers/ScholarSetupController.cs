...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ScholarSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarSetupAPIHelper.GetScholarSetupPageAsync("ContentManagement", "ScholarSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarSetupAPIHelper.GetScholarSetupPageAsync("ContentManagement", "ScholarSetup", "Details");
