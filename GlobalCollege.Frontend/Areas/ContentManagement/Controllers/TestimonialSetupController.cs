...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class TestimonialSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await TestimonialSetupAPIHelper.GetTestimonialSetupPageAsync("ContentManagement", "TestimonialSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await TestimonialSetupAPIHelper.GetTestimonialSetupPageAsync("ContentManagement", "TestimonialSetup", "Details");
