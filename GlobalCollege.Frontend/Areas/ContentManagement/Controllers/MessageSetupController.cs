...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class MessageSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await MessageSetupAPIHelper.GetMessageSetupPageAsync("ContentManagement", "MessageSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await MessageSetupAPIHelper.GetMessageSetupPageAsync("ContentManagement", "MessageSetup", "Details");
