...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ContactForScholarshipController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ContactForScholarshipAPIHelper.GetContactForScholarshipPageAsync("ContentManagement", "ContactForScholarship", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ContactForScholarshipAPIHelper.GetContactForScholarshipPageAsync("ContentManagement", "ContactForScholarship", "Details");
