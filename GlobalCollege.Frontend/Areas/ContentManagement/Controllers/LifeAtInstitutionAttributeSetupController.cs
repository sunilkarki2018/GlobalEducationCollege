...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class LifeAtInstitutionAttributeSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await LifeAtInstitutionAttributeSetupAPIHelper.GetLifeAtInstitutionAttributeSetupPageAsync("ContentManagement", "LifeAtInstitutionAttributeSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await LifeAtInstitutionAttributeSetupAPIHelper.GetLifeAtInstitutionAttributeSetupPageAsync("ContentManagement", "LifeAtInstitutionAttributeSetup", "Details");
