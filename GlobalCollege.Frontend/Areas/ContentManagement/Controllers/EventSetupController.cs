...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class EventSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await EventSetupAPIHelper.GetEventSetupPageAsync("ContentManagement", "EventSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await EventSetupAPIHelper.GetEventSetupPageAsync("ContentManagement", "EventSetup", "Details");
