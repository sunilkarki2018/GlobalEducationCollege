...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class BlogSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await BlogSetupAPIHelper.GetBlogSetupPageAsync("ContentManagement", "BlogSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await BlogSetupAPIHelper.GetBlogSetupPageAsync("ContentManagement", "BlogSetup", "Details");
