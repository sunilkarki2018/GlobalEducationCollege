...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class BannerSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await BannerSetupAPIHelper.GetBannerSetupPageAsync("ContentManagement", "BannerSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await BannerSetupAPIHelper.GetBannerSetupPageAsync("ContentManagement", "BannerSetup", "Details");
