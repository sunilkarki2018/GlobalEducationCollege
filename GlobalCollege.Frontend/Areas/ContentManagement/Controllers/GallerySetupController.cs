...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class GallerySetupController : Controller
    {
        [ResponseCache(Duration = 1200, VaryByQueryKeys = new[] { "*" })]
        public async Task<IActionResult> Index(string Parameters)
        {
            FrontendPageInformation frontendPageInformation = await GallerySetupAPIHelper.GetGallerySetupPageAsync("ContentManagement", "GallerySetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await GallerySetupAPIHelper.GetGallerySetupPageAsync("ContentManagement", "GallerySetup", "Details");
