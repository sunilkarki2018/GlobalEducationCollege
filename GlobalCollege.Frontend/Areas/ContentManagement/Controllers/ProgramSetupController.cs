...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ProgramSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ProgramSetupAPIHelper.GetProgramSetupPageAsync("ContentManagement", "ProgramSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ProgramSetupAPIHelper.GetProgramSetupPageAsync("ContentManagement", "ProgramSetup", "Details");
