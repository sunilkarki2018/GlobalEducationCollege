...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class FacilitySetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await FacilitySetupAPIHelper.GetFacilitySetupPageAsync("ContentManagement", "FacilitySetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await FacilitySetupAPIHelper.GetFacilitySetupPageAsync("ContentManagement", "FacilitySetup", "Details");
