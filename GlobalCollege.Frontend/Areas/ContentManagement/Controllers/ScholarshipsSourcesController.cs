...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class ScholarshipsSourcesController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarshipsSourcesAPIHelper.GetScholarshipsSourcesPageAsync("ContentManagement", "ScholarshipsSources", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await ScholarshipsSourcesAPIHelper.GetScholarshipsSourcesPageAsync("ContentManagement", "ScholarshipsSources", "Details");
