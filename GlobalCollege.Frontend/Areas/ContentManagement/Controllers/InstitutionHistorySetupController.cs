...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class InstitutionHistorySetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstitutionHistorySetupAPIHelper.GetInstitutionHistorySetupPageAsync("ContentManagement", "InstitutionHistorySetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstitutionHistorySetupAPIHelper.GetInstitutionHistorySetupPageAsync("ContentManagement", "InstitutionHistorySetup", "Details");
