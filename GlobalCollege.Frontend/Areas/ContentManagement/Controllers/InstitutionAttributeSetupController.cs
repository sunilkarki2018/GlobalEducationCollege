...
namespace GlobalCollege.Frontend.Areas.ContentManagement.Controllers
{
    ...
    public class InstitutionAttributeSetupController : Controller
    {
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstitutionAttributeSetupAPIHelper.GetInstitutionAttributeSetupPageAsync("ContentManagement", "InstitutionAttributeSetup", "Index");
        ...
        {
            FrontendPageInformation frontendPageInformation = await InstitutionAttributeSetupAPIHelper.GetInstitutionAttributeSetupPageAsync("ContentManagement", "InstitutionAttributeSetup", "Details");
