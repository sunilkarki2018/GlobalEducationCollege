...
namespace GlobalCollege.Frontend
{
    public class CalenderViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<CalenderViewComponentModel>(ComponentName, ProcedureName, "CalenderViewComponentModel", Id, Parameters);
