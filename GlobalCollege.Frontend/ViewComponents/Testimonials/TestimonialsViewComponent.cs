...
namespace GlobalCollege.Frontend
{
    public class TestimonialsViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<TestimonialsViewComponentModel>(ComponentName, ProcedureName, "TestimonialsViewComponentModel", Id, Parameters);
