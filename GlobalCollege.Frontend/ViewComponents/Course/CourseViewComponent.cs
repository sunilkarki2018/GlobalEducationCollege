...
namespace GlobalCollege.Frontend
{
    public class CourseViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<CourseViewComponentModel>(ComponentName, ProcedureName, "CourseViewComponentModel", Id, Parameters);
