...
namespace GlobalCollege.Frontend
{
    public class BlogViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<BlogViewComponentModel>(ComponentName, ProcedureName, "BlogViewComponentModel", Id, Parameters);
