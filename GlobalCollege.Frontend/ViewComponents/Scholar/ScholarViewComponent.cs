...
{
    public class ScholarViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<ScholarViewComponentModel>(ComponentName, ProcedureName, "ScholarViewComponentModel", Id, Parameters);
