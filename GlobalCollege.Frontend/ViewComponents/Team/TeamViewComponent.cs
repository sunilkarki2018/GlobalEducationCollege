...
namespace GlobalCollege.Frontend
{
    public class TeamViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<TeamViewComponentModel>(ComponentName, ProcedureName, "TeamViewComponentModel", Id, Parameters);
