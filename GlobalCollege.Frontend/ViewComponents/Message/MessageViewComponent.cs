...
namespace GlobalCollege.Frontend
{
    public class MessageViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<MessageViewComponentModel>(ComponentName, ProcedureName, "MessageViewComponentModel", Id, Parameters);
