...
namespace GlobalCollege.Frontend
{
    public class WidgetsViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<WidgetsViewComponentModel>(ComponentName, ProcedureName, "WidgetsViewComponentModel", Id, Parameters);
