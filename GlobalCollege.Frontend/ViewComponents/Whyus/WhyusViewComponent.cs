...
namespace GlobalCollege.Frontend
{
    public class WhyusViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<WhyusViewComponentModel>(ComponentName, ProcedureName, "WhyusViewComponentModel", Id, Parameters);
