...
namespace GlobalCollege.Frontend
{
    public class FAQViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<FAQViewComponentModel>(ComponentName, ProcedureName, "FAQViewComponentModel", Id, Parameters);
