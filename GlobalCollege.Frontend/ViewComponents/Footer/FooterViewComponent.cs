...
namespace GlobalCollege.Frontend
{
    public class FooterViewComponent : ViewComponent
    {
        ...
        {
            var ViewComponentInformation = await ViewComponenInformationAPIHelper.GetViewComponentInformation<FooterViewComponentModel>(ComponentName, ProcedureName, "FooterViewComponentModel", Id, Parameters);
