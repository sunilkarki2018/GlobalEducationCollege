CREATE TABLE [Administrator].[ApplicationGroup] (
    ...
    [ChangeLog]          XML              NULL,
    CONSTRAINT [PK_Administrator.ApplicationGroup] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Administrator.ApplicationGroup_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Administrator.ApplicationGroup_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Administrator.ApplicationGroup_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Administrator.ApplicationGroup_ContentManagement.InstitutionSetup_InstitutionSetupId] FOREIGN KEY ([InstitutionSetupId]) REFERENCES [ContentManagement].[InstitutionSetup] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [Administrator].[ApplicationGroup]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [Administrator].[ApplicationGroup]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [Administrator].[ApplicationGroup]([CreatedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_InstitutionSetupId]
    ON [Administrator].[ApplicationGroup]([InstitutionSetupId] ASC);
