CREATE TABLE [DocumentManagement].[DocumentCategory] (
    ...
    [ChangeLog]                XML              NULL,
    CONSTRAINT [PK_DocumentManagement.DocumentCategory] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_DocumentManagement.DocumentCategory_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_DocumentManagement.DocumentCategory_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_DocumentManagement.DocumentCategory_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_DocumentManagement.DocumentCategory_ContentManagement.InstitutionSetup_InstitutionSetupId] FOREIGN KEY ([InstitutionSetupId]) REFERENCES [ContentManagement].[InstitutionSetup] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [DocumentManagement].[DocumentCategory]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [DocumentManagement].[DocumentCategory]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [DocumentManagement].[DocumentCategory]([CreatedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_InstitutionSetupId]
    ON [DocumentManagement].[DocumentCategory]([InstitutionSetupId] ASC);
