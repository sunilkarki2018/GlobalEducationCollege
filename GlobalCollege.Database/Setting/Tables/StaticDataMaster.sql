CREATE TABLE [Setting].[StaticDataMaster] (
    ...
    [ChangeLog]         XML              NULL,
    CONSTRAINT [PK_Setting.StaticDataMaster] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Setting.StaticDataMaster_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.StaticDataMaster_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.StaticDataMaster_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [Setting].[StaticDataMaster]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [Setting].[StaticDataMaster]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [Setting].[StaticDataMaster]([CreatedById] ASC);
