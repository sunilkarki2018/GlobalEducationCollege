CREATE TABLE [Setting].[ModuleTypeSetup] (
    ...
    [ChangeLog]         XML              NULL,
    CONSTRAINT [PK_Setting.ModuleTypeSetup] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Setting.ModuleTypeSetup_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.ModuleTypeSetup_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.ModuleTypeSetup_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [Setting].[ModuleTypeSetup]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [Setting].[ModuleTypeSetup]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [Setting].[ModuleTypeSetup]([CreatedById] ASC);
