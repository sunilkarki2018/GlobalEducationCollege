CREATE TABLE [Setting].[ChildTableInformation] (
    ...
    [ChangeLog]         XML              NULL,
    CONSTRAINT [PK_Setting.ChildTableInformation] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Setting.ChildTableInformation_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.ChildTableInformation_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.ChildTableInformation_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_Setting.ChildTableInformation_Setting.ModuleSetup_ModuleSetupId] FOREIGN KEY ([ModuleSetupId]) REFERENCES [Setting].[ModuleSetup] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [Setting].[ChildTableInformation]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [Setting].[ChildTableInformation]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [Setting].[ChildTableInformation]([CreatedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModuleSetupId]
    ON [Setting].[ChildTableInformation]([ModuleSetupId] ASC);
