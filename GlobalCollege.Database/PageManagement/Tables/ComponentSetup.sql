CREATE TABLE [PageManagement].[ComponentSetup] (
    ...
    [ChangeLog]          XML              NULL,
    CONSTRAINT [PK_PageManagement.ComponentSetup] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_PageManagement.ComponentSetup_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.ComponentSetup_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.ComponentSetup_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.ComponentSetup_ContentManagement.InstitutionSetup_InstitutionSetupId] FOREIGN KEY ([InstitutionSetupId]) REFERENCES [ContentManagement].[InstitutionSetup] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [PageManagement].[ComponentSetup]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [PageManagement].[ComponentSetup]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [PageManagement].[ComponentSetup]([CreatedById] ASC);
...
CREATE NONCLUSTERED INDEX [IX_InstitutionSetupId]
    ON [PageManagement].[ComponentSetup]([InstitutionSetupId] ASC);
