CREATE TABLE [PageManagement].[PageSetup] (
    ...
    [ChangeLog]          XML              NULL,
    CONSTRAINT [PK_PageManagement.PageSetup] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_PageManagement.PageSetup_Administrator.ApplicationUser_AuthorisedById] FOREIGN KEY ([AuthorisedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.PageSetup_Administrator.ApplicationUser_CreatedById] FOREIGN KEY ([CreatedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.PageSetup_Administrator.ApplicationUser_ModifiedById] FOREIGN KEY ([ModifiedById]) REFERENCES [Administrator].[ApplicationUser] ([Id]),
    CONSTRAINT [FK_PageManagement.PageSetup_ContentManagement.InstitutionSetup_InstitutionSetupId] FOREIGN KEY ([InstitutionSetupId]) REFERENCES [ContentManagement].[InstitutionSetup] ([Id]),
    CONSTRAINT [FK_PageManagement.PageSetup_PageManagement.LayoutSetup_LayoutSetupId] FOREIGN KEY ([LayoutSetupId]) REFERENCES [PageManagement].[LayoutSetup] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_AuthorisedById]
    ON [PageManagement].[PageSetup]([AuthorisedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ModifiedById]
    ON [PageManagement].[PageSetup]([ModifiedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreatedById]
    ON [PageManagement].[PageSetup]([CreatedById] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_LayoutSetupId]
    ON [PageManagement].[PageSetup]([LayoutSetupId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_InstitutionSetupId]
    ON [PageManagement].[PageSetup]([InstitutionSetupId] ASC);
