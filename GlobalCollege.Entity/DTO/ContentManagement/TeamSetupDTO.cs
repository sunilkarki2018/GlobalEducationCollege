...
namespace GlobalCollege.Entity.DTO
    {
    public class TeamSetupDTO : BaseEntityDTO<Guid>
    {
        public TeamSetupDTO()
        {
            TeamAttributeSetups = new List<TeamAttributeSetupDTO>();
        }
        ...
        public virtual List<TeamAttributeSetupDTO> TeamAttributeSetups { get; set; }
    }
}
